local config = {
	[6087] = { storage = Storage.Quest.U7_8.HunterOutfits.HunterMusicSheet01, text = "first" },
	[6088] = { storage = Storage.Quest.U7_8.HunterOutfits.HunterMusicSheet02, text = "second" },
	[6089] = { storage = Storage.Quest.U7_8.HunterOutfits.HunterMusicSheet03, text = "third" },
	[6090] = { storage = Storage.Quest.U7_8.HunterOutfits.HunterMusicSheet04, text = "fourth" },
}
