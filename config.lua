...
coreDirectory = "data"
tournamentCoinsName = "Taberna Coins"
...
maintainModeMessage = "Server is closed at this moment!"
...
maxPlayers = 300
serverName = "Taberna OT"
serverMotd = "Bem Vindo(a) ao Taberna OT - O Mundo de Aventuras te Aguarda!"
...
forgeBonusSuccessRate = 30
forgeTierLossReduction = 50
forgeAmountMultiplier = 3
forgeMinSlivers = 3
forgeMaxSlivers = 7
forgeInfluencedLimit = 600
forgeFiendishLimit = 8
...
hazardDamageMultiplier = 300
hazardDefenseMultiplier = 20
...
partyAutoShareExperience = false
...
-- Stamina in Trainers
staminaTrainer = true
staminaTrainerDelay = 4
staminaTrainerGain = 2
-- Stamina in PZ
staminaPz = true
...
housePriceRentMultiplier = 2.0
housePriceEachSQM = 35000
houseRentPeriod = "weekly"
houseRentRate = 1.0
houseOwnedByAccount = false
houseBuyLevel = 300
housePurchasedShowPrice = false
houseLoseAfterInactivity = 15
...
freePremium = true
kickIdlePlayerAfterMinutes = 86400
maxMessageBuffer = 4
emoteSpells = true
allowWalkthrough = true
coinPacketSize = 5
coinImagesURL = "https://tabernaot.com.br/images/store/"
...
combatChainDelay = 50
combatChainTargets = 2
combatChainSkillFormulaAxe = 1
combatChainSkillFormulaClub = 1
combatChainSkillFormulaSword = 1
...
rateKillingInTheNameOfPoints = 4
...
ownerName = "Taberna"
ownerEmail = "serverotftp@gmail.com"
url = "https://tabernaot.com.br/"
location = "Brazil"

-- Sends Discord webhook notifications on startup, raids and shutdown.
-- The URL layout is https://discord.com/api/webhooks/:id/:token
-- Leave empty if you wish to disable.
discordWebhookURL = "https://discord.com/api/webhooks/1199061169567187084/fjDlInzeI3XHvy3CuPETgQb_KgUTdRRpFmg7S8L8ZDVpc3Ic7D-CqV3AbFXb8Lc9xh5m"
