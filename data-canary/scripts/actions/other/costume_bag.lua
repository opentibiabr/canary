local setting = {
	-- Common
	[653] = { "orc warrior", "pirate cutthroat", "dworc voodoomaster", "dwarf guard", "minotaur mage" },
	-- Uncommon
	[654] = { "quara hydromancer", "diabolic imp", "banshee", "frost giant", "lich" },
	-- Deluxe
	[655] = { "serpent spawn", "demon", "juggernaut", "behemoth", "ashmunrah" }
}
