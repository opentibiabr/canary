local dollsTable = {
	...
	[8149] = { "Weirdo, you're a weirdo! Actually all of you are!", "Pie for breakfast, pie for lunch and pie for dinner!", "All hail the control panel!", "I own, god owns, perfect match!", "Hug me! Feed me! Hail me!" },
	[8153] = { "It's news to me.", "News, updated as infrequently as possible!", "Extra! Extra! Read all about it!", "Fresh off the press!" },
	[8154] = { "Hail!", "So cold.", "Run, mammoth!" },
	[9144] = { "Hail |PLAYERNAME|! Hail!", "Hauopa!", "WHERE IS MY HYDROMEL?!", "Yala Boom" },
	[12043] = { "For zze emperor!", "Hail!", "Hail |PLAYERNAME|!" },
	[12904] = { "Mhausheausheu! What a FAIL! Mwahaha!", "Hail |PLAYERNAME|! You are wearing old socks!", "You are so unpopular even your own shadow refuses to follow you.", "Have fun!" },
	[14764] = { "My powers are limitless!", "Hail!" },
	[18343] = { "Hail!", "Shhhhhh, please be quiet!", "Books are great!! Aren't they?" },
	[21435] = {
	...
	[21947] = { "Hail!", "Don't be afraid of the darkness!", "Feel lucky, |PLAYERNAME|!", "Purrrrrrr!" },
	[21962] = { "Hail! (União&Força)", "Hail |PLAYERNAME|! (União&Força)", "Only the real killers can touch me!", "The path of assassin is found in death, DIE!", "<FART...> Ahhh... silent and deadly..." },
	[22120] = { "Silence! I smell something!", "Let me guide you, |PLAYERNAME|!", "I have a bad feeling about this.", "Watch your steps - we found the pit latrine." }
}
