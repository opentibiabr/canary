...
local setting = {
	[236] = {
		health = { 250, 350 },
		vocations = { VOCATION.BASE_ID.KNIGHT, VOCATION.BASE_ID.PALADIN },
		level = 50,
		flask = 283,
	...
	[237] = {
		mana = { 115, 185 },
		vocations = { VOCATION.BASE_ID.SORCERER, VOCATION.BASE_ID.DRUID, VOCATION.BASE_ID.PALADIN },
		level = 50,
		flask = 283,
	...
	[238] = {
		mana = { 150, 250 },
		vocations = { VOCATION.BASE_ID.SORCERER, VOCATION.BASE_ID.DRUID },
		level = 80,
		flask = 284,
	...
	[239] = {
		health = { 425, 575 },
		vocations = { VOCATION.BASE_ID.KNIGHT },
		level = 80,
		flask = 284,
	...
	[7443] = {
		condition = bullseye,
		vocations = { VOCATION.BASE_ID.PALADIN },
