...
spell:vocation("druid;true", "sorcerer;true", "elder druid;true", "master sorcerer;true", "paladin;true", "royal paladin;true", "knight;true", "elite knight;true")
spell:register()