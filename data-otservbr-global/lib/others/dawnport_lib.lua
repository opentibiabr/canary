...
Dawnport = {
	skillsLimit = {
		[VOCATION.ID.NONE] = {},
		[VOCATION.ID.SORCERER] = { [SKILL_MAGLEVEL] = 20 },
		[VOCATION.ID.DRUID] = { [SKILL_MAGLEVEL] = 20 },
		[VOCATION.ID.PALADIN] = { [SKILL_MAGLEVEL] = 9 },
		[VOCATION.ID.KNIGHT] = { [SKILL_MAGLEVEL] = 4 }
	}
}
...
function Player.changeVocation(self, newVocationId)
	...
	local skills = { { id = SKILL_FIST }, { id = SKILL_CLUB }, { id = SKILL_SWORD }, { id = SKILL_AXE }, { id = SKILL_DISTANCE }, { id = SKILL_SHIELD } }
...
function removeMainlandSmugglingItems(player)
	local smugglingItemIds = { 3355, 3562, 3559, 3552, 21348, 21350, 21400, 3350, 3267, 3412, 35562, 21470, 266, 268, 7876, 21352, 21351 } -- Leather helmet -- Coat -- Leather legs -- Leather boots -- The scorcher -- The chiller -- Spellbook of the novice -- Bow -- Dagger -- Wooden shield -- Quiver -- Simple arrow -- Health potion -- Mana potion -- Small health potion -- Lightest missile rune -- Light stone shower rune
