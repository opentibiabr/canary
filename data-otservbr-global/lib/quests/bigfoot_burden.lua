if not warzoneConfig then
	...
	warzoneConfig.resetRoom = function(roomwarzone, msg, releaseRoom)
		...
		local spectators = Game.getSpectators(roomwarzone.center, false, false, roomwarzone.minRangeX, roomwarzone.maxRangeX, roomwarzone.minRangeY, roomwarzone.maxRangeY)
