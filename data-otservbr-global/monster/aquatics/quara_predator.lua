...
monster.loot = {
	{ id = 3031, chance = 78000, maxCount = 154 }, -- Gold Coin
	{ id = 11491, chance = 9900 }, -- Quara Bone
	{ id = 7378, chance = 9300, maxCount = 7 }, -- Royal Spear
	{ id = 3028, chance = 5200, maxCount = 2 }, -- Small Diamond
	{ id = 3581, chance = 5100 }, -- Shrimp
	{ id = 3275, chance = 3000 }, -- Double Axe
	{ id = 5895, chance = 1900 }, -- Fish Fin
	{ id = 239, chance = 1000 }, -- Great Health Potion
	{ id = 7383, chance = 640 }, -- Relic Sword
	{ id = 7368, chance = 520 }, -- Assassin Star
	{ id = 824, chance = 510 }, -- Glacier Robe
	{ id = 5741, chance = 370 }, -- Skull Helmet
	{ id = 12318, chance = 17 }, -- Giant Shrimp
}
