local mType = Game.createMonsterType("History of Navega")
local monster = {}

monster.description = "History of Navega"
...
monster.attacks = {
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = -2900, maxDamage = -4500, length = 8, spread = 0, effect = CONST_ME_WHITE_ENERGY_SPARK },
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_ICEDAMAGE, minDamage = -2500, maxDamage = -5000, effect = CONST_ME_ICEATTACK },
	{ name = "melee", interval = 2000, chance = 100, skill = 200, attack = 1050 },
	...
	{ name = "combat", interval = 1000, chance = 13, type = COMBAT_LIFEDRAIN, minDamage = -2900, maxDamage = -5000, radius = 8, effect = CONST_ME_LOSEENERGY, target = false },
	...
	{ name = "combat", interval = 1000, chance = 15, type = COMBAT_LIFEDRAIN, minDamage = -2000, maxDamage = -3500, length = 8, spread = 0, effect = CONST_ME_MAGIC_RED, target = false },
}
