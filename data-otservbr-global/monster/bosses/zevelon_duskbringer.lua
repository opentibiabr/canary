...
monster.loot = {
	...
	{ id = 236, chance = 15500 }, -- Strong Health Potion
	{ id = 3434, chance = 10900 }, -- Vampire Shield
	{ id = 3114, chance = 7000 }, -- Skull (Item)
	{ id = 3035, chance = 6200, maxCount = 5 }, -- Platinum Coin
	{ id = 3098, chance = 3900 }, -- Ring of Healing
	{ id = 7419, chance = 2300 }, -- Dreaded Cleaver
	{ id = 3027, chance = 780 }, -- Black Pearl
	{ id = 8192, chance = 780 }, -- Vampire Lord Token
}
