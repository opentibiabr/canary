...
monster.health = 35700
monster.maxHealth = 35700
monster.race = "blood"
monster.corpse = 0
monster.speed = 0
...
monster.attacks = {
	...
	-- bleed
	{ name = "condition", type = CONDITION_BLEEDING, interval = 2000, chance = 20, minDamage = -150, maxDamage = -325, radius = 4, effect = CONST_ME_DRAWBLOOD, shootEffect = CONST_ANI_THROWINGKNIFE, target = true },
}
