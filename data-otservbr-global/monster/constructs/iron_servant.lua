...
monster.loot = {
	{ id = 3031, chance = 82000, maxCount = 55 }, -- Gold Coin
	{ id = 8775, chance = 4800 }, -- Gear Wheel
	{ id = 266, chance = 2000 }, -- Health Potion
	{ id = 3269, chance = 1000 }, -- Halberd
	{ id = 8894, chance = 510 }, -- Heavily Rusted Armor
	{ id = 12601, chance = 320 }, -- Slime Mould
}
