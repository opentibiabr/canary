...
monster.loot = {
	{ id = 3031, chance = 96000, maxCount = 186 }, -- Gold Coin
	{ id = 3035, chance = 35000, maxCount = 4 }, -- Platinum Coin
	{ id = 237, chance = 15800 }, -- Strong Mana Potion
	{ id = 236, chance = 14000 }, -- Strong Health Potion
	{ id = 3032, chance = 12000, maxCount = 5 }, -- Small Emerald
	{ id = 3725, chance = 6500, maxCount = 4 }, -- Brown Mushroom
	{ id = 3049, chance = 5400 }, -- Stealth Ring
	{ id = 7440, chance = 1700 }, -- Mastermind Potion
	...
	{ id = 3281, chance = 320 }, -- Giant Sword
}
