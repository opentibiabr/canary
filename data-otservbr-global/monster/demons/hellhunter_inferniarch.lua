...
monster.loot = {
	...
	{ id = 7365, chance = 10200, maxCount = 5 }, -- Onyx Arrow
	{ id = 7368, chance = 8300, maxCount = 10 }, -- Assassin Star
	{ id = 3033, chance = 7100, maxCount = 4 }, -- Small Amethyst
	{ id = 16125, chance = 3800 }, -- Cyan Crystal Fragment
	{ id = 49909, chance = 3100 }, -- Demonic Core Essence
	{ id = 7364, chance = 3000, maxCount = 5 }, -- Sniper Arrow
	{ id = 3384, chance = 1900 }, -- Dark Helmet
	{ id = 6299, chance = 1200 }, -- Death Ring
	{ id = 49908, chance = 990 }, -- Mummified Demon Finger
	{ id = 49894, chance = 780 }, -- Demonic Matter
	{ id = 50055, chance = 470 }, -- Hellhunter Eye
	{ id = 8027, chance = 110 }, -- Composite Hornbow
}
