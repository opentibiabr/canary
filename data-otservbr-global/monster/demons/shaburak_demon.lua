...
monster.loot = {
	{ id = 3031, chance = 97000, maxCount = 255 }, -- Gold Coin
	{ id = 7378, chance = 10300, maxCount = 6 }, -- Royal Spear
	{ id = 236, chance = 5200 }, -- Strong Health Potion
	{ id = 237, chance = 5100 }, -- Strong Mana Potion
	{ id = 3030, chance = 4900, maxCount = 5 }, -- Small Ruby
	{ id = 3725, chance = 4000 }, -- Brown Mushroom
	{ id = 3051, chance = 1100 }, -- Energy Ring
	{ id = 2995, chance = 990 }, -- Piggy Bank
	{ id = 7443, chance = 620 }, -- Bullseye Potion
	{ id = 3071, chance = 600 }, -- Wand of Inferno
	{ id = 821, chance = 150 }, -- Magma Legs
	{ id = 5904, chance = 94 }, -- Magic Sulphur
}
