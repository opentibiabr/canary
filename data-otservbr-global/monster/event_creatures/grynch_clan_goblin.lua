...
monster.loot = {
	{ id = 3031, chance = 55000, maxCount = 16 }, -- Gold Coin
	{ id = 6496, chance = 30000 }, -- Christmas Present Bag
	{ id = 2992, chance = 15100, maxCount = 3 }, -- Snowball
	{ id = 3585, chance = 9900, maxCount = 3 }, -- Red Apple
	{ id = 3598, chance = 7900, maxCount = 5 }, -- Cookie
	{ id = 3586, chance = 5100, maxCount = 2 }, -- Orange
	{ id = 6276, chance = 4900 }, -- Lump of Cake Dough
	{ id = 836, chance = 2000, maxCount = 4 }, -- Walnut
	{ id = 3606, chance = 1000, maxCount = 2 }, -- Egg
	{ id = 3599, chance = 990, maxCount = 3 }, -- Candy Cane
	{ id = 10207, chance = 960 }, -- Snowman Package
	{ id = 841, chance = 920, maxCount = 5 }, -- Peanut
	{ id = 3572, chance = 760 }, -- Scarf
	{ id = 5894, chance = 620, maxCount = 3 }, -- Bat Wing
	{ id = 2875, chance = 520 }, -- Bottle
	{ id = 4871, chance = 510 }, -- Explorer Brooch
	{ id = 6500, chance = 430 }, -- Gingerbreadman
	{ id = 5890, chance = 420, maxCount = 3 }, -- Chicken Feather
	{ id = 3454, chance = 420 }, -- Broom
	{ id = 5902, chance = 360 }, -- Honeycomb
	{ id = 3590, chance = 310, maxCount = 4 }, -- Cherry
	{ id = 5792, chance = 120 }, -- Die
	{ id = 2906, chance = 120 }, -- Watch
	{ id = 3046, chance = 120 }, -- Magic Light Wand
	{ id = 3147, chance = 110 }, -- Blank Rune
	{ id = 2983, chance = 110 }, -- Flower Bowl
	{ id = 2639, chance = 110 }, -- Picture (Landscape)
	{ id = 6393, chance = 100 }, -- Cream Cake
	{ id = 6392, chance = 98 }, -- Valentine's Cake
	{ id = 2950, chance = 98 }, -- Lute
	{ id = 2995, chance = 95 }, -- Piggy Bank
	{ id = 3042, chance = 87 }, -- Scarab Coin
	{ id = 5021, chance = 84 }, -- Orichalcum Pearl
	{ id = 3003, chance = 76 }, -- Rope
	{ id = 3463, chance = 73 }, -- Mirror
