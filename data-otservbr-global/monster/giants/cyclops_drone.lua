...
monster.loot = {
	...
	{ id = 3294, chance = 7900 }, -- Short Sword
	{ id = 9657, chance = 6900 }, -- Cyclops Toe
	{ id = 3410, chance = 2000 }, -- Plate Shield
	{ id = 3413, chance = 1600 }, -- Battle Shield
	{ id = 3269, chance = 670 }, -- Halberd
	{ id = 236, chance = 500 }, -- Strong Health Potion
	{ id = 3384, chance = 200 }, -- Dark Helmet
	{ id = 7398, chance = 120 }, -- Cyclops Trophy
	{ id = 3093, chance = 73 }, -- Club Ring
}
