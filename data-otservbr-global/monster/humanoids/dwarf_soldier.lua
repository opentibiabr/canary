...
monster.loot = {
	{ id = 3723, chance = 40000, maxCount = 2 }, -- White Mushroom
	{ id = 3446, chance = 38000, maxCount = 7 }, -- Bolt
	{ id = 3031, chance = 28000, maxCount = 12 }, -- Gold Coin
	{ id = 3375, chance = 11900 }, -- Soldier Helmet
	{ id = 3457, chance = 10100 }, -- Shovel
	{ id = 3358, chance = 7400 }, -- Chain Armor
	{ id = 7363, chance = 3800, maxCount = 3 }, -- Piercing Bolt
	{ id = 3425, chance = 3100 }, -- Dwarven Shield
	{ id = 3349, chance = 3000 }, -- Crossbow
	{ id = 3266, chance = 2500 }, -- Battle Axe
	{ id = 5880, chance = 300 }, -- Iron Ore
	{ id = 3092, chance = 110 }, -- Axe Ring
}
