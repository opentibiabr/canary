...
monster.loot = {
	{ id = 3031, chance = 65000, maxCount = 12 }, -- Gold Coin
	{ id = 3277, chance = 25000 }, -- Spear
	{ id = 3552, chance = 9900 }, -- Leather Boots
	{ id = 3577, chance = 9900 }, -- Meat
	{ id = 3412, chance = 5300 }, -- Wooden Shield
	{ id = 3336, chance = 5100 }, -- Studded Club
	{ id = 3447, chance = 5100, maxCount = 5 }, -- Arrow
	{ id = 9689, chance = 3000 }, -- Bunch of Troll Hair
	{ id = 11515, chance = 900 }, -- Trollroot
	{ id = 3054, chance = 130 }, -- Silver Amulet
}
monster.attacks = {
