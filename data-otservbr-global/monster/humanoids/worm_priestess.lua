...
monster.loot = {
	...
	{ id = 11473, chance = 16000 }, -- Purple Robe
	{ id = 237, chance = 12200, maxCount = 3 }, -- Strong Mana Potion
	{ id = 3066, chance = 11900 }, -- Snakebite Rod
	{ id = 7425, chance = 5000 }, -- Taurus Mace
	{ id = 2920, chance = 5000 }, -- Torch
	{ id = 5878, chance = 5000 }, -- Minotaur Leather
	{ id = 11472, chance = 2900, maxCount = 2 }, -- Minotaur Horn
	{ id = 3033, chance = 2600, maxCount = 2 }, -- Small Amethyst
	{ id = 9057, chance = 2500, maxCount = 2 }, -- Small Topaz
	{ id = 3032, chance = 2400, maxCount = 2 }, -- Small Emerald
	{ id = 3030, chance = 2400, maxCount = 2 }, -- Small Ruby
	{ id = 3029, chance = 2400, maxCount = 2 }, -- Small Sapphire
	{ id = 3028, chance = 2400, maxCount = 2 }, -- Small Diamond
	{ id = 5912, chance = 1600 }, -- Blue Piece of Cloth
	{ id = 8082, chance = 1500 }, -- Underworld Rod
