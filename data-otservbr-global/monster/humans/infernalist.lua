...
monster.loot = {
	{ id = 3031, chance = 98000, maxCount = 151 }, -- Gold Coin
	{ id = 238, chance = 19300 }, -- Great Mana Potion
	{ id = 239, chance = 19100 }, -- Great Health Potion
	{ id = 8012, chance = 8000, maxCount = 5 }, -- Raspberry
	{ id = 3324, chance = 6500 }, -- Skull Staff
	{ id = 676, chance = 4700 }, -- Small Enchanted Ruby
	{ id = 3051, chance = 2100 }, -- Energy Ring
	{ id = 5911, chance = 1200 }, -- Red Piece of Cloth
	{ id = 9045, chance = 770 }, -- Royal Tapestry
	{ id = 5904, chance = 630 }, -- Magic Sulphur
	{ id = 8074, chance = 480 }, -- Spellbook of Mind Control
	{ id = 37335, chance = 440 }, -- black skull
	{ id = 2852, chance = 290 }, -- Red Tome
	{ id = 818, chance = 180 }, -- Magma Boots
	{ id = 9058, chance = 130 }, -- Gold Ingot
	{ id = 9067, chance = 110 }, -- Crystal of Power
	{ id = 2995, chance = 92 }, -- Piggy Bank
	{ id = 9056, chance = 440 }, -- Black Skull (Item)
}
