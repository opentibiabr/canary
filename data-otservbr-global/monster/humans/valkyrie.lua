...
monster.loot = {
	...
	{ id = 3585, chance = 7400, maxCount = 2 }, -- Red Apple
	{ id = 11443, chance = 6100 }, -- Girlish Hair Decoration
	{ id = 3347, chance = 5100 }, -- Hunting Spear
	{ id = 11444, chance = 3100 }, -- Protective Charm
	{ id = 3084, chance = 1100 }, -- Protection Amulet
	{ id = 3357, chance = 820 }, -- Plate Armor
	{ id = 3114, chance = 760 }, -- Skull (Item)
	{ id = 266, chance = 460 }, -- Health Potion
	{ id = 3275, chance = 380 }, -- Double Axe
	{ id = 3028, chance = 96 }, -- Small Diamond
}
