...
monster.loot = {
	{ id = 3031, chance = 92000, maxCount = 105 }, -- Gold Coin
	{ id = 9667, chance = 9900 }, -- Boggy Dreads
	{ id = 239, chance = 2000 }, -- Great Health Potion
	{ id = 3557, chance = 2000 }, -- Plate Legs
	{ id = 7642, chance = 2000 }, -- Great Spirit Potion
	{ id = 8084, chance = 1000 }, -- Springsprout Rod
	{ id = 7643, chance = 780 }, -- Ultimate Health Potion
	{ id = 8044, chance = 590 }, -- Belted Cape
	{ id = 8063, chance = 140 }, -- Paladin Armor
}
