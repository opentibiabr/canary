...
monster.loot = {
	...
	{ id = 10306, chance = 8100 }, -- Essence of a Bad Dream
	{ id = 10312, chance = 4900 }, -- Scythe Leg
	{ id = 3035, chance = 1000, maxCount = 3 }, -- Platinum Coin
	{ id = 3385, chance = 700 }, -- Crown Helmet
	{ id = 7387, chance = 350 }, -- Diamond Sceptre
	{ id = 6299, chance = 320 }, -- Death Ring
	{ id = 8043, chance = 320 }, -- Focus Cape
	{ id = 7451, chance = 240 }, -- Shadow Sceptre
	{ id = 6574, chance = 220 }, -- Bar of Chocolate
	{ id = 9027, chance = 110 }, -- Crystal of Focus
}
