...
monster.loot = {
	...
	{ id = 3578, chance = 10400 }, -- Fish
	{ id = 3582, chance = 9600 }, -- Ham
	{ id = 3723, chance = 9600, maxCount = 3 }, -- White Mushroom
	{ id = 3052, chance = 1500 }, -- Life Ring
	{ id = 3069, chance = 910 }, -- Necrotic Rod
	{ id = 16123, chance = 780 }, -- Brown Crystal Splinter
	{ id = 16122, chance = 630 }, -- Green Crystal Splinter
	{ id = 16124, chance = 560 }, -- Blue Crystal Splinter
	{ id = 8072, chance = 480 }, -- Spellbook of Enlightenment
	{ id = 3297, chance = 430 }, -- Serpent Sword
	{ id = 814, chance = 330 }, -- Terra Amulet
	{ id = 813, chance = 300 }, -- Terra Boots
	{ id = 6299, chance = 190 }, -- Death Ring
	{ id = 12311, chance = 150 }, -- Carrot on a Stick
}
