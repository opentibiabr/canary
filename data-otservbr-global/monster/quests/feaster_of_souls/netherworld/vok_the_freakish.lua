...
monster.bosstiary = {
	...
	storageCooldown = Storage.Quest.FeasterOfSouls.Bosses.VokTheFreakish.Timer
}
...
monster.loot = {
	...
	{name = "white gem", chance = 33333, maxCount = 2},
	{id = 3039, chance = 23667, maxCount = 2},
	{name = "bow", chance = 85662},
	{id = 16163, chance = 10000},
	{name = "cursed bone", chance = 40000},
	{name = "gemmed figurine", chance = 20000},
	{name = "moonstone", chance = 33333},
	{name = "ornate crossbow", chance = 55668},
	{name = "pair of nightmare boots", chance = 450},
	{id = 23529, chance = 10000},
	{name = "skull coin", chance = 66666},
	{name = "yellow gem", chance = 40000, maxCount = 2},
}
