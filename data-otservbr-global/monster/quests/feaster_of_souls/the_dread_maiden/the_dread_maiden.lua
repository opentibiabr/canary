...
monster.bosstiary = {
	...
	storageCooldown = Storage.Quest.FeasterOfSouls.Bosses.TheDreadMaiden.Timer
}
...
monster.defenses = {
	...
	{name ="combat", interval = 10000, chance = 20, type = COMBAT_HEALING, minDamage = 1000, maxDamage = 2000, effect = CONST_ME_MAGIC_BLUE, target = false},
	{name ="summonsthedreadmaiden", interval = 5000, chance = 80, target = false},
	{name ="summonsthedreadmaidenn", interval = 10000, chance = 70, target = false},
	{name ="summonsthedreadmaidennn", interval = 15000, chance = 60, target = false},
}
