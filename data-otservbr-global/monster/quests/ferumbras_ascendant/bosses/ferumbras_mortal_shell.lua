...
monster.summon = {
	maxSummons = 5,
	summons = {
		{ name = "Demon", chance = 100, interval = 1000, count = 5 },
	},
}
...
monster.loot = {
	{ id = 822, chance = 10800 }, -- lightning legs
	{ id = 8041, chance = 10400 }, -- greenwood coat
	{ id = 3029, chance = 10000, maxCount = 10 }, -- small sapphire
	{ id = 7416, chance = 800 }, -- bloody edge
	{ id = 7427, chance = 10800 }, -- chaos mace
	{ id = 3360, chance = 10800 }, -- golden armor
	{ id = 8102, chance = 10400 }, -- emerald sword
	...
	{ id = 8040, chance = 10300 }, -- velvet mantle
	{ id = 3010, chance = 11000 }, -- emerald bangle
	{ id = 7423, chance = 10300 }, -- skullcrusher
	...
	{ id = 7414, chance = 10800 }, -- abyss hammer
	{ id = 5903, chance = 7 }, -- ferumbras' hat
	{ id = 22769, chance = 800 }, -- ferumbras' mana keg
	{ id = 7382, chance = 1800 }, -- demonrage sword
	...
	{ id = 3422, chance = 7 }, -- great shield
	{ id = 821, chance = 10800 }, -- magma legs
	{ id = 9058, chance = 10800 }, -- gold ingot
...
monster.attacks = {
	...
	-- poison
	{ name = "condition", type = CONDITION_POISON, interval = 2000, chance = 20, minDamage = -750, maxDamage = -1120, radius = 6, effect = CONST_ME_POISONAREA, target = false },
	{ name = "ferumbras electrify", interval = 2000, chance = 18, target = false },
	{ name = "combat", interval = 2000, chance = 16, type = COMBAT_MANADRAIN, minDamage = -725, maxDamage = -1010, radius = 6, effect = CONST_ME_MAGIC_RED, target = false },
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_MANADRAIN, minDamage = -925, maxDamage = -1410, radius = 9, effect = CONST_ME_MAGIC_BLUE, target = false },
	{ name = "combat", interval = 2000, chance = 21, type = COMBAT_ENERGYDAMAGE, minDamage = -900, maxDamage = -1250, radius = 9, effect = CONST_ME_ENERGYHIT, target = false },
	{ name = "combat", interval = 2000, chance = 21, type = COMBAT_LIFEDRAIN, minDamage = -700, maxDamage = -1050, radius = 6, effect = CONST_ME_POFF, target = false },
	{ name = "ferumbras soulfire", interval = 2000, chance = 20, range = 7, target = false },
	{ name = "combat", interval = 2000, chance = 17, type = COMBAT_LIFEDRAIN, minDamage = -1090, maxDamage = -1650, length = 8, spread = 0, effect = CONST_ME_HITBYPOISON, target = false },
}
...
monster.defenses = {
	...
	armor = 100,
	--	mitigation = ???,
	{ name = "combat", interval = 2000, chance = 23, type = COMBAT_HEALING, minDamage = 1000, maxDamage = 2490, effect = CONST_ME_MAGIC_GREEN, target = false },
	{ name = "combat", interval = 2000, chance = 3, type = COMBAT_HEALING, minDamage = 30000, maxDamage = 70000, effect = CONST_ME_MAGIC_GREEN, target = false },
