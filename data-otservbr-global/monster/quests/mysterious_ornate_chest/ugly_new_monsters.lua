...
monster.loot = {
	{name = "cobra crossbow", chance = 90},
	{name = "cobra hood", chance = 90},
	{name = "cobra axe", chance = 90},
	{name = "cobra boots", chance = 90},
	{name = "cobra sword", chance = 90},
	{name = "cobra wand", chance = 90},
	{name = "cobra rod", chance = 90},
	{name = "cobra club", chance = 90}
}
