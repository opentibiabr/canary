...
monster.loot = {
	{ id = 9058, chance = 44000, maxCount = 5 }, -- Gold Ingot
	{ id = 14112, chance = 6600 }, -- Bar of Gold
	{ id = 7377, chance = 2500, maxCount = 3 }, -- Ice Cream Cone (Blue-Barian)
	{ id = 7441, chance = 1400 }, -- Ice Cube
}
