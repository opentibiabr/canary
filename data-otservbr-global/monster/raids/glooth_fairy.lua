...
monster.attacks = { {
	...
	target = false
}, { -- blue energy ultimate explosion
	name = "war golem skill reducer",
	interval = 2000,
	chance = 10,
	target = false
}, { -- reduces shield "yellow stars beam"
	name = "glooth fairy skill reducer",
	interval = 2000,
	chance = 5,
	target = false
}, { -- reduces magic level "great energy beam"
	name = "speed",
	interval = 2000,
	chance = 20,
	speedChange = -400,
	...
	target = true,
	duration = 60000
} } -- paralyze, poison ultimate explosion
