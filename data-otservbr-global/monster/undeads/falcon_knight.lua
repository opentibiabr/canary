...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 18, type = COMBAT_EARTHDAMAGE, minDamage = -300, maxDamage = -400, radius = 2, effect = CONST_ME_GROUNDSHAKER, target = false },
	{ name = "combat", interval = 2000, chance = 14, type = COMBAT_HOLYDAMAGE, minDamage = -290, maxDamage = -320, length = 5, spread = 0, effect = CONST_ME_BLOCKHIT, target = false },
}
