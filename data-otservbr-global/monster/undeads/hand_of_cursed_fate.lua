...
monster.loot = {
	...
	{ id = 6558, chance = 29000, maxCount = 3 }, -- Flask of Demonic Blood
	{ id = 238, chance = 19700, maxCount = 2 }, -- Great Mana Potion
	{ id = 7643, chance = 15600 }, -- Ultimate Health Potion
	{ id = 3062, chance = 15100 }, -- Mind Stone
	{ id = 7368, chance = 14400, maxCount = 5 }, -- Assassin Star
	{ id = 3029, chance = 13300, maxCount = 4 }, -- Small Sapphire
	{ id = 6499, chance = 12100 }, -- Demonic Essence
	{ id = 3084, chance = 11900 }, -- Protection Amulet
	{ id = 3037, chance = 7100 }, -- Yellow Gem
	{ id = 3071, chance = 6400 }, -- Wand of Inferno
	{ id = 3010, chance = 6000 }, -- Emerald Bangle
	{ id = 3370, chance = 5000 }, -- Knight Armor
	{ id = 3155, chance = 5000, maxCount = 8 }, -- Sudden Death Rune
	{ id = 6299, chance = 1800 }, -- Death Ring
	{ id = 3051, chance = 1600 }, -- Energy Ring
	{ id = 2828, chance = 1200 }, -- Book (Orange)
	{ id = 3036, chance = 1100 }, -- Violet Gem
	{ id = 3041, chance = 890 }, -- Blue Gem
	{ id = 3324, chance = 710 }, -- Skull Staff
	{ id = 9058, chance = 350 }, -- Gold Ingot
	{ id = 3055, chance = 350 }, -- Platinum Amulet
	{ id = 3381, chance = 180 }, -- Crown Armor
	{ id = 3079, chance = 170 }, -- Boots of Haste
	{ id = 5668, chance = 90 }, -- Mysterious Voodoo Skull
	{ id = 7414, chance = 410 }, -- Abyss Hammer
}
