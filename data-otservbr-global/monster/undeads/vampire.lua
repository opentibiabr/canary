...
monster.loot = {
	{ id = 3031, chance = 90000, maxCount = 60 }, -- Gold Coin
	{ id = 9685, chance = 8100 }, -- Vampire Teeth
	{ id = 11449, chance = 4800 }, -- Blood Preservation
	{ id = 3027, chance = 1900 }, -- Black Pearl
	{ id = 3661, chance = 1800 }, -- Grave Flower
	{ id = 236, chance = 1400 }, -- Strong Health Potion
	{ id = 3300, chance = 1300 }, -- Katana
	{ id = 3114, chance = 1000 }, -- Skull (Item)
	{ id = 3271, chance = 980 }, -- Spike Sword
	{ id = 3284, chance = 560 }, -- Ice Rapier
	{ id = 3373, chance = 410 }, -- Strange Helmet
	{ id = 3010, chance = 220 }, -- Emerald Bangle
	{ id = 3056, chance = 190 }, -- Bronze Amulet
