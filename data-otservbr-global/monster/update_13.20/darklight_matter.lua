...
monster.description = "Darklight Matter"
...
monster.loot = {
	{ name = "crystal coin", chance = 13066, maxCount = 1 },
	{ name = "unstable darklight matter", chance = 14881, maxCount = 1 },
	{ name = "darklight core (object)", chance = 10006, maxCount = 1 },
	{ name = "ultimate health potion", chance = 8241, maxCount = 6 },
	{ id = 3039, chance = 5115, maxCount = 1 }, -- red gem
	{ name = "darklight matter (object)", chance = 11020, maxCount = 1 },
	{ name = "rubber cap", chance = 13010, maxCount = 1 },
	{ id = 23544, chance = 10681, maxCount = 1 }, -- collar of red plasma
	{ name = "green gem", chance = 7901, maxCount = 1 },
	{ name = "shadow sceptre", chance = 6127, maxCount = 1 },
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = -220, maxDamage = -1050 },
