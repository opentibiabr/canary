...
keywordHandler:addKeyword({ "pirate" }, StdModule.say, {
	npcHandler = npcHandler,
	text = { "In a just world, I would be captain of a grand ship, ...", "Those pirates out there would now be my minions, and we would brave the seas and become the terror of the coastal towns! ...", "If only our plan had worked!" }
})
...
keywordHandler:addKeyword({ "captain" }, StdModule.say, {
	npcHandler = npcHandler,
	text = { "I'd have been a much better captain then Kid was. I played several captains on stage and I was good! ...", "Where Kid longed for the appreciation of his men, I would rule by fear and with an iron fist!" }
})
...
keywordHandler:addKeyword({ "kidnap" }, StdModule.say, {
	npcHandler = npcHandler,
	text = { "Ah kidnapping is so much fun. That is, if you're not on the receiving end. ...", "It's easy money and you have a chance to frighten and torture someone who can't fight back!" }
})
...
keywordHandler:addKeyword({ "plundering" }, StdModule.say, {
	npcHandler = npcHandler,
	text = { "As long as we stick to undefended coastal towns we can make an easy fortune. Har Har! ...", "As soon as I get out of here I'll finally become a pirate captain on my own. I don't need Captain Kid!" }
})
