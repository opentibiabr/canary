...
keywordHandler:addKeyword({ "cooki" }, StdModule.say, {
	npcHandler = npcHandler,
...
keywordHandler:addKeyword({ "profession" }, StdModule.say, {
	npcHandler = npcHandler,
...
-- Pick quest
local pickKeyword = keywordHandler:addKeyword({ "pick" }, StdModule.say, {
	npcHandler = npcHandler,
...
pickKeyword:addChildKeyword(
	{ "yes" },
	StdModule.say,
	{
		npcHandler = npcHandler,
		text = "Splendid! Here, take your pick.",
		reset = true
	},
	function(player)
...
pickKeyword:addChildKeyword({ "yes" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Sorry, I am looking for a SMALL axe.",
	reset = true
})
pickKeyword:addChildKeyword({ "" }, StdModule.say, {
	npcHandler = npcHandler,
