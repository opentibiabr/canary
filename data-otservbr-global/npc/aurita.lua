...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "mission") then
		if player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission03.AnUnlikelyCouple) < 1 then
			npcHandler:say({
		...
		elseif player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission03.AnUnlikelyCouple) == 1 then
			npcHandler:say({
		...
		elseif player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission03.AnUnlikelyCouple) >= 2 and player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission03.AnUnlikelyCouple) <= 3 then
			npcHandler:say({
	...
	elseif MsgContains(message, "starlight vial") or MsgContains(message, "empty starlight vial") then
		if player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission03.AnUnlikelyCouple) == 4 then
			if player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission03.EmptyStarlightVial) < 1 then
				npcHandler:say({
				...
				player:setStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission03.EmptyStarlightVial, 1)
				npcHandler:setTopic(playerId, 0)
			else
				npcHandler:say({
	...
	elseif MsgContains(message, "yes") then
		if npcHandler:getTopic(playerId) == 1 then
			...
			player:setStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission03.AnUnlikelyCouple, 1)
			player:setStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission03.UnlikelyCouple, 1)
			npcHandler:setTopic(playerId, 0)
		end
