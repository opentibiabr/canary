...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "yes") then
		...
		elseif npcHandler:getTopic(playerId) == 3 then
			npcHandler:say({ "So let us begin. Please concentrate with me. Concentrate! ...", "Concentrate! ...", "Concentrate! ...", "Concentrate! ...", "Concentrate! ...", "Do you feel something?" }, npc, creature)
