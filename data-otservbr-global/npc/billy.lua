...
panKeyword:addChildKeyword({ "yes" }, StdModule.say, { npcHandler = npcHandler, text = "A pan! At last! Take this in case you eat something my cousin has cooked.", reset = true }, function(player)
