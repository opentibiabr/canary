...
local config = {
	[1] = {
		...
		updateStorages = { {
			key = Storage.WhatAFoolish.Mission1,
			value = 2
		}, {
			key = Storage.WhatAFoolish.Questline,
			value = 2
		} }
	},
	[2] = {
		...
		addItem = { itemId = 107 },
		updateStorages = { {
			key = Storage.WhatAFoolish.Mission2,
			value = 1
		}, {
			key = Storage.WhatAFoolish.Questline,
			value = 3
	...
	[4] = {
		...
		updateStorages = { {
			key = Storage.WhatAFoolish.Mission3,
			value = 1
		}, {
			key = Storage.WhatAFoolish.Questline,
			value = 5
	...
	[6] = {
		text = {
			[1] = { "Ah, the fool in training wants to see some action? Fine with me. I think you are ready for a big prank. But first I need 18 vials filled with wine ...", "Get them and report here about your mission." }
		},
		updateStorages = { {
			key = Storage.WhatAFoolish.Mission4,
			value = 1
		}, {
			key = Storage.WhatAFoolish.Questline,
			value = 7
	...
	[9] = {
		...
		updateStorages = { {
			key = Storage.WhatAFoolish.Mission5,
			value = 1
		}, {
			key = Storage.WhatAFoolish.TriangleTowerDoor,
			value = 1
		}, {
			key = Storage.WhatAFoolish.Questline,
			value = 10
	...
	[12] = {
		text = { [1] = "I can't think of anything right now. Maybe you should try to get your jester outfit." }
	},
	[13] = {
		text = { [1] = "You know, nothing has brought more fun and joy to humanity than the whoopee cushion. Its creation is a delicate matter though. Bring me 4 pieces of minotaur leather first and then lets talk about this mission." },
		updateStorages = { {
			key = Storage.WhatAFoolish.Mission6,
			value = 1
		}, {
			key = Storage.WhatAFoolish.Questline,
			value = 14
	...
	[18] = {
		...
		updateStorages = { {
			key = Storage.WhatAFoolish.Mission7,
			value = 1
		}, {
			key = Storage.WhatAFoolish.QueenEloiseCatDoor,
			value = 1
		}, {
			key = Storage.WhatAFoolish.Questline,
			value = 19
	...
	[20] = {
		...
		updateStorages = { {
			key = Storage.WhatAFoolish.Mission8,
			value = 1
		}, {
			key = Storage.WhatAFoolish.Questline,
			value = 21
	...
	[25] = {
		...
		updateStorages = { {
			key = Storage.WhatAFoolish.Mission9,
			value = 1
		}, {
			key = Storage.WhatAFoolish.Questline,
			value = 26
	...
	[30] = {
		...
		yes = true,
		updateStorages = { {
			key = Storage.WhatAFoolish.Mission10,
			value = 1
		}, {
			key = Storage.WhatAFoolish.Questline,
			value = 31
	...
	[32] = {
		...
		updateStorages = { {
			key = Storage.WhatAFoolish.Mission11,
			value = 1
		}, {
			key = Storage.WhatAFoolish.Questline,
			value = 33
	...
	[36] = {
		text = { [1] = "You are a fully trained fool now who has developed to an accomplished jester. Your final mission is to bring fun and joy to the whole world." }
	}
}
...
keywordHandler:addKeyword(
	...
	StdModule.say,
	{
		...
		text = "I wanted to become a sorcerer, too, but I was overqualified!"
	},
	function(player)
...
keywordHandler:addKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "I wanted to become a druid, too, but I was overqualified!"
	},
	function(player)
...
keywordHandler:addKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "I wanted to become a paladin, too, but I was overqualified!"
	},
	function(player)
...
keywordHandler:addKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "I wanted to become a knight, too, but I was overqualified!"
	},
	function(player)
...
keywordHandler:addKeyword({ "sorcerer" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "The good thing about them is that they can't be at two places at the same time."
})
keywordHandler:addKeyword({ "druid" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I wonder if they love my water squirt flowers as much as all other plants."
})
keywordHandler:addKeyword({ "paladin" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "They are the king's favourites, because they know how to 'bow'."
})
keywordHandler:addKeyword({ "knight" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Did you notice that old knights have their scars just on their backs?"
})

keywordHandler:addKeyword({ "here" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "A fitting place for a {jester}. I guess there are worse {jobs} around."
})
keywordHandler:addKeyword({ "king" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Bozo: Nah, no jests about His Royal Highness."
})
keywordHandler:addKeyword({ "tibia" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I rarely leave the castle. It's really stressful to be as popular as me."
})
...
keywordHandler:addKeyword({ "help" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I'm a jester, not a doctor!"
})
keywordHandler:addKeyword({ "name" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "My name is Bozo. But it's more than a name, it's a lifestyle for me!"
})
keywordHandler:addKeyword({ "bozo" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "That's me: Bozo, the jester!"
})
...
keywordHandler:addKeyword({ "joke" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I know some 'monstrous' jokes!"
})
keywordHandler:addKeyword({ "news" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I know the newest jokes in tibia."
})
keywordHandler:addKeyword({ "how", "are", "you" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Thank you, I'm fine, the gods are with me."
})
keywordHandler:addKeyword({ "necromant", "nectar" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Pheeew! That sounds disgusting! Are you a cook at Frodo's?"
})
keywordHandler:addKeyword({ "necromant" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Don't feed the necromants."
})
keywordHandler:addKeyword({ "dog" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Are we talking about Noodles?"
})
keywordHandler:addKeyword({ "poodle" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Are we talking about Noodles?"
})
keywordHandler:addKeyword({ "noodles" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Hey, the little one is almost as funny as me!"
})
keywordHandler:addKeyword({ "muriel" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Better don't mess with sorcerers!"
})
keywordHandler:addKeyword({ "elane" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "She's pretty but too serious for my taste."
})
...
keywordHandler:addKeyword({ "gregor" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "A man of steel with a stomach of wax. Never offer him a beer!"
})
...
keywordHandler:addKeyword({ "god" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I better make no jokes about THIS matter."
})
...
keywordHandler:addKeyword({ "benjamin" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "He would make a fine jester, too."
})
keywordHandler:addKeyword({ "monster" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I know a lot of monster jokes. Just tell me a monster's name, come on."
})
keywordHandler:addKeyword({ "demon" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Why are the experienced heroes quicker than others? ... The demons love fast food!"
})
keywordHandler:addKeyword({ "ghoul" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Where do ghouls buy their robes? ... In a boooohtique!"
})
keywordHandler:addKeyword({ "dragon" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Why do dragons breathe fire? ... They ate too many sorcerers in chilli sauce!"
})
keywordHandler:addKeyword({ "orc" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Why do orcs have green skin? ... They ate at Frodo's!"
})
keywordHandler:addKeyword({ "cyclops" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "How many eyes does a cyclops have? ... One for each IQ point they have!"
})
keywordHandler:addKeyword({ "oswald" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "If you believe half the rumours he's spreading, you will get in a lot of trouble."
})
keywordHandler:addKeyword({ "dungeon" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "If you are a bad jester, you get a chance to visit them now and then."
})
...
keywordHandler:addKeyword({ "troll" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Why do trolls live underground? ... Because there are so many pks on the surface!"
})
keywordHandler:addKeyword({ "bonelord" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Why are bonelords so ugly? ... Because their mom and dad were bonelords, too!"
})
keywordHandler:addKeyword({ "rat" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Why does the rat have a wooden leg? ... Because it is a former pirate!"
})
...
keywordHandler:addKeyword({ "hugo" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I had a cousin named like that."
})
keywordHandler:addKeyword({ "cousin" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "He died some years ago."
})
keywordHandler:addKeyword({ "durin" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Isn't he the author of the book 'Fun with Demons'?"
})
keywordHandler:addKeyword({ "stephan" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "He is kind of a father figure to me. Of course he denies all kinship to me."
})
keywordHandler:addKeyword({ "steve" }, StdModule.say, {
	npcHandler = npcHandler,
...
keywordHandler:addKeyword({ "excalibug" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I am not foolish enough to believe in the existence of this weapon."
})
keywordHandler:addKeyword({ "wall", "carving" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Oh, I saw some demon carvings in the dungeons as I hid there after a little joke on old Stutch."
})
keywordHandler:addKeyword({ "demon", "carving" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Yes, they showed demons, seven actually, dancing around a sword! In something like a flaming pit."
})
keywordHandler:addKeyword({ "flaming", "pit" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Ah, don't ask me! Usually mages and mystics know more about such stuff."
})

local jobKeyword = keywordHandler:addKeyword({ "job" }, StdModule.say, {
	npcHandler = npcHandler,
...
jobKeyword:addChildKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "Thank you very much. I will have a drink or two on your health!",
		reset = true
	},
	nil,
	function(player)
		if player:removeMoneyBank(50) then  end
	end
)
jobKeyword:addChildKeyword({ "" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Well, perhaps later.",
	reset = true
})

local magicKeyword = keywordHandler:addKeyword({ "magic" }, StdModule.say, {
	npcHandler = npcHandler,
...
magicKeyword:addChildKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "Here you are, I already lessened your load.",
		reset = true
	},
	nil,
	function(player)
		if player:removeMoneyBank(200) then  end
	end
)
magicKeyword:addChildKeyword({ "" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "You don't know what offer you are missing!",
	reset = true
})
keywordHandler:addAliasKeyword({ "spell" })

local weaponKeyword = keywordHandler:addKeyword({ "weapon" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Do you want to buy a 'mace of the fury' for 250 gold?"
})
...
weaponKeyword:addChildKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "And here it is, it suits you well!",
		reset = true
	},
	nil,
	function(player)
...
weaponKeyword:addChildKeyword({ "" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "You dont know what offer you have passed!",
	reset = true
})
...
local kissKeyword = keywordHandler:addKeyword({ "kiss" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Do you want to kiss me?"
})
...
kissKeyword:addChildKeyword({ "" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Pah, I didn't want to kiss you anyway!",
	reset = true
})
...
local ladyKeyword = keywordHandler:addKeyword({ "lady" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Has any man said to you that you're not only beautiful but also intelligent?"
})
ladyKeyword:addChildKeyword({ "yes" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "This is a world of fantasy and full of surprises!",
	reset = true
})
ladyKeyword:addChildKeyword({ "" }, StdModule.say, {
	npcHandler = npcHandler,
