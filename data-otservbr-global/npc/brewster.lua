...
keywordHandler:addKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "I think you have forgotten to bring your stake, pilgrim."
	},
	function(player)
...
local stakeKeyword = keywordHandler:addKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "Yes, I have been informed and haven't yet drunk enough to forget, so you can count yourself lucky. Are you prepared to <hicks> receive my line of the prayer?"
	},
	function(player)
...
stakeKeyword:addChildKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "So receive my prayer: 'Your hand shall be guided - your feet shall walk in <hicks> harmony'. Now, take your stake to Tyrias in <hicks> Liberty Bay for the next line of the prayer. I shall let him know what he is to do.",
		reset = true
	},
	nil,
	function(player)
...
keywordHandler:addKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "You should visit Tyrias in Liberty Bay now."
	},
	function(player)
...
keywordHandler:addKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "You have already received my line of the prayer. Don't make me do more work than necessary!"
	},
	function(player)
		return player:getStorageValue(Storage.FriendsandTraders.TheBlessedStake) > 10
	end
...
keywordHandler:addKeyword({ "stake" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "A blessed stake? That's a <hicks> strange request. Maybe Quentin knows more, he is one of the oldest monks after all."
})
