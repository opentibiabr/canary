...
addTravelKeyword(
	"farmine",
	{ "Do you seek a ride to Farmine for |TRAVELCOST|?", "Full steam ahead!", "We would like to serve you some time." },
	210,
...
keywordHandler:addKeyword({ "passage" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Do you want me take you to {Cormaya}, {Farmine} or to {Gnomprona}?"
})
