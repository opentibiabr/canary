...
keywordHandler:addKeyword({ "disturb" }, StdModule.say, {
	...
	text = "I'm the foreman of this {mine}."
})
keywordHandler:addAliasKeyword({ "job" })
keywordHandler:addAliasKeyword({ "shop" })
keywordHandler:addKeyword({ "dwarfs" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "We understand the ways of the earth like nobody else."
})
keywordHandler:addKeyword({ "help" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I'm a miner, not your mother. Go ask someone else."
})
keywordHandler:addKeyword({ "hideout" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "The hideout of the Horned Fox is probably a dangerous if not lethal place for inexperienced adventurers. It is the source of all the {trouble} around here."
})
keywordHandler:addKeyword({ "horned fox" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "He is a minotaur who was kicked out of Mintwallin. He must have some kind of {hideout} nearby."
})
keywordHandler:addKeyword({ "mine" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "This is not an amusement park! Leave the miners and their drilling-worms alone and get out! We've already got enough {trouble} without you."
})
keywordHandler:addAliasKeyword({ "dungeon" })
keywordHandler:addKeyword({ "monster" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "We occasionally come across nasty beasts in the deepest mines."
})
keywordHandler:addKeyword({ "name" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "My name is Budrik Deepdigger, Son of Earth, from the Molten Rock."
})
keywordHandler:addKeyword({ "time" }, StdModule.say, {
	npcHandler = npcHandler,
	text = { "Precisely " .. getFormattedWorldTime() .. ", young one." }
})
keywordHandler:addKeyword({ "trouble" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "The {Horned Fox} is leading his bandits in sneak attacks and raids on us."
})
keywordHandler:addKeyword({ "shearton softbeard" }, StdModule.say, {
	npcHandler = npcHandler,
	text = { "Yes, I remember him well. It was a tragedy. An earthquake led to a cave-in and many of our brave miners died. ...", "Their ghosts still haunt the Grothmok tunnel in which they died, so we had to seal it off." }
})
keywordHandler:addKeyword({ "grothmok" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "You may enter the tunnel."
})
keywordHandler:addKeyword({ "deeper mines" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "This is no funhouse. Leave the miners and their drilling-worms alone and get out! We have already enough trouble without you."
})
