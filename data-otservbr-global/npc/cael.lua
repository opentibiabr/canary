...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "tome") or MsgContains(message, "knowledge") then
		if player:getStorageValue(TheNewFrontier.Mission08) == 2 then
			if player:getStorageValue(TheNewFrontier.TomeofKnowledge) < 1 then
				npcHandler:say("Oh! That sounds fascinating. Have you found a Tome of Knowledge for me to read?", npc, creature)
				npcHandler:setTopic(playerId, 1)
			elseif player:getStorageValue(TheNewFrontier.TomeofKnowledge) >= 1 and player:getStorageValue(TheNewFrontier.TomeofKnowledge) <= 5 then
			...
			elseif player:getStorageValue(TheNewFrontier.TomeofKnowledge) >= 6 and player:getStorageValue(TheNewFrontier.TomeofKnowledge) <= 11 then
			...
			elseif player:getStorageValue(TheNewFrontier.TomeofKnowledge) >= 12 then
	...
	elseif MsgContains(message, "zao") then
		if npcHandler:getTopic(playerId) == 21 then
			...
			npcHandler:setTopic(playerId, 40) --more than tome12
		--tome1
