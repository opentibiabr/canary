...
keywordHandler:addKeyword({ "kick" }, StdModule.kick, {
	npcHandler = npcHandler,
	destination = { Position(32384, 31815, 6), Position(32387, 31815, 6), Position(32390, 31815, 6) }
})

-- Basic
keywordHandler:addKeyword({ "name" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "My name is Captain Greyhound from the Royal Tibia Line."
})
...
keywordHandler:addKeyword({ "trip" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Where do you want to go? To {Thais}, {Ab'Dendriel}, {Venore}, {Svargrond}, {Yalahar} or {Edron?}"
})
...
keywordHandler:addKeyword({ "carlin" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "This is Carlin. Where do you want to go?"
})
