...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif MsgContains(message, "yes") then
		if npcHandler:getTopic(playerId) == 1 then
			...
			npcHandler:setTopic(playerId, 0) --test
...
keywordHandler:addKeyword({ "name" }, StdModule.say, {
	...
	text = "My name is Haba, Captain Haba for ya little worm."
})
keywordHandler:addKeyword({ "pirate" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I ain't no pirate. Don't let yourself mislead by my pirate hat. I got it from a friend of mine."
})
keywordHandler:addKeyword({ "friend" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Most o' my friends are dead the others don't like me anymore......well, seems there aren't many left."
})
keywordHandler:addKeyword({ "yeti" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "What fo' godsake shall that be??"
})
keywordHandler:addAliasKeyword({ "chakoya" })
keywordHandler:addKeyword({ "barbarian" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Who are ya calling a barbarian?!? Watch your tongue here on board or you end up as fish fodder!"
})
keywordHandler:addKeyword({ "port hope" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Dis is no passenger ship it's a WARship. I'm on hunting business."
})
...
keywordHandler:addKeyword({ "ferumbras" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Never heard of him. He is no captain that's for sure, otherwise I'd know him. I was on the sea for the last 20 years hunting this, this monster."
})
keywordHandler:addKeyword({ "monster" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Yee, I've been chasing that monster for over 20 years now. I promise I'll bring it down!"
})
...
keywordHandler:addKeyword({ "rum" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "It lets me forget the long years, the lost years. The years I was chasing after THAT monster, the sea serpent."
})
keywordHandler:addKeyword({ "job" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Ye, I command 'is ship!"
})
keywordHandler:addKeyword({ "ship" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Our last ship has been destroyed by the most evil creature of the ocean: the sea serpent. To continue our hunt, I've bought this ship here."
})
...
keywordHandler:addKeyword({ "banor" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I'm faithful - I'll catch that monster one day. Yes I will, as sure as my name is Captain Haba!!"
})
keywordHandler:addAliasKeyword({ "uman" })
keywordHandler:addAliasKeyword({ "zathroth" })
keywordHandler:addKeyword({ "queen" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "On the high seas there is no queen. At least I didn't see her yet. Hararar!"
})
keywordHandler:addKeyword({ "king" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "On the high seas there is no king. At least I didn't see him yet. Hararar!"
})
keywordHandler:addKeyword({ "body" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Arms, legs, head, whatever. I got injuries on almost every part of my body!"
})
keywordHandler:addKeyword({ "buy" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "This is no shop boy, this is a warship!"
})
keywordHandler:addAliasKeyword({ "shop" })
keywordHandler:addAliasKeyword({ "sell" })
keywordHandler:addKeyword({ "camp" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "We aren't even near that location! Wanna swim? Harharhar!"
})
...
keywordHandler:addKeyword({ "druid" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I know Marvik in Thais. He once helped me with a furuncle I had on my ...ahh, doesn't matter. He's a nice gran'pa, though!"
})
keywordHandler:addKeyword({ "enemies" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "My worst enemy is a huge sea serpent. I dunno when I started to follow it's trail. I'll kill it and if it's the last thing I'll do, I'll kill it!"
})
keywordHandler:addAliasKeyword({ "victory" })
keywordHandler:addKeyword({ "leader" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "This is a ship and the captain is some kind o' leader, isn't he? <mumbles>..stupid..landlubber."
})
keywordHandler:addKeyword({ "raiders" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "What fo' godsake shall that be??"
})
keywordHandler:addKeyword({ "shaman" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Seems that they are some sort o' druids fo' the Norseman."
})
keywordHandler:addKeyword({ "story" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I'm full of stories mate! Name a body part and I tell you the story what happened to it!"
})
