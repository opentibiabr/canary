...
local travelNode = keywordHandler:addKeyword({ "liberty bay" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Do you want go back to Liberty Bay?"
})
travelNode:addChildKeyword({ "yes" }, StdModule.travel, {
	...
	level = 0,
	cost = 0,
	destination = Position(32298, 32895, 6)
})
...
keywordHandler:addKeyword({ "back" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Do you want go back to {Liberty Bay}?"
})
