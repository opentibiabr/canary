...
-- Darashia
local travelNode = keywordHandler:addKeyword({ "darashia" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Do you seek a passage to Darashia for |TRAVELCOST|?",
	cost = 0,
	discount = "postman"
})
local childTravelNode = travelNode:addChildKeyword({ "yes" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I warn you! This route is haunted by a ghostship. Do you really want to go there?"
})
...
childTravelNode:addChildKeyword({ "no" }, StdModule.say, {
	npcHandler = npcHandler,
	reset = true,
	text = "We would like to serve you some time."
})
...
keywordHandler:addKeyword({ "kick" }, StdModule.kick, {
	npcHandler = npcHandler,
	destination = { Position(33498, 31711, 6) }
})

-- Basic
keywordHandler:addKeyword({ "sail" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Where do you want to go? To {Edron}, {Darashia}, {Oramond} or {Venore}?"
})
...
keywordHandler:addKeyword({ "venore" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "This is Venore. Where do you want to go?"
})
keywordHandler:addKeyword({ "name" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "My name is Captain Pelagia from the Royal Tibia Line."
})
