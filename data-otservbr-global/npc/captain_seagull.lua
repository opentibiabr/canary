...
keywordHandler:addKeyword({ "kick" }, StdModule.kick, {
	npcHandler = npcHandler,
	destination = { Position(32724, 31669, 6), Position(32726, 31665, 6) }
})

-- Basic
keywordHandler:addKeyword({ "name" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "My name is Captain Seagull from the Royal Tibia Line."
})
...
keywordHandler:addKeyword({ "trip" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Where do you want to go? To {Thais}, {Carlin}, {Venore}, {Yalahar}, {Edron} or {Gray Island}?"
})
keywordHandler:addKeyword({ "passage" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "WWhere do you want to go? To {Thais}, {Carlin}, {Venore}, {Yalahar}, {Edron} or {Gray Island}?"
})
...
keywordHandler:addKeyword({ "ankrahmun" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I'm sorry, but we don't serve this route."
})
keywordHandler:addKeyword({ "tiquanda" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I'm sorry, but we don't serve this route."
})
...
keywordHandler:addKeyword({ "ab'dendriel" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "This is Ab'Dendriel. Where do you want to go?"
})
