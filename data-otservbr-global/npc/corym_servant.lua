...
local function greetCallback(npc, creature, message)
	...
	elseif player:getStorageValue(HiddenThreats.QuestLine) == 4 then
		npcHandler:setMessage(MESSAGE_GREET, { "Well, I see you have already collected enough rare earth! Would you give it to me?" })
	elseif player:getStorageValue(HiddenThreats.QuestLine) == 3 then
		npcHandler:setMessage(MESSAGE_GREET, { "You have to liberate all the Corym I told you. Unlock the three affected areas." })
	else
