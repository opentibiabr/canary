...
-- WAYFARER END --
keywordHandler:addKeyword({ "addons" }, StdModule.say, {
	npcHandler = npcHandler,
	onlyFocus = true,
	text = "I can offer you first & second addons of the following outfit: {Wayfarer}."
})

keywordHandler:addKeyword({ "storage" }, StdModule.say, {
	npcHandler = npcHandler,
	onlyFocus = true,
	text = "Ask about {first addon} or {second addon}."
})
...
keywordHandler:addKeyword({ "help" }, StdModule.say, {
	npcHandler = npcHandler,
	onlyFocus = true,
	text = "llected all the required pieces, say 'yes' and voila - you got yourself an addon!"
})

local node1 = keywordHandler:addKeyword({ "first addon" }, StdModule.say, {
	npcHandler = npcHandler,
	onlyFocus = true,
	text = "To achieve the first storage addon you need to give me the Old Cape. Do you have them with you?"
})
...
local node2 = keywordHandler:addKeyword({ "second addon" }, StdModule.say, {
	npcHandler = npcHandler,
	onlyFocus = true,
	text = "To achieve the second storage addon you need to give me the Sedge Hat. Do you have them with you?"
})
