local internalNpcName = "Croupier"
...
local config = {
	...
	playerPosition = Position(1553, 1343, 6), -- NpcPos(x-2) player must stay on this position to talk with npc
	dicerCounter = Position(1553, 1342, 6), --	NpcPos(x-1, y-1) 	counter position
	diePos = Position(1552, 1342, 6), --NpcPos(y-1)
}
