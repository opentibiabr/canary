...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "spell") then
		if player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission03.AnUnlikelyCouple) == 1 and player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission03.UnlikelyCouple) == 1 then
			npcHandler:say({
			...
			player:setStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission03.UnlikelyCouple, 2)
