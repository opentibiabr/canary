...
local function greetCallback(npc, creature)
	...
	if greetMessage and player:getStorageValue(Storage.Diapason.Edala) == 1 and player:getStorageValue(Storage.Diapason.EdalaTimer) < os.time() then
...
-- Fire of the Suns
local blessKeyword = keywordHandler:addKeyword({ "suns" }, StdModule.say, {
...
blessKeyword:addChildKeyword({ "yes" }, StdModule.bless, {
	npcHandler = npcHandler,
	text = "So receive the fire of the suns, pilgrim.",
	cost = "|BLESSCOST|",
	bless = 4
})
