...
keywordHandler:addKeyword({ "queen" }, StdModule.say, {
	...
	text = "I am privileged to be in service of our beloved queen!"
})
keywordHandler:addKeyword({ "carlin" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "We are proud people who fought hard for their freedom and won't allow others to oppress us again."
})
keywordHandler:addKeyword({ "service" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I am the head of Carlin's Girls Brigade, also known as CGB."
})
...
keywordHandler:addKeyword({ "avin" }, StdModule.say, {
	npcHandler = npcHandler,
	text = { "The AVIN is rather a crime syndicate than anything else. If there is something dirty and illegal, they are most likely involved. ...", "They are unscrupulous and also do not back away from blackmailing and assassination." }
})
...
keywordHandler:addKeyword({ "name" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I am known as Emma."
})
keywordHandler:addKeyword({ "ab'dendriel" }, StdModule.say, {
	npcHandler = npcHandler,
	text = { "The elves of Ab'Dendriel are our allies. Our druids contribute most to keeping such a good relation. ...", "They seem to understand the elves a bit better than we ordinary people do." }
})
keywordHandler:addKeyword({ "thais" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "The Thaians never got over the fact that we gained our independence. They do everything they can to hinder the prospering of our city."
})
keywordHandler:addKeyword({ "venore" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Venore is a hellhole of evil. The trade barons' greed lets them plot against all other cities and even against each other."
})
keywordHandler:addKeyword({ "svargrond" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Svargrond is an important project for our city. It's not a colony but many of our people live there alongside those barbarians. If everything works out fine, Carlin and Svargrond will both prosper."
})
keywordHandler:addKeyword({ "ankrahmun" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Strange people with strange customs live in this city. Luckily, we rarely have to deal with them."
})
keywordHandler:addKeyword({ "darashia" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Darashia never bothers about the affairs of other cities."
})
keywordHandler:addKeyword({ "liberty bay" }, StdModule.say, {
	npcHandler = npcHandler,
	text = { "The name of the city is a cruel joke. The people there are oppressed by Thais and Venore who slowly bleed the isle and its people white. ...", "It shows what would have happened to us if our rebellion had failed." }
})
keywordHandler:addKeyword({ "port hope" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "It's just another Thaian puppet. Still, it is distant enough to stand a fair chance to get rid of Thais's oppression one day."
})
keywordHandler:addKeyword({ "kazordoon" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "The dwarfs of Kazordoon usually mind their own business. I wish all other cities would do the same."
})
