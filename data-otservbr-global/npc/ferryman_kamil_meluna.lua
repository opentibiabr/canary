...
local travelNode = keywordHandler:addKeyword({ "fibula" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "You want me to transport you and your spouse back to {Fibula}?"
})
travelNode:addChildKeyword({ "yes" }, StdModule.travel, {
	...
	level = 0,
	cost = 0,
	destination = Position(32153, 32457, 7)
})
