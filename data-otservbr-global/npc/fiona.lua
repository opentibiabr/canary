...
keywordHandler:addKeyword({ "magical ingredients" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Oof, there are too many to list. Magical ingredients can sometimes be found when you defeat a monster, for example bat wings. I buy many of these things if you don't want to use them for quests, just ask me for a {trade}."
})
...
npcConfig.shop = { {
	...
	itemName = "dragon priests wandtip",
	clientId = 10444,
	sell = 175
}, {
	itemName = "dragons tail",
	clientId = 11457,
	sell = 100
}, {
	...
	itemName = "flask of warriors sweat",
	clientId = 5885,
	sell = 10000
}, {
