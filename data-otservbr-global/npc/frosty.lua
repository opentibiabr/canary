...
npcConfig.outfit = { lookType = 1159 }
...
local sleightInfo = {
	["bright percht sleigh"] = {
		...
		items = { { 30192, 1 } },
		mount = 133,
		storageID = Storage.Percht1
	},
	["cold percht sleigh"] = {
		cost = 0,
		items = { { 30192, 1 } },
		mount = 132,
		storageID = Storage.Percht2
	},
	["dark percht sleigh"] = {
		cost = 0,
		items = { { 30192, 1 } },
		mount = 134,
		storageID = Storage.Percht3
	}
}
...
keywordHandler:addKeyword({ "carrot" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "What about 'no' do you not understand, hrm? You are more annoying than any {percht} around here! Not to mention those bothersome {bunnies} who try to graw away my nose!"
})
keywordHandler:addKeyword({ "percht skull" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Well why didn't you say that rightaway, if you give me such a skull I can give you one of my {sleighs}."
})
keywordHandler:addKeyword({ "bunnies" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Always trying to eat my nose!"
})
