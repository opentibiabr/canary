...
keywordHandler:addKeyword({ "news" }, StdModule.say, { npcHandler = npcHandler, text = "News? Of course there's news! There's a new furniture man in town, and he's here to stay! You mean my specials, don't you? (Cannot trigger this transcript)" })
...
keywordHandler:addKeyword({ "topsy" }, StdModule.say, { npcHandler = npcHandler, text = "Ah, those twins. Strange people they are (*sigh*). Oh, they are great to work with, of course. Excellent quality, competetive prices! But well... (whispers) they give me the creeps!" })
keywordHandler:addKeyword({ "turvy" }, StdModule.say, { npcHandler = npcHandler, text = "Ah, those twins. Strange people they are (*sigh*). Oh, they are great to work with, of course. Excellent quality, competetive prices! But well... (whispers) they give me the creeps!" })
keywordHandler:addKeyword({ "twins" }, StdModule.say, { npcHandler = npcHandler, text = "Ah, those twins. Strange people they are (*sigh*). Oh, they are great to work with, of course. Excellent quality, competetive prices! But well... (whispers) they give me the creeps!" })
