...
npcConfig.shop = { {
	...
	itemName = "gnomish crystal package",
	clientId = 15802,
	buy = 1000
}, {
	itemName = "gnomish extraction crystal",
	clientId = 15696,
	buy = 50
}, {
	itemName = "gnomish repair crystal",
	clientId = 15703,
	buy = 50
}, {
	itemName = "gnomish spore gatherer",
	clientId = 15821,
	buy = 50
}, {
	itemName = "little pig",
...
local config = {
	...
	["addition to the soil guardian outfit"] = {
		itemid = 16253,
		token = {
			type = "minor",
			id = 16128,
	...
	["addition to the crystal warlord armor outfit"] = {
		itemid = 16256,
		token = {
			type = "minor",
			id = 16128,
...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif MsgContains(message, "relations") then
		...
		if player:getStorageValue(Storage.BigfootBurden.QuestLine) >= 25 then
			...
			npcHandler:say(
				"Your renown amongst us gnomes is currently {" .. math.max(0, player:getStorageValue(Storage.BigfootBurden.Rank)) .. "}. Do you want to improve your standing by sacrificing tokens? One token will raise your renown by 5 points. ",
				npc,
				creature
			)
