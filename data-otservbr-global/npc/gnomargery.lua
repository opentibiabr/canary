...
local function creatureSayCallback(npc, creature, type, message)
	...
	if talkState[playerId] == "report" then
		if MsgContains(message, "delivery") then
			if player:getStorageValue(Storage.Quest.U10_20.SpikeTaskQuest.Constants.Spike_Lower_Parcel_Main) == -1 then
		...
		elseif MsgContains(message, "undercover") then
			if player:getStorageValue(Storage.Quest.U10_20.SpikeTaskQuest.Constants.Spike_Lower_Undercover_Main) == -1 then
				npcHandler:say("You have not started that mission.", npc, creature)
		...
		elseif MsgContains(message, "temperature") then
			if player:getStorageValue(Storage.Quest.U10_20.SpikeTaskQuest.Constants.Spike_Lower_Lava_Main) == -1 then
				npcHandler:say("You have not started that mission.", npc, creature)
		...
		elseif MsgContains(message, "kill") then
			if player:getStorageValue(Storage.Quest.U10_20.SpikeTaskQuest.Constants.Spike_Lower_Kill_Main) == -1 then
				npcHandler:say("You have not started that mission.", npc, creature)
	...
	if MsgContains(message, "deliver") then
		if player:getStorageValue(Storage.Quest.U10_20.SpikeTaskQuest.Constants.Spike_Lower_Parcel_Daily) >= os.time() then
			return npcHandler:say("Sorry, you have to wait " .. string.diff(player:getStorageValue(Storage.Quest.U10_20.SpikeTaskQuest.Constants.Spike_Lower_Parcel_Daily) - os.time()) .. " before this task gets available again.", npc, creature)
		end
	...
	if talkState[playerId] == "delivery" then
		if MsgContains(message, "yes") then
			...
			player:setStorageValue(Storage.Quest.U10_20.SpikeTaskQuest.Constants.Spike_Lower_Parcel_Main, 0)
	...
	if MsgContains(message, "undercover") then
		if player:getStorageValue(Storage.Quest.U10_20.SpikeTaskQuest.Constants.Spike_Lower_Undercover_Daily) >= os.time() then
			return npcHandler:say("Sorry, you have to wait " .. string.diff(player:getStorageValue(Storage.Quest.U10_20.SpikeTaskQuest.Constants.Spike_Lower_Undercover_Daily) - os.time()) .. " before this task gets available again.", npc, creature)
		end
	...
	if talkState[playerId] == "undercover" then
		if MsgContains(message, "yes") then
			player:setStorageValue(Storage.Quest.U10_20.SpikeTaskQuest.Constants.Spike_Lower_Undercover_Main, 0)
	...
	if MsgContains(message, "temperature") then
		if player:getStorageValue(Storage.Quest.U10_20.SpikeTaskQuest.Constants.Spike_Lower_Lava_Daily) >= os.time() then
			return npcHandler:say("Sorry, you have to wait " .. string.diff(player:getStorageValue(Storage.Quest.U10_20.SpikeTaskQuest.Constants.Spike_Lower_Lava_Daily) - os.time()) .. " before this task gets available again.", npc, creature)
		end
	...
	if talkState[playerId] == "temperature" then
		if MsgContains(message, "yes") then
			...
			player:setStorageValue(Storage.Quest.U10_20.SpikeTaskQuest.Constants.Spike_Lower_Lava_Main, 0)
	...
	if MsgContains(message, "kill") then
		if player:getStorageValue(Storage.Quest.U10_20.SpikeTaskQuest.Constants.Spike_Lower_Kill_Daily) >= os.time() then
			return npcHandler:say("Sorry, you have to wait " .. string.diff(player:getStorageValue(Storage.Quest.U10_20.SpikeTaskQuest.Constants.Spike_Lower_Kill_Daily) - os.time()) .. " before this task gets available again.", npc, creature)
		end
	...
	if talkState[playerId] == "kill" then
		if MsgContains(message, "yes") then
			player:setStorageValue(Storage.Quest.U10_20.SpikeTaskQuest.Constants.Spike_Lower_Kill_Main, 0)
