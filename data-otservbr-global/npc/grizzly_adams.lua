...
local tier = {
	...
	{
		allName = { "hydras", "serpent spawns", "medusa", "behemoths", "sea serpents", "hellhounds", "ghastly dragons", "undead dragons", "drakens", "destroyers", "hydra", "serpent spawn", "medusa", "behemoth", "sea serpent", "hellhound", "ghastly dragon", "undead dragon", "draken", "destroyer" },
		withsName = { "hydras", "serpent spawns", "medusa", "behemoths", "sea serpents", "hellhounds", "ghastly dragons", "undead dragons", "drakens", "destroyers" },
	},
}
local messageStartTask = {
	...
	["medusa"] = "They live deep in the old ruins of Banuta and they are nasty! I think a mere 500 medusa should do the trick. What do you say?",
...
local messageStartTaskAlt = {
	...
	["medusa"] = messageStartTask["medusa"],
...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif table.contains({ "tasks", "task", "mission" }, message:lower()) then
		...
		elseif player:getLevel() >= 130 and player:getStorageValue(POINTSSTORAGE) < 100 then
			npcHandler:say({
				"Alright, what would you like to hunt? You can try {hydras}, {serpent spawns}, {medusa}, {behemoths}, {sea serpents}, ...",
			...
			npcHandler:say({
				...
				"You can try {hydras}, {serpent spawns}, {medusa}, {behemoths}, {sea serpents}, ...",
