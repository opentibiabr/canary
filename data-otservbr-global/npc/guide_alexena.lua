...
keywordHandler:addKeyword({ "map" }, StdModule.say, { npcHandler = npcHandler, text = "Would you like me to mark locations like - for example - the depot, bank and shops on your map?" })
keywordHandler:addKeyword({ "mark" }, StdModule.say, { npcHandler = npcHandler, text = "Would you like me to mark locations like - for example - the depot, bank and shops on your map?" })
