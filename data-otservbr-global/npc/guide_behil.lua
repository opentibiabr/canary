...
local configMarks = { {
	mark = "shops",
	position = Position(33223, 32422, 7),
	markId = MAPMARK_BAG,
	description = "Shops"
}, {
	mark = "depottp",
	position = Position(33214, 32453, 7),
	markId = MAPMARK_LOCK,
	description = "Depot and Temple"
} }
...
keywordHandler:addKeyword({ "temple" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "The temple is a few floors over the depot. Just walk up the numerous stairs there."
})
...
keywordHandler:addKeyword({ "name" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "My name is Behil. Glad to be your guide."
})
