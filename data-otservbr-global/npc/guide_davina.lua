...
local configMarks = { {
	mark = "shops",
	position = Position(32293, 32824, 7),
	markId = MAPMARK_BAG,
	description = "Shops"
}, {
	mark = "depot",
	position = Position(32336, 32838, 7),
	markId = MAPMARK_LOCK,
	description = "Depot"
}, {
	mark = "temple",
	position = Position(32317, 32826, 7),
...
keywordHandler:addKeyword({ "temple" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "The temple is just north west of the depot. You can't miss it."
})
keywordHandler:addKeyword({ "bank" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Jefrey, our bank clerk, can be found inside the depot. Easy to find."
})
...
keywordHandler:addKeyword({ "job" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Well, I'm a guide. I can mark important locations on your map and give you some information about the town. I do this for free, but I'm always happy about a small donation if you can spare some money."
})
keywordHandler:addKeyword({ "town" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "This city has three main districts - a noble district, a merchant district and the slums. The class difference is clearly visible here. Most shops are in the merchant district. There are also large sugarcane plantations."
})
keywordHandler:addKeyword({ "name" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I'm Davina. Glad to help you today."
})
