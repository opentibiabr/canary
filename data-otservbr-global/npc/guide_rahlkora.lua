...
local configMarks = { {
	mark = "shops",
	position = Position(33130, 32815, 7),
	markId = MAPMARK_BAG,
	description = "Shops"
}, {
	mark = "depot",
	position = Position(33126, 32841, 7),
	markId = MAPMARK_LOCK,
	description = "Depot"
}, {
	mark = "temple",
	position = Position(33195, 32852, 7),
...
keywordHandler:addKeyword({ "information" }, StdModule.say, {
	...
	text = "Currently, I can tell you all about the town, its temple, the bank, shops, spell trainers and the depot."
})
keywordHandler:addKeyword({ "temple" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "The temple is in the south-eastern part of town. If you exit the depot to the south and walk east - slightly south-east - you can't miss it."
})
keywordHandler:addKeyword({ "bank" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Tesha is in charge of both the bank and the gem store. You can find her on the market pyramid. Just exit the depot on the north side and walk up the next pyramid."
})
...
keywordHandler:addKeyword({ "job" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I will help you to find your way around Ankrahmun. I can mark important locations on your map and give you some information about the town."
})
keywordHandler:addKeyword({ "town" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Ankrahmun consists almost completely of pyramids. You can walk up and down those pyramids just like you'd climb up stairs. Most shops are on the upper floors."
})
keywordHandler:addKeyword({ "name" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "My name is Rahlkora. I'm a guide."
})
