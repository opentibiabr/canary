...
local configMarks = { {
	mark = "depot",
	position = Position(32681, 31686, 7),
	markId = MAPMARK_LOCK,
	description = "Depot and Shops"
}, {
	mark = "temple",
	position = Position(32732, 31634, 7),
...
keywordHandler:addKeyword({ "temple" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "The temple is built around the elves' holy tree. You can find it north of this harbour."
})
keywordHandler:addKeyword({ "bank" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Finarfin is in charge of the bank. You can find him on the lowest floor of the depot."
})
keywordHandler:addKeyword({ "shops" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "You can buy weapons, armor, tools, gems, magical equipment, instruments, furniture, spells and food here."
})
...
keywordHandler:addKeyword({ "town" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "The elves have constructed Ab'Dendriel mainly in and on trees. There is also a large underground cave system with shops, a prison and troll caves."
})
