...
local configMarks = { {
	mark = "depot",
	position = Position(32631, 32742, 7),
	markId = MAPMARK_LOCK,
	description = "Depot"
}, {
	mark = "temple",
	position = Position(32594, 32745, 7),
...
keywordHandler:addKeyword({ "temple" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "The temple is in the north-eastern part of town, left of the depot. The priest there has a little alcohol problem, though. It's sad."
})
keywordHandler:addKeyword({ "bank" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Our bank can be found one floor above the depot. Just talk to Ferks."
})
keywordHandler:addKeyword({ "shops" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "The shops here are very close to one another. I can mark them for you if you'd like."
})
...
keywordHandler:addKeyword({ "job" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I'll help you not to get lost in Port Hope. I can mark important locations on your map and give you some information about the town and the world status."
})
keywordHandler:addKeyword({ "town" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "The inhabitants of Port Hope are bravely facing the constant threat from the jungle. The town is built on pile dwellings and most shops are close to each other."
})
keywordHandler:addKeyword({ "name" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I'm Tiko and your guide today. Have a good day!"
})
