...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "mission") then
		...
		elseif questProgress == 2 then
			npcHandler:say({ "Whisper moss strong is, but me need liquid that humans have to make it work ...", "Our raiders brought it from human settlement, it's called cough syrup. Go ask healer there for it." }, npc, creature)
...
keywordHandler:addKeyword({ "kongra" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Kongra verry strong. Kongra verry angry verry fast. Take care when kongra comes. Better climb on highest tree."
})
keywordHandler:addKeyword({ "sibang" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Sibang verry fast and funny. Sibang good gather food. Sibang know {jungle} well."
})
keywordHandler:addKeyword({ "merlkin" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Merlkin we are. Merlkin verry wise, merlkin learn many things quick. Teach other apes things a lot. Making {heal} and making {magic}."
})
...
npcConfig.shop = { {
	...
	itemName = "monkey statue 'hear' kit",
	clientId = 5087,
	buy = 65
}, {
	itemName = "monkey statue 'see' kit",
	clientId = 5086,
	buy = 65
}, {
	itemName = "monkey statue 'speak' kit",
	clientId = 5088,
	buy = 65
} }
