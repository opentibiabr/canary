...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif MsgContains(message, "ser tybald") then
		npcHandler:say(
			{ "I wish I had thought of changing my name to that of a hero. Would have smoothed my way no end!", "Anyway, whatever he was before he joined, Tybald now fits the bill of the legendary hero. \z
...
npcConfig.shop = { {
	...
	itemName = "light stone shower rune",
	clientId = 21351,
	buy = 25
}, {
	itemName = "lightest missile rune",
	clientId = 21352,
	buy = 20
}, {
