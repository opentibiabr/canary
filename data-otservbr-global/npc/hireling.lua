function createHirelingType(HirelingName)
	...
	npcConfig.shop = { {
		...
		itemName = "bamboo drawer kit",
		clientId = 2795,
		buy = 20
	}, {
		itemName = "bamboo table kit",
		clientId = 2788,
		buy = 25
	}, {
		itemName = "barrel kit",
		...
		itemName = "tusk chair kit",
		clientId = 2780,
		buy = 25
	}, {
		itemName = "tusk table kit",
		clientId = 2787,
		buy = 25
	}, {
		...
		itemName = "venorean cabinet",
		clientId = 17974,
		buy = 90
	}, {
		itemName = "venorean drawer",
		clientId = 17977,
		buy = 40
	}, {
		itemName = "venorean wardrobe",
		clientId = 17975,
		buy = 50
	}, {
		itemName = "vial",
	...
	npcType.onAppear = function(npc, creature)
		...
		if not hireling then
			...
			if not hireling then return end
	...
	local TOPIC_FOOD = { SKILL_CHOOSE = 1301 }
	...
	local function getHirelingServiceString(creature)
		...
		for i = 1, #skills do
			...
			if skills[i] == HIRELING_SKILLS.BANKER then
				str = str .. "to access your {bank} account"
			-- TODO: this setence is not official
	...
	local function getDeliveredMessageByFoodId(
	food_id -- remove the hardcoded food ids
	)
		local message = ""
	...
	local function cookFood(npc, creature)
		...
		if random == 6 then
			...
			npcHandler:say("Yay! I have the ingredients to make a skill boost dish. Would you rather like to boost your {magic}, {melee}, {shielding} or {distance} skill?", npc, creature) -- deliver the random generated index
		else
