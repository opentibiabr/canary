...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif MsgContains(message, "balanced") then
		npcHandler:say(
			{ "Balanced {fighting} balances out your attack strength as well as your defense strength. \z
					Magical damage you deal is not affected by this. ...", "I can also tell you something about {offensive} and {defensive} fighting." },
			npc,
			creature,
			10
		)
	elseif MsgContains(message, "defensive") then
		npcHandler:say(
			{ "Defensive {fighting} increases your defense but reduces your attack strength. \z
					The magical damage you deal is not affected by this. ...", "I can also tell you something about {offensive} and {balanced} fighting." },
			npc,
			creature,
			10
		)
	...
	elseif MsgContains(message, "yes") and npcHandler:getTopic(playerId) == 1 then
		npcHandler:say(
			...
			You can never come back here if you leave now, and you will loso all your Dawnport equipment and products! ...", "Are you {SURE} you want to {LEAVE} Dawnport for ROOKGAARD?" },
			npc,
			creature,
			10
		)
	...
	elseif npcHandler:getTopic(playerId) == 2 and MsgContains(message, "yes") or MsgContains(message, "sure") or MsgContains(message, "leave") then
		...
		local slots = { 1, 2, 4, 5, 6, 7, 8, 9, 10 }
		...
		local toBeDeleted = {}
		local allowedIds = { 2853, 2920, 3003, 3031 }
