...
keywordHandler:addKeyword({ "need" }, StdModule.say, {
	...
	text = "I am a jeweller. Maybe you want to have a look at my wonderful {offers}."
})
keywordHandler:addKeyword({ "offers" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Well, I sell gems and {goblets}. If you'd like to see my offers, ask me for a {trade}."
})
keywordHandler:addKeyword({ "goblets" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Ah, our newest import! We have golden goblets, silver goblets and bronze goblets. All of them have space for a hand-written dedication."
})
