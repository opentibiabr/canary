...
keywordHandler:addKeyword({ "silus" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "My {father}, can you tell me if he's alright?"
})
keywordHandler:addKeyword({ "thais" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Alright then, you are very welcome to explore the temple!"
})
keywordHandler:addKeyword({ "name" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "My name is Ivalisse."
})
keywordHandler:addKeyword({ "time" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "There is always time to make a change."
})
...
keywordHandler:addKeyword({ "duties" }, StdModule.say, {
	npcHandler = npcHandler,
