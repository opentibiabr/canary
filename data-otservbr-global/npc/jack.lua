...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif MsgContains(message, "furniture") then
		if player:getStorageValue(Storage.TibiaTales.JackFutureQuest.QuestLine) == 3 then
			if
				(player:getStorageValue(Storage.TibiaTales.JackFutureQuest.Furniture01) == 1)
				and (player:getStorageValue(Storage.TibiaTales.JackFutureQuest.Furniture02) == 1)
				and (player:getStorageValue(Storage.TibiaTales.JackFutureQuest.Furniture03) == 1)
				and (player:getStorageValue(Storage.TibiaTales.JackFutureQuest.Furniture04) == 1)
				and (player:getStorageValue(Storage.TibiaTales.JackFutureQuest.Furniture05) == 1)
			then
				npcHandler:say(
