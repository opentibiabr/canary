...
local travelNode = keywordHandler:addKeyword({ "thais" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Do you seek a passage back to thais?"
})
travelNode:addChildKeyword({ "yes" }, StdModule.travel, {
	...
	level = 0,
	cost = 0,
	destination = Position(32310, 32218, 5)
})
...
keywordHandler:addKeyword({ "passage" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I can travel you to {thais}."
})
