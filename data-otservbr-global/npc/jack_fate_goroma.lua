...
keywordHandler:addKeyword({ "job" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I'm the captain of this - well, wreck. Argh."
})
keywordHandler:addKeyword({ "captain" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I'm the captain of this - well, wreck. Argh"
})
keywordHandler:addKeyword({ "goroma" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "This is where we are... the volcano island Goroma. There are many rumours about this place."
})
