...
keywordHandler:addKeyword({'iceberg'}, StdModule.say, {npcHandler = npcHandler, text = {
...
keywordHandler:addKeyword({'language'}, StdModule.say, {npcHandler = npcHandler, text = {
...
keywordHandler:addKeyword({'legion'}, StdModule.say, {npcHandler = npcHandler, text = {
...
keywordHandler:addKeyword({'goal'}, StdModule.say, {npcHandler = npcHandler, text = {
...
keywordHandler:addKeyword({'purge'}, StdModule.say, {npcHandler = npcHandler, text = {
...
keywordHandler:addKeyword({'locations'}, StdModule.say, {npcHandler = npcHandler, text = {
