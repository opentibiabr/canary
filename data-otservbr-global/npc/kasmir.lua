...
keywordHandler:addKeyword(
	...
	function(player)
		return player:getStorageValue(Storage.FriendsandTraders.TheBlessedStake) == 7 and player:getItemCount(5941) == 0
	end
)
...
local stakeKeyword = keywordHandler:addKeyword(
	...
	function(player)
		return player:getStorageValue(Storage.FriendsandTraders.TheBlessedStake) == 7
	end
)
stakeKeyword:addChildKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "So receive my prayer: 'Let there be honour and humility'. Now, bring your stake to Rahkem in Ankrahmun for the next line of the prayer. I will inform him what to do.",
		reset = true
	},
	nil,
	function(player)
...
keywordHandler:addKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "You should visit Rahkem in Ankrahmun now, pilgrim."
	},
	function(player)
