...
keywordHandler:addKeyword({ "passage" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Where do you want to go? To {Nostalgia}, {Horror Village}"
})
...
keywordHandler:addKeyword({ "Nostalgia" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "This is Nostalgia. Where do you want to go?"
})
keywordHandler:addKeyword({ "Horror Village" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "This is Horror Village. Where do you want to go?"
})
