local internalNpcName = "Loot Trader"
...
npcConfig.voices = {
	interval = 15000,
	chance = 50,
	{text = 'Are you interested in a trade?'},{text = 'Dont sell to others im the best in town.'},{text = 'I will sell this stuff to monsters at double of  the price.'}
}
...
npcHandler:setMessage(MESSAGE_GREET, "Greatings, trader i was waiting for you.")
npcHandler:setMessage(MESSAGE_SENDTRADE, "Yes, i have almost everything, your may also ask me.")
npcHandler:setMessage(MESSAGE_FAREWELL, "Another idiot that loves gold, goodbye, |PLAYERNAME|.")
...
npcConfig.shop = {
    ...
    { itemName = "dragon lord trophy", clientId = 7399, sell = 15000 },
	...
	{ itemName = "demon trophy", clientId = 7393, sell = 15000 },
	{ itemName = "behemoth trophy", clientId = 7396, sell = 15000 },
    { itemName = "elite draken mail", clientId = 11651, sell = 150000 },
    { itemName = "draken sulphur", clientId = 11658, sell = 550 },
    { itemName = "dragon claws", clientId = 5919, sell = 150000 },          
    { itemName = "Zaoan halberd", clientId = 10406, sell = 3500 },
    { itemName = "twin hooks", clientId = 10392, sell = 1000 },
    { itemName = "Zaoan armor", clientId = 10384, sell = 15000 },
    { itemName = "Dracola's eyes", clientId = 6546, sell = 50000 },
    { itemName = "reaper's axe", clientId = 7420, sell = 2000000 },
    { itemName = "glooth cape", clientId = 21164, sell = 7000 },
    { itemName = "warrior's axe", clientId = 14040, sell = 11000 },
    { itemName = "calopteryx cape", clientId = 14086, sell = 5000 },
    { itemName = "glooth spears", clientId = 21158, sell = 200 },
    { itemName = "grasshopper legs", clientId = 14087, sell = 30000 },
    ...
    { itemName = "bronze amulet", clientId = 3056, buy = 100, count = 200, sell = 50 },
    { itemName = "club ring", clientId = 3093, buy = 500, sell = 100 },
    { itemName = "elven amulet", clientId = 3082, buy = 500, count = 50, sell = 100 },
    ...
    { itemName = "stone skin amulet", clientId = 3081, buy = 5000, count = 5, sell = 500 },
    ...
    { itemName = "dragon necklace", clientId = 3085, buy = 1000, count = 200, sell = 100 },
    ...
    { itemName = "might ring", clientId = 3048, buy = 5000, count = 20, sell = 250 },
    ...
    { itemName = "protection amulet", clientId = 3084, buy = 700, count = 250, sell = 100 },
    { itemName = "ring of healing", clientId = 3098, buy = 2000, sell = 100 },
    { itemName = "silver amulet", clientId = 3054, buy = 100, count = 200, sell = 50 },
    { itemName = "snakebite rod", clientId = 3066, sell = 100 },
    { itemName = "springsprout rod", clientId = 8084, sell = 3600 },
    { itemName = "strange talisman", clientId = 3045, buy = 100, count = 200, sell = 30 },
    ...
    { itemName = "sai", clientId = 10389, sell = 16000 },
    { itemName = "nightmare blade ", clientId = 7418, sell = 40000 },                  
    { itemName = "dragon scale mail", clientId = 3386, sell = 15000 },
    { itemName = "warrior helmet", clientId = 3369, sell = 5000 },
    ...
    { itemName = "shoesZaoan ", clientId = 10386, sell = 5000 },
