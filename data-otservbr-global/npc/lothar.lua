...
keywordHandler:addKeyword({ "barrel" }, StdModule.say, { npcHandler = npcHandler, text = "In some parts of this world, creatures are using barrels to roll down hills and even mountains to entertain themselves. One can probably do the same, given the right tools and opportunity." })
keywordHandler:addKeyword({ "tame" }, StdModule.say, { npcHandler = npcHandler, text = "Well, usually you can tame animals with the help of a few simple items. If you've found such an item, show it to me and I might be able to help you with instructions on the taming process." })
keywordHandler:addKeyword({ "stampor" }, StdModule.say, { npcHandler = npcHandler, text = "The stampor in the back? She's my friend, but she came to me out of her own free will. I must admit I've never managed to tame any other stampor. ... I heard that there's some sort of voodoo magic which would allow you to summon a stampor, but I'm not a voodoo expert, so I wouldn't know." })
keywordHandler:addKeyword({ "arkarra" }, StdModule.say, { npcHandler = npcHandler, text = "In some parts of this world, ambitious and industrious people have built advanced contraptions far beyond our own imagination. Sorry but there isn't much I can tell you about such." })
keywordHandler:addKeyword({ "glooth" }, StdModule.say, { npcHandler = npcHandler, text = "In some parts of this world, ambitious and industrious people have built advanced contraptions far beyond our own imagination. Sorry but there isn't much I can tell you about such." })
...
keywordHandler:addKeyword({ "red silk flower" }, StdModule.say, { npcHandler = npcHandler, text = "I heard stories about those artificial flowers. The werelions of the Darama Desert create them and they come in different colours. Each colour has a different meaning. ... White silk flowers are used as love pledges, for example. But red ones are decorations for bravery and valour. ... If you offer one respectfully to a white lion, such a kingly animal might accompany you willingly." })
