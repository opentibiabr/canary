...
local stoneKeyword = keywordHandler:addKeyword(
	{ "adventurer stone" },
	StdModule.say,
	{
		npcHandler = npcHandler,
...
stoneKeyword:addChildKeyword({ "" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "No problem.",
	reset = true
})
...
keywordHandler:addKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "I think you have forgotten to bring your stake."
	},
	function(player)
		return player:getStorageValue(Storage.FriendsandTraders.TheBlessedStake) == 3 and player:getItemCount(5941) == 0
	end
)
...
stakeKeyword:addChildKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "So receive my prayer: 'Peace may fill your soul - evil shall be cleansed'. Now, bring your stake to Yberius in the Venore temple for the next line of the prayer. I will inform him what to do.",
		reset = true
	},
	nil,
	function(player)
...
keywordHandler:addKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "You should visit Yberius in the Venore temple now."
	},
	function(player)
		return player:getStorageValue(Storage.FriendsandTraders.TheBlessedStake) == 4
	end
)
keywordHandler:addKeyword(
	{ "stake" },
...
keywordHandler:addKeyword({ "stake" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "A blessed stake? That is a strange request. Maybe Quentin knows more, he is one of the oldest monks after all."
})
...
keywordHandler:addKeyword({ "heal" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "You aren't looking that bad. Sorry, I can't help you. But if you are looking for additional protection you should go on the {pilgrimage} of ashes or get the protection of the {twist of fate} here."
})
...
keywordHandler:addKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "I can sense that the spark of the phoenix already was given to you by the dwarven priests of earth and fire in Kazordoon."
	},
	function(player)
...
keywordHandler:addKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "I can sense you already talked to the hermit Eremo on the isle of Cormaya and received this blessing."
	},
	function(player)
...
keywordHandler:addGreetKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "Welcome, young |PLAYERNAME|! If you are heavily wounded or poisoned, I can {heal} you for free."
	}
)
--Farewell message
keywordHandler:addFarewellKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "May the gods bless you, |PLAYERNAME|!"
	}
)
