...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "mission") then
		...
		elseif player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.NightmareIntruders) >= 1 and player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.NightmareIntruders) <= 2 then
			npcHandler:say("Have you defeated the nightmare monsters?", npc, creature)
			npcHandler:setTopic(playerId, 2)
		elseif player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.NightmareIntruders) >= 3 and player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.NightmareIntruders) <= 4 then
			npcHandler:say("Have you found the moon mirror and freed the captured fairies?", npc, creature)
			npcHandler:setTopic(playerId, 4)
		elseif player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.NightmareIntruders) == 5 and player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission03.AnUnlikelyCouple) == 4 then
			npcHandler:say("Have you already found the starlight vial and the sun catcher?", npc, creature)
			npcHandler:setTopic(playerId, 6)
		elseif player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.NightmareIntruders) == 6 then
			npcHandler:say("Could you already gather the three lights?", npc, creature)
			npcHandler:setTopic(playerId, 7)
		elseif player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.NightmareIntruders) == 7 then
	...
	elseif MsgContains(message, "yes") then
		if npcHandler:getTopic(playerId) == 1 then
			...
			player:setStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.KroazurAccess, 1)
			player:setStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.EnfeebledCount, 0)
			player:setStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.FrazzlemawsCount, 0)
			player:setStorageValue(Storage.Quest.U11_40.ThreatenedDreams.QuestLine, 2)
			npcHandler:setTopic(playerId, 0)
		elseif npcHandler:getTopic(playerId) == 2 then
			...
			local kroazurKill = player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.KroazurKill)
			if player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.NightmareIntruders) == 1 and kroazurKill >= 1 and (enfeebledKills + frazzlemawsKills) >= 200 then
				...
				player:setStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.NightmareIntruders, 2)
			elseif player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.NightmareIntruders) == 2 then
		...
		elseif npcHandler:getTopic(playerId) == 3 then
			...
			player:setStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.NightmareIntruders, 3)
			npcHandler:setTopic(playerId, 0)
		elseif npcHandler:getTopic(playerId) == 4 then
			if player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.FairiesCounter) == 5 and player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.DarkMoonMirror) == 1 then
				...
				player:setStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.NightmareIntruders, 4)
			elseif player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.NightmareIntruders) == 4 then
		...
		elseif npcHandler:getTopic(playerId) == 5 then
			...
			player:setStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.NightmareIntruders, 5)
			npcHandler:setTopic(playerId, 0)
		elseif npcHandler:getTopic(playerId) == 6 then
			...
			player:setStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.NightmareIntruders, 6)
			npcHandler:setTopic(playerId, 0)
		elseif npcHandler:getTopic(playerId) == 7 then
			if player:getItemCount(25734) >= 1 and player:getItemCount(25732) >= 1 and player:getItemCount(25730) >= 1 then
				...
				player:setStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.NightmareIntruders, 7)
				npcHandler:setTopic(playerId, 0)
			else
		...
		elseif npcHandler:getTopic(playerId) == 8 then
			if player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.ChargedMoonMirror) == 0 and player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.ChargedStarlightVial) == 0 and player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.ChargedSunCatcher) == 0 then
				...
				player:setStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.NightmareIntruders, 8)
				npcHandler:setTopic(playerId, 0)
			else
