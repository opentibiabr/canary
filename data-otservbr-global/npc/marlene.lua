...
keywordHandler:addKeyword({ "bruno" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Bruno is a wonderful husband. But he is seldom at home. *looks a little bit sad*"
})
...
keywordHandler:addKeyword({ "thank you" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "My pleasure, I always enjoy sharing interesting stories."
})
