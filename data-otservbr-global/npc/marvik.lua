...
node36:addChildKeyword({ "yes" }, StdModule.learnSpell, { npcHandler = npcHandler, premium = false, spellName = "magic patch", vocation = { 1, 2, 3, 5, 6, 7, 9, 10 }, price = 0, level = 1 })
...
keywordHandler:addKeyword({ "harkath bloodblade" }, StdModule.say, { npcHandler = npcHandler, text = "I understand, he's a warrior of some kind." })
keywordHandler:addKeyword({ "crunors caress" }, StdModule.say, { npcHandler = npcHandler, text = "It was a small order of druids in the past. Their followers wanted the druids to become more involved with the daily affairs of men." })
keywordHandler:addKeyword({ "sorcerers" }, StdModule.say, { npcHandler = npcHandler, text = "Sorcerers are very aggressive. They use their power for fighting and killing." })
...
keywordHandler:addKeyword({ "tibianus" }, StdModule.say, { npcHandler = npcHandler, text = "Kings come and go." })
keywordHandler:addKeyword({ "eclesius" }, StdModule.say, { npcHandler = npcHandler, text = "A confused magician living outside of the city walls. I never talked to him." })
keywordHandler:addKeyword({ "mcronald" }, StdModule.say, { npcHandler = npcHandler, text = "The McRonalds are true believers." })
keywordHandler:addKeyword({ "kingsday" }, StdModule.say, { npcHandler = npcHandler, text = "Don't get distracted from your real tasks." })
keywordHandler:addKeyword({ "general" }, StdModule.say, { npcHandler = npcHandler, text = "I don't care about armies." })
keywordHandler:addKeyword({ "members" }, StdModule.say, { npcHandler = npcHandler, text = "Our members use their magic power to protect their life and the life of other creatures." })
keywordHandler:addKeyword({ "quentin" }, StdModule.say, { npcHandler = npcHandler, text = "He is a great healer." })
keywordHandler:addKeyword({ "marvik" }, StdModule.say, { npcHandler = npcHandler, text = "Marvik is my name, so what?" })
keywordHandler:addKeyword({ "crunor" }, StdModule.say, { npcHandler = npcHandler, text = "Crunor, the eternal tree, is more than nature. Even more as the sum of each part of nature." })
keywordHandler:addKeyword({ "baxter" }, StdModule.say, { npcHandler = npcHandler, text = "I don't know him." })
keywordHandler:addKeyword({ "donald" }, StdModule.say, { npcHandler = npcHandler, text = "The McRonalds are true believers." })
keywordHandler:addKeyword({ "sherry" }, StdModule.say, { npcHandler = npcHandler, text = "The McRonalds are true believers." })
keywordHandler:addKeyword({ "gregor" }, StdModule.say, { npcHandler = npcHandler, text = "Warriors are the main recipients of our healing powers." })
keywordHandler:addKeyword({ "muriel" }, StdModule.say, { npcHandler = npcHandler, text = "So much power and so little philosophy ... a dangerous combination indeed." })
keywordHandler:addKeyword({ "oswald" }, StdModule.say, { npcHandler = npcHandler, text = "He saws the seeds of evil through spreading rumours." })
keywordHandler:addKeyword({ "power" }, StdModule.say, { npcHandler = npcHandler, text = "Everyone who joins the Druids has the opportunity to learn many magic spells." })
keywordHandler:addKeyword({ "druid" }, StdModule.say, { npcHandler = npcHandler, text = "I am a druid. Druids concentrate their magic on defence, healing, and nature." })
keywordHandler:addKeyword({ "elane" }, StdModule.say, { npcHandler = npcHandler, text = "Paladins are quite proud of their magic but lack the understandig of the powers they wield." })
keywordHandler:addKeyword({ "frodo" }, StdModule.say, { npcHandler = npcHandler, text = "A little more seriousity would suite him well." })
keywordHandler:addKeyword({ "lynda" }, StdModule.say, { npcHandler = npcHandler, text = "Though she focuses not only on Crunor, she is an enlightened person." })
keywordHandler:addKeyword({ "lugri" }, StdModule.say, { npcHandler = npcHandler, text = "A misguided soul who lost the path in the darkness." })
...
keywordHandler:addKeyword({ "news" }, StdModule.say, { npcHandler = npcHandler, text = "Why are you so concerned with news if you haven't even understood the old things you know?" })
keywordHandler:addKeyword({ "king" }, StdModule.say, { npcHandler = npcHandler, text = "Kings come and go." })
keywordHandler:addKeyword({ "army" }, StdModule.say, { npcHandler = npcHandler, text = "I don't care about armies." })
keywordHandler:addKeyword({ "bozo" }, StdModule.say, { npcHandler = npcHandler, text = "I don't like his kind of humour." })
keywordHandler:addKeyword({ "gorn" }, StdModule.say, { npcHandler = npcHandler, text = "A shopkeeper." })
...
keywordHandler:addKeyword({ "sam" }, StdModule.say, { npcHandler = npcHandler, text = "An armourer." })
