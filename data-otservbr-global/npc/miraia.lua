...
local config = {
	...
	["blue cloth"] = {
		...
		count = 100,
		storageValue = 4,
		text = { "Ah, have you brought the 100 pieces of blue cloth?", "It's a great material for turbans.", "Ah! Congratulations - I hope this veil will turn out as beautiful as you are. Here, I'll do it for you." }
	}
}
...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "outfit") then
		npcHandler:say(
			player:getSex() == PLAYERSEX_FEMALE and "Hehe, would you like to wear a pretty veil like I do? Well... I could help you, but you would have to complete a task first." or "My veil? No, I will definitely not lift it for you! If you are looking for an addon, go talk to Razan.",
			npc,
			creature
		)
...
keywordHandler:addKeyword({ "drink" }, StdModule.say, {
	...
	text = "I can offer you lemonade, camel milk, and water. If you'd like to see my offers, ask me for a {trade}."
})
keywordHandler:addKeyword({ "food" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Are you looking for food? I have bread, cheese, ham, and meat. If you'd like to see my offers, ask me for a {trade}."
})
