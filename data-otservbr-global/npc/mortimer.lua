...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif MsgContains(message, "mission") then
		if player:getStorageValue(Storage.ExplorerSociety.JoiningTheExplorers) > 4 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) > 4 and player:getStorageValue(Storage.ExplorerSociety.ThePlantCollection) < 26 and player:getStorageValue(
			Storage.ExplorerSociety.QuestLine
		) < 26 or player:getStorageValue(Storage.ExplorerSociety.TheIceDelivery) == 8 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 8 or player:getStorageValue(Storage.ExplorerSociety.TheButterflyHunt) == 17 and player:getStorageValue(
			Storage.ExplorerSociety.QuestLine
		) == 17 or player:getStorageValue(Storage.ExplorerSociety.JoiningTheExplorers) == 5 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 5 then
			...
			-- SPECTRAL STONE
			-- ASTRAL PORTALS -- orichalcum pearl -- crown backpack
			-- ASTRAL PORTALS
		elseif player:getStorageValue(Storage.ExplorerSociety.ThePlantCollection) > 25 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) > 35 and player:getStorageValue(Storage.ExplorerSociety.TheOrcPowder) < 35 and player:getStorageValue(
			Storage.ExplorerSociety.QuestLine
		) < 35 or player:getStorageValue(Storage.ExplorerSociety.ThePlantCollection) == 26 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 26 or player:getStorageValue(Storage.ExplorerSociety.TheLizardUrn) == 29 and player:getStorageValue(
			Storage.ExplorerSociety.QuestLine
		) == 29 or player:getStorageValue(Storage.ExplorerSociety.TheBonelordSecret) == 32 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 32 then
			npcHandler:say("The missions available for your rank are {lizard urn}, {bonelord secrets} and {orc powder}.", npc, creature)
			npcHandler:setTopic(playerId, 0)
		elseif player:getStorageValue(Storage.ExplorerSociety.TheOrcPowder) > 34 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) > 34 and player:getStorageValue(Storage.ExplorerSociety.TheRuneWritings) < 44 and player:getStorageValue(
			Storage.ExplorerSociety.QuestLine
		) < 44 or player:getStorageValue(Storage.ExplorerSociety.TheOrcPowder) == 35 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 35 or player:getStorageValue(Storage.ExplorerSociety.TheElvenPoetry) == 38 and player:getStorageValue(
			Storage.ExplorerSociety.QuestLine
		) == 38 or player:getStorageValue(Storage.ExplorerSociety.TheMemoryStone) == 41 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 41 then
		...
		elseif player:getStorageValue(Storage.ExplorerSociety.TheSpectralStone) == 55 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 55 then
			...
			player:addItem(5021, 6)
			player:addItem(9605, 1)
		end
	-- MISSION CHECK

	-- PICKAXE MISSION
	elseif MsgContains(message, "pickaxe") then
		if player:getStorageValue(Storage.ExplorerSociety.JoiningTheExplorers) < 5 or player:getStorageValue(Storage.ExplorerSociety.JoiningTheExplorers) > 1 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) < 1 or player:getStorageValue(
			Storage.ExplorerSociety.QuestLine
		) > 1 then
	...
	elseif MsgContains(message, "ice delivery") then
		if player:getStorageValue(Storage.ExplorerSociety.JoiningTheExplorers) == 5 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 5 then
			npcHandler:say(
				{
		...
		elseif player:getStorageValue(Storage.ExplorerSociety.TheIceDelivery) == 7 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 7 then
	...
	elseif MsgContains(message, "butterfly hunt") then
		if player:getStorageValue(Storage.ExplorerSociety.TheIceDelivery) == 8 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 8 then
		...
		elseif player:getStorageValue(Storage.ExplorerSociety.TheButterflyHunt) == 11 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 11 then
			npcHandler:say(
				{ "This preparation kit will allow you to collect a blue butterfly you have killed ...", "Just use it on the fresh corpse of a blue butterfly, return the prepared butterfly to me and give me a report of your butterfly hunt." },
				npc,
				creature
			)
			npcHandler:setTopic(playerId, 0)
		...
		elseif player:getStorageValue(Storage.ExplorerSociety.TheButterflyHunt) == 14 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 14 then
			npcHandler:say(
				{ "This preparation kit will allow you to collect a red butterfly you have killed ...", "Just use it on the fresh corpse of a red butterfly, return the prepared butterfly to me and give me a report of your butterfly hunt." },
				npc,
				creature
			)
			npcHandler:setTopic(playerId, 0)
		...
		elseif player:getStorageValue(Storage.ExplorerSociety.TheButterflyHunt) == 16 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 16 then
	...
	elseif MsgContains(message, "plant collection") then
		if player:getStorageValue(Storage.ExplorerSociety.TheButterflyHunt) == 17 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 17 then
		...
		elseif player:getStorageValue(Storage.ExplorerSociety.ThePlantCollection) == 119 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 19 then
			npcHandler:say("Did you acquire the sample of the jungle bells plant we are looking for?", npc, creature)
			npcHandler:setTopic(playerId, 12)
		elseif player:getStorageValue(Storage.ExplorerSociety.ThePlantCollection) == 20 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 20 then
		...
		elseif player:getStorageValue(Storage.ExplorerSociety.ThePlantCollection) == 23 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 23 then
		...
		elseif player:getStorageValue(Storage.ExplorerSociety.ThePlantCollection) == 25 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 25 then
	...
	elseif MsgContains(message, "yes") then
		...
		elseif npcHandler:getTopic(playerId) == 3 then
			if player:removeItem(4845, 1) then
				...
				npcHandler:say({ "Excellent, you brought just the tool we need! Of course it was only a simple task. However ...", "I officially welcome you to the explorer society. From now on you can ask for missions to improve your rank." }, npc, creature)
				npcHandler:setTopic(playerId, 0)
			end
		...
		elseif npcHandler:getTopic(playerId) == 7 then
			...
			npcHandler:say(
				{ "This preparation kit will allow you to collect a purple butterfly you have killed ...", "Just use it on the fresh corpse of a purple butterfly, return the prepared butterfly to me and give me a report of your butterfly hunt." },
				npc,
				creature
			)
			npcHandler:setTopic(playerId, 0)
		...
		elseif npcHandler:getTopic(playerId) == 17 then
			...
			npcHandler:say({ "Excellent! So travel to the city of Darashia and then head north-east for the pyramid ...", "If any documents are left, you probably find them in the catacombs beneath. Good luck!" }, npc, creature)
			npcHandler:setTopic(playerId, 0)
	...
	elseif MsgContains(message, "giant smithhammer") and player:getStorageValue(Storage.ExplorerSociety.GiantSmithHammer) < 1 then
