...
-- Spiritual Shielding
local blessKeyword = keywordHandler:addKeyword({ "spiritual" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Here in the whiteflower temple you may receive the blessing of spiritual shielding. But we must ask of you to sacrifice |BLESSCOST| gold. Are you still interested?"
})
blessKeyword:addChildKeyword({ "yes" }, StdModule.bless, {
	npcHandler = npcHandler,
	text = "So receive the shielding of your spirit, pilgrim.",
	cost = "|BLESSCOST|",
	bless = 5
})
