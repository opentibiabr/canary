...
keywordHandler:addKeyword({ "job" }, StdModule.say, {
	...
	text = "I guard this humble temple as a monument for the order of the {nightmare knights}."
})
...
keywordHandler:addKeyword({ "nightmare" }, StdModule.say, {
	npcHandler = npcHandler,
...
keywordHandler:addKeyword({ "extinct" }, StdModule.say, {
	npcHandler = npcHandler,
...
keywordHandler:addKeyword({ "dreamers" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "They learned the ancient art of {dreamwalking} from some elves they befriended."
})
keywordHandler:addKeyword({ "dreamwalking" }, StdModule.say, {
	npcHandler = npcHandler,
...
keywordHandler:addKeyword({ "omen" }, StdModule.say, {
	npcHandler = npcHandler,
...
keywordHandler:addKeyword({ "schemes of darkness" }, StdModule.say, {
	npcHandler = npcHandler,
...
keywordHandler:addKeyword({ "havok" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Before the battles raged across them, they were called the fair plains."
})
...
keywordHandler:addKeyword({ "god" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "They created Tibia and all life on it ... and unlife, too."
})
keywordHandler:addKeyword({ "unlife" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Beware the foul undead!"
})
...
keywordHandler:addKeyword({ "yenny the gentle" }, StdModule.say, {
	npcHandler = npcHandler,
