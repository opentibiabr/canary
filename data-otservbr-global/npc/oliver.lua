...
keywordHandler:addKeyword({ "blood crystal" }, StdModule.say, { npcHandler = npcHandler, text = "I'll tell you that story another time, but not now. Sorry." }, function(player)
