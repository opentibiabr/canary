...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif MsgContains(message, "mission") then
		if player:getStorageValue(TheNewFrontier.Questline) < 1 and npcHandler:getTopic(playerId) == 2 then
			...
			player:setStorageValue(TheNewFrontier.Questline, 1)
			player:setStorageValue(TheNewFrontier.Mission01, 1)
			npcHandler:setTopic(playerId, 0) -- Questlog, "Mission 10: New Horizons"
		...
		elseif player:getStorageValue(TheNewFrontier.Questline) == 14 then
			if player:getStorageValue(TheNewFrontier.Mission05.KingTibianus) == 3 and player:getStorageValue(TheNewFrontier.Mission05.Leeland) == 3 and player:getStorageValue(TheNewFrontier.Mission05.Angus) == 3 and player:getStorageValue(
				TheNewFrontier.Mission05.Wyrdin
			) == 3 and player:getStorageValue(TheNewFrontier.Mission05.Telas) == 3 and player:getStorageValue(TheNewFrontier.Mission05.Humgolf) == 3 then
		...
		elseif player:getStorageValue(TheNewFrontier.Questline) == 28 then
			...
			player:setStorageValue(TheNewFrontier.Mission10[1], 2)
