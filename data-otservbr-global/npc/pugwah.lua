...
keywordHandler:addKeyword({ "blood crystal" }, StdModule.say, { npcHandler = npcHandler, text = "Big red crystal. Some people talk about it in my tavern. But strange people those are!" }, function(player)
