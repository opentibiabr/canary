...
stakeKeyword:addChildKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "Alright, I guess you need a stake first. Maybe Gamon can help you, the leg of a chair or something could just do. Try asking him for a stake, and if you have one, bring it back to me.",
		reset = true,
		ungreet = true
	},
	nil,
...
keywordHandler:addKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "I guess you couldn't convince Gamon to give you a stake, eh?"
	},
	function(player)
		return player:getStorageValue(Storage.FriendsandTraders.TheBlessedStake) == 1 and player:getItemCount(5941) == 0
	end
)
...
stakeKeyword:addChildKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "So receive my prayer: 'Light shall be near - and darkness afar'. Now, bring your stake to Tibra in the Carlin church for the next line of the prayer. I will inform her what to do.",
		reset = true
	},
	nil,
	function(player)
...
keywordHandler:addKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "You should visit Tibra in the Carlin church now."
	},
	function(player)
