...
stakeKeyword:addChildKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "So receive my prayer: 'Let there be power and compassion'. Now, bring your stake to Brewster in Port Hope for the next line of the prayer. I will inform him what to do.",
		reset = true
	},
	nil,
	function(player)
...
keywordHandler:addKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "You should visit Brewster in Port Hope now."
	},
	function(player)
