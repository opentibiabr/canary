...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif MsgContains(message, "mission") then
		...
		elseif player:getStorageValue(Storage.TheShatteredIsles.RaysMission3) == 1 and player:getStorageValue(Storage.TheShatteredIsles.TavernMap1) == 1 and player:getStorageValue(Storage.TheShatteredIsles.TavernMap2) == 1 and player:getStorageValue(
			Storage.TheShatteredIsles.TavernMap3
		) == 1 then
			npcHandler:say(
				{
	...
	elseif MsgContains(message, "task") and player:getStorageValue(Storage.TheShatteredIsles.RaysMission4) == 5 then
		...
		elseif player:getStorageValue(Storage.KillingInTheNameOf.PirateTask) == 2 then
			npcHandler:say(
				{ "So you went into the leaders' hideout? I hope you were successful and got what you were looking for! Thank you, my friend. Pirates still keep coming here, unfortunately. ...", "Do you, by chance, would like to kill pirates again for us?" },
				npc,
				creature
			)
			npcHandler:setTopic(playerId, 2)
