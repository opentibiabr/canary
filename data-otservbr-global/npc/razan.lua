...
local config = {
	...
	["blue cloth"] = {
		...
		count = 100,
		storageValue = 4,
		text = { "Ah, have you brought the 100 pieces of blue cloth?", "It's a great material for turbans.", "Ah! Congratulations - even if you are not a true weaponmaster, you surely deserve to wear this turban. Here, I'll tie it for you." }
	}
}
...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "outfit") then
		npcHandler:say(
			player:getSex() == PLAYERSEX_FEMALE and "My turban? I know something better for a pretty girl like you. Why don't you go talk to Miraia?" or "My turban? Eh no, you can't have it. Only oriental weaponmasters may wear it after having completed a difficult task.",
			npc,
			creature
		)
