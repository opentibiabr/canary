...
keywordHandler:addKeyword({ "blood crystal" }, StdModule.say, { npcHandler = npcHandler, text = "It's nice talking to you, but honestly, you give me the creeps. So please decide what you want and move on." }, function(player)
