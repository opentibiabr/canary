...
keywordHandler:addKeyword({ "paradox" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "This tower, of course, silly one. It holds my {master'}s {treasure}."
})
keywordHandler:addAliasKeyword({ "tower" })

keywordHandler:addKeyword({ "master" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "His name is none of your business"
})
keywordHandler:addKeyword({ "treasure" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I am guarding the treasures of the tower. Only those who pass the {test} of the three sigils may pass."
})
keywordHandler:addKeyword({ "name" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I am known as the riddler. That is all you need to know."
})
keywordHandler:addKeyword({ "job" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I am the guardian of the paradox tower."
})
keywordHandler:addKeyword({ "key" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "The key of this tower! You will never find it! A malicious plant spirit is guarding it!."
})
