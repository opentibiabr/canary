...
keywordHandler:addKeyword({ "name" }, StdModule.say, {
	...
	text = "I am Romella and I will be serving you today."
})
keywordHandler:addAliasKeyword({ "job" })

keywordHandler:addKeyword({ "weapons" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I have many weapons to offer. If you'd like to see my offers, ask me for a {trade}."
})
keywordHandler:addKeyword({ "offers" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I sell and buy weapons. If you'd like to see my offers, ask me for a {trade}."
})
keywordHandler:addAliasKeyword({ "ware" })

keywordHandler:addKeyword({ "army" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Our warehouse is the main supplier of the local garrison."
})
keywordHandler:addKeyword({ "news" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "It says the amazons are looking for a certain magical weapon in this area."
})
keywordHandler:addKeyword({ "amazons" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I wonder how they finance themselves. I bet they are secretly trading in some strange stuff."
})
keywordHandler:addKeyword({ "ferumbras" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Make sure to buy some extra weapons before facing that one."
})
keywordHandler:addKeyword({ "excalibug" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I heard the amazons are after it."
})
keywordHandler:addKeyword({ "swamps" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Don't go exploring without weapons. Especially you'll need a machete."
})
