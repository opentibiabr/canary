...
local function creatureSayCallback(npc, creature, type, message)
	...
	if (MsgContains(message, "mission") or MsgContains(message, "task")) then
		...
		------------------------ FINISH MISSION 03 ------------------------ -- quest log -- quest log

		------------------------ FINISH MISSION 01 ------------------------ -- quest log -- quest log
		------------------------ FINISH MISSION 02 ------------------------ -- quest log
		------------------------ FINISH MISSION 03 ------------------------
	elseif MsgContains(message, "yes") then
		if (npcHandler:getTopic(playerId) == 1) then
			npcHandler:say(
				"Good, because that is exactly what you will help us with - getting more 'lucky charms'. If we won't get our hands on new charms in time, we will surely have to starve... during the autumn. That would be a hard time for all of us. So... you in?",
				npc,
				creature
			)
		...
		elseif (npcHandler:getTopic(playerId) == 2) then
			...
			setPlayerStorageValue(creature, Storage.RottinWoodAndMaried.Questline, 1)
		...
		elseif (npcHandler:getTopic(playerId) == 3) and getPlayerItemCount(creature, 12173) >= 7 then
			...
			setPlayerStorageValue(creature, Storage.RottinWoodAndMaried.Questline, 4)
			npcHandler:setTopic(playerId, 0)
		...
		elseif (npcHandler:getTopic(playerId) == 4) then
			...
			setPlayerStorageValue(creature, Storage.RottinWoodAndMaried.Questline, 3)
			npcHandler:setTopic(playerId, 0)
		elseif (npcHandler:getTopic(playerId) == 5) then
			...
			setPlayerStorageValue(creature, Storage.RottinWoodAndMaried.Questline, 6)
		...
		elseif (npcHandler:getTopic(playerId) == 7) then
			...
			setPlayerStorageValue(creature, Storage.RottinWoodAndMaried.Questline, 5)
			npcHandler:setTopic(playerId, 0)
		end
	end
	return true
