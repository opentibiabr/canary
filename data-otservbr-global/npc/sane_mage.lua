...
keywordHandler:addKeyword({ "mad" }, StdModule.say, {
	npcHandler = npcHandler,
...
keywordHandler:addKeyword({ "vacation" }, StdModule.say, {
	npcHandler = npcHandler,
...
keywordHandler:addKeyword({ "help" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "You want to help me? HELP me? You? Who... who are you anyway? Ah nevermind."
})
