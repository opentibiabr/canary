...
keywordHandler:addSpellKeyword(
	{ "findperson" },
	{
		...
		price = 80,
		level = 8,
		vocation = { VOCATION.BASE_ID.PALADIN, VOCATION.BASE_ID.KNIGHT }
	}
)
keywordHandler:addSpellKeyword(
	{ "light" },
...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif MsgContains(message, "oressa") then
		npcHandler:say(
			...
			which is quite understandable when you think about it. ...", "However, she's also a very apt healer and can give you advice on your choice of vocation." },
			creature
		)
	end
end
