...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "mission") then
		...
		elseif player:getStorageValue(Storage.TheIceIslands.Questline) == 10 then
			...
			player:setStorageValue(Storage.TheIceIslands.Mission05, 1)
			npcHandler:setTopic(playerId, 0)
		...
		elseif player:getStorageValue(Storage.TheIceIslands.Questline) == 12 then
			...
			player:setStorageValue(Storage.TheIceIslands.Mission05, 2)
			npcHandler:setTopic(playerId, 0)
		...
		elseif player:getStorageValue(Storage.TheIceIslands.Questline) == 14 then
			...
			player:setStorageValue(Storage.TheIceIslands.Mission05, 3)
			npcHandler:setTopic(playerId, 0)
		...
		elseif player:getStorageValue(Storage.TheIceIslands.Questline) == 16 then
			...
			player:setStorageValue(Storage.TheIceIslands.Mission05, 4)
			npcHandler:setTopic(playerId, 0)
		...
		elseif player:getStorageValue(Storage.TheIceIslands.Questline) == 18 then
			...
			player:setStorageValue(Storage.TheIceIslands.Mission05, 5)
			npcHandler:setTopic(playerId, 0)
	...
	-- Questlog The Ice Islands Quest, Nibelor 4: Berserk Brewery
	-- Questlog The Ice Islands Quest, Nibelor 4: Berserk Brewery
	-- Questlog The Ice Islands Quest, Nibelor 4: Berserk Brewery
	-- Questlog The Ice Islands Quest, Nibelor 4: Berserk Brewery
	-- Questlog The Ice Islands Quest, Nibelor 4: Berserk Brewery
	...
	elseif MsgContains(message, "yes") then
		if npcHandler:getTopic(playerId) == 1 then
			...
			player:setStorageValue(Storage.TheIceIslands.Mission03, 1)
			player:addItem(7243, 1)
			npcHandler:setTopic(playerId, 0)
		-- Questlog The Ice Islands Quest, Nibelor 2: Ecological Terrorism
