...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "mission") then
		if player:getStorageValue(Storage.Quest.U10_50.DarkTrails.Mission01) == 2 and player:getStorageValue(Storage.Quest.U10_50.DarkTrails.Mission02) == 1 and player:getStorageValue(Storage.Oramond.DoorBeggarKing) == 1 then
	...
	elseif MsgContains(message, "abandoned sewers") then
		if npcHandler:getTopic(playerId) == 4 then
			...
			player:setStorageValue(Storage.Quest.U10_50.DarkTrails.Mission02, 2) -- Mission 2 end
			player:setStorageValue(Storage.Quest.U10_50.DarkTrails.Mission03, 1) -- Mission 3 start
			npcHandler:setTopic(playerId, 0)
		end
	end
	return true
