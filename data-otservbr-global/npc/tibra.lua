...
keywordHandler:addKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "You should visit Maealil in the elven settlement now, my child."
	},
	function(player)
...
keywordHandler:addKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "You already received my line of the prayer, dear child."
	},
	function(player)
		return player:getStorageValue(Storage.FriendsandTraders.TheBlessedStake) > 3
	end
...
keywordHandler:addKeyword({ "life" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "The teachings of Crunor tell us to honor life and not to harm it."
})
keywordHandler:addKeyword({ "mission" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "It is my mission to bring the teachings of the gods to everyone."
})
...
keywordHandler:addKeyword({ "name" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "My name is Tibra. Your soul tells me that you are |PLAYERNAME|."
})
...
keywordHandler:addKeyword({ "sell" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "The grace of the gods must be earned, it cannot be bought!"
})
...
keywordHandler:addKeyword({ "crypt" }, StdModule.say, {
	npcHandler = npcHandler,
...
keywordHandler:addKeyword({ "monsters" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Remind: Not everything you call monster is evil to the core!"
})
...
keywordHandler:addKeyword({ "ferumbras" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "The fallen one should be mourned, not feared."
})
keywordHandler:addKeyword({ "lugri" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Only a man can fall as low as he did. His soul rotted away already."
})
...
keywordHandler:addKeyword({ "gods of good" }, StdModule.say, {
	npcHandler = npcHandler,
...
keywordHandler:addKeyword({ "sula" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Sula is the essence of the elemental power of water."
})
...
keywordHandler:addKeyword({ "toth" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Toth, Lord of Death, is the keeper of the souls, the guardian of the afterlife."
})
...
keywordHandler:addKeyword({ "archdemons" }, StdModule.say, {
	npcHandler = npcHandler,
...
keywordHandler:addKeyword({ "ruthless seven" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I don't want to talk about that subject!"
})
