...
keywordHandler:addKeyword({ "blood crystal" }, StdModule.say, { npcHandler = npcHandler, text = "Sorry... but uhm... please move on, I actually shouldn't chat with you." }, function(player)
