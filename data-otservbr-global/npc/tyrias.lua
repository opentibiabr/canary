...
keywordHandler:addKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "You don't even have that strange stake with you."
	},
	function(player)
...
local stakeKeyword = keywordHandler:addKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "Brewster sent me a strange message about some strange hocus-pocus. I think it's nonsense, but since you have come that far, I'll play along. Are you ready?"
	},
	function(player)
...
stakeKeyword:addChildKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "So receive my prayer: 'Your mind shall be a vessel for joy, light and wisdom' - uh, wow, something happened. Well, I guess that's it, but next time if you need some mumbo jumbo rather go to Chondur.",
		reset = true
	},
	function(player)
...
stakeKeyword:addChildKeyword({ "" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "No problem, I have other things to do.",
	reset = true
})
...
keywordHandler:addKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "A blessed stake? I don't believe in things like that. If anyone does, it's probably old Quentin."
	},
	function(player)
		return player:getStorageValue(Storage.FriendsandTraders.TheBlessedStake) < 10
	end
...
keywordHandler:addKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "I won't do that rubbish again. Go pester Chondur with your hocus-pocus."
	},
	function(player)
