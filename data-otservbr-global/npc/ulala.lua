...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "mission") then
		...
		elseif player:getStorageValue(Storage.UnnaturalSelection.Questline) == 7 then
			...
			player:setStorageValue(Storage.UnnaturalSelection.Mission04, 1)
			npcHandler:setTopic(playerId, 0)
		...
		elseif player:getStorageValue(Storage.UnnaturalSelection.Questline) == 9 then
			...
			player:setStorageValue(Storage.UnnaturalSelection.Mission05, 1)
			npcHandler:setTopic(playerId, 0)
		...
		elseif player:getStorageValue(Storage.UnnaturalSelection.Questline) == 12 then
			...
			player:setStorageValue(Storage.UnnaturalSelection.Mission06, 1)
			npcHandler:setTopic(playerId, 0)
		end
	--Questlog, Unnatural Selection Quest "Mission 4: Bits and Pieces"
	--Questlog, Unnatural Selection Quest "Mission 5: Ray of Light"
	--Questlog, Unnatural Selection Quest "Mission 5: Ray of Light"
	--Questlog, Unnatural Selection Quest "Mission 6: Firewater Burn"
