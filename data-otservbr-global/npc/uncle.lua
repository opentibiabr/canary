	...
	if MsgContains(message, "yes") then
		...
		elseif npcHandler:getTopic(playerId) == 8 then
			if player:removeItem(396, 1) then
				...
				npcHandler:say({ "You have proven yourself as very efficient. The future may hold great things for you in store ...", "Take this token of gratitude. I hope you can use well what you will find inside!" }, npc, creature)
			else
