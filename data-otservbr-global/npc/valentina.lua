...
npcConfig.shop = { {
	...
	itemName = "sweetheart ring",
	clientId = 21955,
	buy = 500
}, {
	itemName = "truelove teddy",
	clientId = 21953,
	buy = 1000
}, {
	itemName = "valentines cake",
	clientId = 6392,
	buy = 30
}, {
...
keywordHandler:addKeyword({ "job" }, StdModule.say, {
	...
	text = "I am known as the saleswoman of love, as a cupid."
})
