...
-- Mission 2: Start
local mission2 = keywordHandler:addKeyword(
	{ "yes" },
	StdModule.say,
	{
...
local mission02Reject = KeywordNode:new({ "no" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "OK, dude!"
})
...
-- Mission 3: Start
local mission3 = keywordHandler:addKeyword(
	{ "yes" },
	StdModule.say,
	{
		npcHandler = npcHandler,
...
keywordHandler:addKeyword(
	...
	function(player)
		return player:getStorageValue(Storage.TheRookieGuard.Mission04) == 6 and player:getStorageValue(Storage.TheRookieGuard.Mission05) == -1 or (player:getStorageValue(Storage.TheRookieGuard.Mission05) >= 1 and player:getStorageValue(
			Storage.TheRookieGuard.Mission05
		) <= 2)
	end,
	function(player)
...
-- Mission 7: Start
local mission7 = keywordHandler:addKeyword(
	{ "yes" },
	StdModule.say,
	{
		npcHandler = npcHandler,
...
-- Mission 11: Start
local mission11 = keywordHandler:addKeyword(
	{ "yes" },
	StdModule.say,
	{
		npcHandler = npcHandler,
...
local mission11Reset = keywordHandler:addKeyword(
	{ "yes" },
	StdModule.say,
	{
		npcHandler = npcHandler,
