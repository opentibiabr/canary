...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif MsgContains(message, "mission") or MsgContains(message, "quest") then
		npcHandler:say({ "A quest? Well, if you're so keen on doing me a favour... Why don't you try to find a {blood herb}?", "To be honest, I'm drowning in blood herbs by now." }, npc, creature)
	...
	elseif MsgContains(message, "yes") then
		if npcHandler:getTopic(playerId) == 1 then
			...
			npcHandler:resetNpc(creature) -- witchesbroom -- torn teddy
