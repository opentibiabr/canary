...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "mission") then
		...
		elseif player:getStorageValue(Storage.InServiceofYalahar.Questline) == 25 and player:getStorageValue(Storage.InServiceofYalahar.MrWestStatus) == 2 then
			...
			player:setStorageValue(Storage.InServiceofYalahar.BadSide, player:getStorageValue(Storage.InServiceofYalahar.BadSide) >= 0 and player:getStorageValue(Storage.InServiceofYalahar.BadSide) + 1 or 0)
			player:setStorageValue(Storage.InServiceofYalahar.Questline, 27)
			player:setStorageValue(Storage.InServiceofYalahar.Mission04, 6)
			npcHandler:setTopic(playerId, 0)
		...
		elseif player:getStorageValue(Storage.InServiceofYalahar.Questline) == 39 then
			...
			npcHandler:setTopic(playerId, 0)
		elseif player:getStorageValue(Storage.InServiceofYalahar.Questline) == 41 and player:getStorageValue(Storage.InServiceofYalahar.QuaraInky) == 1 and player:getStorageValue(Storage.InServiceofYalahar.QuaraSharptooth) == 1 and player:getStorageValue(
			Storage.InServiceofYalahar.QuaraSplasher
		) == 1 and player:getStorageValue(Storage.InServiceofYalahar.QuaraState) == 2 then
		...
		elseif player:getStorageValue(Storage.InServiceofYalahar.Questline) == 43 then
			...
			player:setStorageValue(Storage.InServiceofYalahar.Mission08, 1)
			npcHandler:setTopic(playerId, 0)
		...
		elseif player:getStorageValue(Storage.InServiceofYalahar.Questline) == 50 and player:getStorageValue(Storage.InServiceofYalahar.SideDecision) == 2 then
			...
			player:setStorageValue(Storage.InServiceofYalahar.Mission10, 2)
			npcHandler:setTopic(playerId, 0)
		elseif player:getStorageValue(Storage.InServiceofYalahar.Questline) == 52 and player:getStorageValue(Storage.InServiceofYalahar.SideDecision) == 2 then
			...
			player:setStorageValue(Storage.InServiceofYalahar.Mission10, 4)
			player:addOutfit(324, 0)
			player:addOutfit(325, 0)
			player:getPosition():sendMagicEffect(CONST_ME_MAGIC_BLUE)
			npcHandler:setTopic(playerId, 0)
		end
	-- StorageValue for Questlog "Mission 03: Death to the Deathbringer"
	-- StorageValue for Questlog "Mission 03: Death to the Deathbringer"
	-- StorageValue for Questlog "Mission 04: Good to be Kingpin"
	-- StorageValue for Questlog "Mission 04: Good to be Kingpin"
	-- Side Storage
	-- StorageValue for Questlog "Mission 04: Good to be Kingpin"
	-- StorageValue for Questlog "Mission 05: Food or Fight"
	-- Side Storage
	-- StorageValue for Questlog "Mission 05: Food or Fight"
	-- StorageValue for Questlog "Mission 06: Frightening Fuel"
	-- StorageValue for Questlog "Mission 06: Frightening Fuel"
	-- StorageValue for Questlog "Mission 06: Frightening Fuel"
	-- Side Storage
	...
	-- StorageValue for Questlog "Mission 07: A Fishy Mission"
	-- Side Storage
	-- StorageValue for Questlog "Mission 08: Dangerous Machinations"
	-- Side Storage
	-- Side Storage
	-- StorageValue for Questlog "Mission 08: Dangerous Machinations"
	-- StorageValue for Questlog "Mission 09: Decision"
	...
	elseif MsgContains(message, "yes") then
		if npcHandler:getTopic(playerId) == 1 then
			if player:removeItem(8818, 1) then
				...
				npcHandler:setTopic(playerId, 0)
			end -- StorageValue for Questlog "Mission 09: Decision"
