...
addMonsterKeyword(5, "Nice job out there, |PLAYERNAME|. Are you looking for other monsters than {trolls} or {wolves}? Maybe you'd like to check out {skeletons}. I'll mark them for you so you can find them easily.", { {
	position = Position(31977, 32228, 7),
...
addMonsterKeyword(4, "You're halfway to leaving this island, well done. {Spiders} or {wolves} are always good to fight, but if you want to move on, why don't you check out trolls? I'll mark you the troll cave on this side.", { {
	position = Position(32002, 32212, 7),
	type = MAPMARK_GREENSOUTH,
...
addMonsterKeyword(3, "Good progress, |PLAYERNAME|. You can still stay with {spiders} or {snakes}, but maybe you'd like to try fighting a {wolf}? I'll mark some of their hills on your map.", { {
	position = Position(32002, 32225, 7),
	type = MAPMARK_GREENNORTH,
	description = "Wolf Hill"
}, {
	position = Position(31989, 32198, 7),
	type = MAPMARK_GREENNORTH,
	description = "Wolf Hill"
} })
addMonsterKeyword(2, "You've already grown some, |PLAYERNAME|. You can either stay with {rats} or leave town to hunt {spiders} or {snakes}. I'll mark some spawns on your map.", { {
	position = Position(32001, 32238, 7),
	type = MAPMARK_GREENSOUTH,
	description = "Snake Pit"
}, {
	position = Position(32046, 32188, 7),
	type = MAPMARK_GREENSOUTH,
...
keywordHandler:addKeyword({ "bear" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "There is a bear cave close to this bridge. Be careful, though, they hit hard!"
})
...
keywordHandler:addKeyword({ "banor" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "The heavenly warrior! Read {books} to learn about him."
})
keywordHandler:addKeyword({ "magic" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "You will learn about magic soon enough."
})
keywordHandler:addKeyword({ "tibia" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "In the world of Tibia, many challenges await the brave adventurer."
})
...
keywordHandler:addKeyword({ "loui" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Such a chicken-hearted person."
})
...
keywordHandler:addKeyword({ "zirella" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "She has her own problems."
})
keywordHandler:addKeyword({ "al", "dee" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "There's something about this guy I don't like."
})
keywordHandler:addKeyword({ "amber" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "She's very attractive. Too bad my duty leaves me no time to date her."
})
...
keywordHandler:addKeyword({ "hyacinth" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "One of these reclusive druids."
})
keywordHandler:addKeyword({ "lee'delle" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Her shop is just north of the bridge. She really has good offers."
})
...
keywordHandler:addKeyword({ "seymour" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "His job of teaching young heroes is important for the survival of all of us."
})
...
keywordHandler:addKeyword({ "willie" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "He's quite rude. Also, he buys and sells {food}."
})
