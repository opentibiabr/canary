...
keywordHandler:addKeyword({ "magic" }, StdModule.say, { npcHandler = npcHandler, text = "This is not on sale here." })
keywordHandler:addKeyword({ "name" }, StdModule.say, { npcHandler = npcHandler, text = "I am Zethra the wormbane." })
