...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "mission") then
		if player:getStorageValue(Storage.WrathoftheEmperor.Questline) == 25 then
			...
			player:setStorageValue(Storage.WrathoftheEmperor.Mission09, 0)
			player:setStorageValue(Storage.WrathoftheEmperor.TeleportAccess.Zizzle, 3)
			player:setStorageValue(Storage.WrathoftheEmperor.Questline, 26)
			npcHandler:setTopic(playerId, 0)
		--Questlog, Wrath of the Emperor "Mission 08: Uninvited Guests"
		--door access
		--teleport access
		...
		end --Questlog, Wrath of the Emperor "Mission 08: Uninvited Guests"
