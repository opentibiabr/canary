...
local hatKeyword = keywordHandler:addKeyword(
	{ "proof" },
	StdModule.say,
	{
...
hatKeyword:addChildKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "Sorry you don't have the Ferumbras' hat."
	},
	function(player)
...
keywordHandler:addKeyword(
	...
	{
		npcHandler = npcHandler,
		text = "Stop bothering me. I am a far too busy man to be constantly giving out awards."
	},
	function(player)
