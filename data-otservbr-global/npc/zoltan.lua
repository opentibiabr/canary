...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif npcHandler:getTopic(playerId) == 1 then
			...
			local hasAddon = (player:getSex() == PLAYERSEX_MALE and player:hasOutfit(130, 2)) or (player:getSex() == PLAYERSEX_FEMALE and player:hasOutfit(138, 2))

				if hasAddon then
					npcHandler:say("You already have the Ferumbras' hat addon.", npc, creature)
				elseif player:getItemCount(5903) < 1 then
					...
					player:addOutfitAddon(141, 2) -- summoner addon for both
