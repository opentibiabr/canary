...
keywordHandler:addKeyword({ "job" }, StdModule.say, {
	...
	text = "I wait. I wait for someone like you to come here. I wait for them to grow disconsolate. I wait for them to despair. And I wait for them to die. Muhahaha."
})
keywordHandler:addKeyword({ "name" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I am Zumtah, Zumtah the impeccable, Zumtah the marvellous, Zumtah the... the... eternal."
})
keywordHandler:addAliasKeyword({ "djinn" })
keywordHandler:addAliasKeyword({ "zumtah" })
keywordHandler:addKeyword({ "zao" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "The land you are currently dwelling in, human. Don't you have any sense of your surroundings?"
})
keywordHandler:addKeyword({ "humans" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "I have seen many of them. I have seen many of them die. In here, with me. Perhaps you will be pleased to meet them. Not long and you will join their ranks. Muhaha."
})
keywordHandler:addKeyword({ "lizard" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Pesky creatures. Many of them have been brought here, many of them died here. Humans, lizards, beasts, they all die the same. Down here, with me. Muhahaha."
})
keywordHandler:addKeyword({ "zalamon" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "What? What do you mean by that?"
})
keywordHandler:addKeyword({ "emperor" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Hmm, an old one. I don't care much about politics or power, as here, he has none. Here, only I have power. Muhaha."
})
keywordHandler:addKeyword({ "resistance" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "What are you talking about, such things do not matter down here. Down here alone, isolated and broken. Muhaha."
})
