...
local BOOST_DURATION = 3600  --3600, 1 hora
...
function expscroll.onUse(cid, item, fromPosition, itemEx, toPosition)
    ...
    player:setXpBoostPercent(65)  -- Supongamos un 75% de incremento en XP
    ...
    player:say('Your hour of 65% bonus XP has started!', TALKTYPE_MONSTER_SAY)
    return true
end
