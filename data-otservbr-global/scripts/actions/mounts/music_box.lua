local config = {
	...
	draptor = {
		mountId = 6,
		tameMessage = "You have tamed the wild draptor.",
		sound = "Screeeeeeeeech",
		ACHIEV = "Scales and Tail"
	},
	["enraged white deer"] = {
		mountId = 18,
		tameMessage = "You have tamed the deer.",
		sound = "bell",
		ACHIEV = "Friend of Elves"
	},
	ironblight = {
		mountId = 29,
		tameMessage = "You tamed the ironblight.",
		sound = "Plinngggg",
		ACHIEV = "Magnetised"
	},
	["magma crawler"] = {
	...
	["midnight panther"] = {
		mountId = 5,
		tameMessage = "You have tamed the wild panther.",
		sound = "Purrrrrrr",
	...
	["wild horse"] = {
		mountId = 17,
		mountName = "war horse",
		tameMessage = "The horse eats the sugar oat and accepts you as its new master.",
		sound = "*snort*",
		ACHIEV = "Lucky Horseshoe"
	},
	panda = {
		mountId = 19,
		tameMessage = "You have tamed the panda.",
		sound = "Rrrrr...",
