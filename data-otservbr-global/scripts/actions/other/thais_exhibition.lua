local ThaisExhibitionConfig = {
	[Storage.ThaisExhibition.FriendshipAmulet] = {
		sounds = { { text = "Hail |PLAYERNAME|, my friend!" }, { text = "Friends forever!" }, { text = "Look, how our friendship shines!" }, { text = "Hail Tibiafriends!" } },
		itemid = 9802,
		dir = DIRECTION_NORTH
	},
	...
	[Storage.ThaisExhibition.EpaminondasDoll] = {
		sounds = { { text = "Hauopa!" }, {
			text = "Yala Boom",
			exhibitEffect = CONST_ME_SOUND_RED
	...
	[Storage.ThaisExhibition.NorsemanDoll] = {
		sounds = { { text = "Hail TibiaNordic!" }, { text = "So cold..." }, { text = "Run, mammoth!" } },
		itemid = 8154,
		dir = DIRECTION_WEST
	},
	[Storage.ThaisExhibition.BookwormDoll] = {
		sounds = { { text = "Hail Tibia Library!" }, { text = "Shhhhhh, please be quiet!" }, { text = "Books are great!! Aren't they?" } },
		itemid = 18343,
		dir = DIRECTION_NORTH
	},
	[Storage.ThaisExhibition.GoldenNewspaper] = {
		sounds = { { text = "It's news to me." }, { text = "News, updated as infrequently as possible!" }, { text = "Extra! Extra! Read all about it!" }, { text = "Fresh off the press!" } },
		itemid = 8153,
		dir = DIRECTION_NORTH
	},
	...
	[Storage.ThaisExhibition.GoldenFalcon] = {
		sounds = { { text = "Oh, when I get my claws on you..." }, { text = "Let's hunt, |PLAYERNAME|!" }, { text = "Hail TibiaBR.com! Flap! Flap!" } },
		itemid = 8148,
		transformid = 8175,
		dir = DIRECTION_NORTH
	},
	...
	[Storage.ThaisExhibition.FerumbrasDoll] = {
		sounds = { { text = "Mwahaha!" }, { text = "NO ONE WILL STOP ME THIS TIME!" }, { text = "THE POWER IS IN TIBIOPEDIA!" }, { text = "THE POWER IS MINE!" } },
		itemid = 10798,
		dir = DIRECTION_NORTH
	},
	...
	[Storage.ThaisExhibition.DrakenDoll] = {
		sounds = { { text = "For zze emperor!" }, { text = "Hail TibiaJourney.com!" }, { text = "Hail |PLAYERNAME|!" } },
		itemid = 12043,
		dir = DIRECTION_NORTH
	},
	...
	[Storage.ThaisExhibition.DurinTheAlmighty] = {
		sounds = { { text = "My powers are limitless!" }, { text = "Hail Tibia Bariloche!" } },
		itemid = 14764,
		dir = DIRECTION_NORTH
	},
	[Storage.ThaisExhibition.DragonEye] = {
		sounds = { { text = "Do not trade me!" }, { text = "Hail |PLAYERNAME|!" }, { text = "Hail Tibia-Market!" } },
		itemid = 16262,
		dir = DIRECTION_NORTH
	},
	...
	[Storage.ThaisExhibition.MedusaSkull] = {
		sounds = { { text = "I will petrify thisss moment! Sstonesss are forever!!!" }, { text = "Where isss my body?!? I'll kill you!!!" } },
		itemid = 14762,
		dir = DIRECTION_NORTH
	},
	[Storage.ThaisExhibition.MathmasterShield] = {
		sounds = { { exhibitEffect = CONST_ME_LOSEENERGY } },
		itemid = 14760,
		transformid = 14761,
		dir = DIRECTION_NORTH
	},
	[Storage.ThaisExhibition.Imortus] = {
		sounds = { { text = "Now you will see, |PLAYERNAME|!" }, { text = "More eyes for many numbers!" }, { text = "594!? So easy..." }, { text = "Numbers for Exhiti..." } },
		itemid = 12811,
		transformid = 12812,
		dir = DIRECTION_WEST
	},
	[Storage.ThaisExhibition.OldRadio] = {
		itemids = { {
			sounds = { { text = "Now Tibia bffff... has sound." }, { text = "Hail bffff... RadioTibia!" }, { text = "Hello bffff... |PLAYERNAME|." } },
			itemid = 12813,
			transformid = 12814
		}, {
			itemid = 12814,
	...
	[Storage.ThaisExhibition.EpicWisdom] = {
		sounds = { {
			text = "MY BRAIN... TOO MUCH... KNOWLEDGE! AAAAH!",
			playerEffect = CONST_ME_STUN
		}, { text = "Excalibug is lying at the heart of every true fighter." }, { text = "Fire is fascinating. But whether it is going to light your path or burning you till death, you can never tell." } },
		itemid = 12809,
		dir = DIRECTION_NORTH
	},
	[Storage.ThaisExhibition.DreadDoll] = {
		sounds = { { text = "Mhausheausheu! What a FAIL! Mwahaha!" }, { text = "Hail |PLAYERNAME|! You are wearing old socks!" }, { text = "ou are so unpopular even your own shadow refuses to follow you." }, { text = "Have fun with FunTibia.com!" } },
		itemid = 12904,
		dir = DIRECTION_NORTH
	},
	[Storage.ThaisExhibition.PhoenixStatue] = {
		sounds = { { text = "Come closer, I will show some Tibian mysteries to you!" }, { text = "Feel the eternity of Tibiafans.se!" }, { text = "|PLAYERNAME|, you are worthy to feel the power of Tibiafans.se! HAIL TIBIAFANS!" } },
		itemid = 4115,
		dir = DIRECTION_WEST
	},
	[Storage.ThaisExhibition.OrcsJawShredder] = {
		sounds = { { text = "Hail |PLAYERNAME|!" }, { text = "Hail TibiaSpy.com!" }, { text = "Wrrrzzzgggrrzzzz..." }, { text = "Yummy..." } },
		itemid = 10800,
		dir = DIRECTION_NORTH
	},
	...
	[Storage.ThaisExhibition.TibiorasBox] = {
		sounds = { { text = "Click! You don't seem experienced enough to open this properly." }, { text = "Click! The box won't open for you." }, { text = "Click! This item is too precious for a newbie. You are unable to open it." } },
		itemid = 3997,
		transformid = 4010,
		transformDuration = 7000,
		dir = DIRECTION_NORTH
...
local function resetExhibit(exhibitPosition, uid)
	...
	if not settings.transformid then return end
