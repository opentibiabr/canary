local config = {
	...
	requiredLevel = 250,
	playerPositions = { {
		pos = Position(33893, 31388, 15),
		teleport = Position(33904, 31356, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(33894, 31388, 15),
		teleport = Position(33904, 31356, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(33895, 31388, 15),
		teleport = Position(33904, 31356, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(33896, 31388, 15),
		teleport = Position(33904, 31356, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(33897, 31388, 15),
		teleport = Position(33904, 31356, 14),
		effect = CONST_ME_TELEPORT
	} },
	specPos = {
