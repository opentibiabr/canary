local config = {
	...
	requiredLevel = 250,
	playerPositions = { {
		pos = Position(32578, 32500, 12),
		teleport = Position(32619, 32498, 12)
	}, {
		pos = Position(32578, 32501, 12),
		teleport = Position(32619, 32498, 12)
	}, {
		pos = Position(32578, 32502, 12),
		teleport = Position(32619, 32498, 12)
	}, {
		pos = Position(32578, 32503, 12),
		teleport = Position(32619, 32498, 12)
	}, {
		pos = Position(32578, 32504, 12),
		teleport = Position(32619, 32498, 12)
	} },
	specPos = {
