local config = {
	OldGate = {
		fromPosition = Position(33978, 32177, 14),
		toPosition = Position(33982, 32177, 14)
	},
	LostRuin = {
		fromPosition = Position(33946, 32161, 14),
		toPosition = Position(33951, 32163, 14)
	},
	TheGaze = {
		fromPosition = Position(33962, 32139, 14),
		toPosition = Position(33976, 32148, 14)
	},
	Outpost = {
		fromPosition = Position(33865, 32008, 14),
		toPosition = Position(33875, 32021, 14)
	},
	Bastion = {
		fromPosition = Position(33923, 31983, 14),
		toPosition = Position(33942, 31998, 14)
	},
	BrokenTower = {
		fromPosition = Position(33859, 32358, 14),
		toPosition = Position(33867, 32363, 14)
	}
}
