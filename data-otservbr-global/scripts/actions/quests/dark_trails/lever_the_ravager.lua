local setting = {
	...
	range = 10,
	playerPositions = { Position(33417, 32102, 10), Position(33418, 32102, 10), Position(33419, 32102, 10), Position(33420, 32102, 10) },
	newPositions = { Position(33487, 32088, 8), Position(33487, 32088, 8), Position(33487, 32088, 8), Position(33487, 32088, 8) },
	canopicJarPositions = { Position(33486, 32081, 8), Position(33488, 32081, 8), Position(33486, 32083, 8), Position(33488, 32083, 8) }
}
...
function leverTheRavager.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	if item.itemid == 2772 then
		...
		Game.createMonster("the ravager", {
			x = 33487,
			y = 32108,
			z = 9
		})
