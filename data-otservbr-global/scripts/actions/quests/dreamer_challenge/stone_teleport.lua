local config = {
	[2772] = {
		sacrifices = { {
			position = Position(32878, 32270, 14),
			itemId = 2886
		}, {
			position = Position(32881, 32267, 14),
			itemId = 3052
		}, {
			position = Position(32881, 32273, 14),
			itemId = 6299
		}, {
			position = Position(32884, 32270, 14),
			itemId = 21465
		} }, -- or itemID = 2118 for PVP servers
		wells = { {
			position = Position(32874, 32263, 14),
			wellId = 2094,
			transformId = 2098
		}, {
			position = Position(32875, 32263, 14),
			wellId = 2095,
			transformId = 2099
		}, {
			position = Position(32874, 32264, 14),
			wellId = 2096,
			transformId = 2100
		}, {
			position = Position(32875, 32264, 14),
			wellId = 2097,
			transformId = 2101
		} }
	},
