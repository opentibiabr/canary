...
function explorerSocietyStone.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	if target.uid == 25018 and player:getStorageValue(Storage.ExplorerSociety.TheSpectralStone) == 53 and player:getStorageValue(Storage.ExplorerSociety.QuestLine) == 53 and player:getStorageValue(Storage.ExplorerSociety.SpectralStone) == 1 then
