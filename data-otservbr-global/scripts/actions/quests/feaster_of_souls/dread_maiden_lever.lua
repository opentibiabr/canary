local config = {
	...
	requiredLevel = 250,
	playerPositions = { {
		pos = Position(33739, 31506, 14),
		teleport = Position(33711, 31510, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(33740, 31506, 14),
		teleport = Position(33711, 31510, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(33741, 31506, 14),
		teleport = Position(33711, 31510, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(33742, 31506, 14),
		teleport = Position(33711, 31510, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(33743, 31506, 14),
		teleport = Position(33711, 31510, 14),
		effect = CONST_ME_TELEPORT
	} },
	specPos = {
