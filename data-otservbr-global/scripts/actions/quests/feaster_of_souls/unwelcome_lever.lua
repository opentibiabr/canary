local config = {
	...
	requiredLevel = 250,
	playerPositions = { {
		pos = Position(33736, 31537, 14),
		teleport = Position(33708, 31547, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(33737, 31537, 14),
		teleport = Position(33708, 31547, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(33738, 31537, 14),
		teleport = Position(33708, 31547, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(33739, 31537, 14),
		teleport = Position(33708, 31547, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(33740, 31537, 14),
		teleport = Position(33708, 31547, 14),
		effect = CONST_ME_TELEPORT
	} },
	specPos = {
