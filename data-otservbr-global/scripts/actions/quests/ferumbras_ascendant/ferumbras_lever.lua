		...
		for x = 33269, 33271 do
			for y = 31477, 31481 do
				...
				if playerTile and playerTile:isPlayer() then
					if not playerTile:canFightBoss(config.mortalShell) then
		...
		for x = 33269, 33271 do
			for y = 31477, 31481 do
				...
				if playerTile and playerTile:isPlayer() then
					...
					playerTile:setBossCooldown(config.mortalShell, os.time() + config.days * 24 * 3600)
					...
					Game.createMonster(config.mortalShell, config.bossPos, true, true)
					item:transform(8912)
				end
			end
		end
