...
local config = {
	...
	playerPositions = { {
		pos = Position(32302, 31088, 14),
		teleport = Position(32271, 31097, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(32302, 31089, 14),
		teleport = Position(32271, 31097, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(32302, 31090, 14),
		teleport = Position(32271, 31097, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(32302, 31091, 14),
		teleport = Position(32271, 31097, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(32302, 31092, 14),
		teleport = Position(32271, 31097, 14),
		effect = CONST_ME_TELEPORT
	} },
	monsters = { {
		name = "icicle",
		pos = Position(32266, 31084, 14)
	}, {
		name = "icicle",
		pos = Position(32272, 31084, 14)
	}, {
		name = "dragon egg",
		pos = eggPos
	}, {
		name = "melting frozen horror",
		pos = Position(32267, 31071, 14)
	} },
	specPos = {
