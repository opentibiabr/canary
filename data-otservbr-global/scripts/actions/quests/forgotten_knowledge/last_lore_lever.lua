local config = {
	...
	playerPositions = { {
		pos = Position(32018, 32844, 14),
		teleport = Position(31984, 32851, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(32019, 32844, 14),
		teleport = Position(31984, 32851, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(32020, 32844, 14),
		teleport = Position(31984, 32851, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(32018, 32845, 14),
		teleport = Position(31984, 32851, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(32019, 32845, 14),
		teleport = Position(31984, 32851, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(32020, 32845, 14),
		teleport = Position(31984, 32851, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(32018, 32846, 14),
		teleport = Position(31984, 32851, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(32019, 32846, 14),
		teleport = Position(31984, 32851, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(32020, 32846, 14),
		teleport = Position(31984, 32851, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(32018, 32847, 14),
		teleport = Position(31984, 32851, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(32019, 32847, 14),
		teleport = Position(31984, 32851, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(32020, 32847, 14),
		teleport = Position(31984, 32851, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(32018, 32848, 14),
		teleport = Position(31984, 32851, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(32019, 32848, 14),
		teleport = Position(31984, 32851, 14),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(32020, 32848, 14),
		teleport = Position(31984, 32851, 14),
		effect = CONST_ME_TELEPORT
	} },
	bossPosition = Position(31987, 32839, 14),
	monsters = { {
		pos = Position(31973, 32840, 15),
		monster = "bound astral power"
	}, {
		pos = Position(31973, 32856, 15),
		monster = "bound astral power"
	}, {
		pos = Position(31989, 32856, 15),
		monster = "bound astral power"
	}, {
		pos = Position(31989, 32840, 15),
		monster = "bound astral power"
	}, {
		pos = Position(31986, 32840, 14),
		monster = "a shielded astral glyph"
	}, {
		pos = Position(31986, 32823, 15),
		monster = "the distorted astral source"
	}, {
		pos = Position(31989, 32823, 15),
		monster = "an astral glyph"
	} },
	specPos = {
