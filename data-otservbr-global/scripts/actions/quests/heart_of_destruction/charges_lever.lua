					...
					if creatures and #creatures > 0 then
						for _, c in pairs(creatures) do
							if c == team[1] or c == team[2] then
								...
								c:say("A shift in polarity switches creatures with coresponding polarity into another phase of existence!", TALKTYPE_MONSTER_YELL, isInGhostMode, pid, {
									x = 32158,
									y = 31355,
									z = 14
								})
...
function heartDestructionCharges.onUse(player, item, fromPosition, itemEx, toPosition)
	local config = {
		playerPositions = { Position(32091, 31327, 12), Position(32092, 31327, 12), Position(32093, 31327, 12), Position(32094, 31327, 12), Position(32095, 31327, 12) },
		newPos = {
			x = 32135,
			y = 31363,
			z = 14
