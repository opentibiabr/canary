...
function heartDestructionRupture.onUse(player, item, fromPosition, itemEx, toPosition)
	local config = {
		playerPositions = { Position(32309, 31248, 14), Position(32309, 31249, 14), Position(32309, 31250, 14), Position(32309, 31251, 14), Position(32309, 31252, 14) },
		newPos = {
			x = 32335,
			y = 31257,
			z = 14
			...
			if player:getPosition().x == pushPos.x and player:getPosition().y == pushPos.y and player:getPosition().z == pushPos.z then
				...
				if doCheckArea() == false then
					...
					for i = 1, #storePlayers do
						...
						players:setStorageValue(14323, os.time() + configManager.getNumber(configKeys.BOSS_DEFAULT_TIME_TO_FIGHT_AGAIN))
					end
