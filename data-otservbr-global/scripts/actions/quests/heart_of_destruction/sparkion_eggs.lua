local config = {
	[23538] = {
		mountId = 94,
		message = "You receive the permission to ride a sparkion"
	},
	[23684] = {
		mountId = 98,
		message = "You receive the permission to ride a neon sparkid"
	},
	[23685] = {
		mountId = 99,
		message = "You receive the permission to ride a vortexion"
	}
}
