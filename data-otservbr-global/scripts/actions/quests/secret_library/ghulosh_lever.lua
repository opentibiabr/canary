local config = {
	...
	requiredLevel = 250,
	playerPositions = { {
		pos = Position(32747, 32773, 10),
		teleport = Position(32756, 32729, 10),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(32748, 32773, 10),
		teleport = Position(32756, 32729, 10),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(32749, 32773, 10),
		teleport = Position(32756, 32729, 10),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(32750, 32773, 10),
		teleport = Position(32756, 32729, 10),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(32751, 32773, 10),
		teleport = Position(32756, 32729, 10),
		effect = CONST_ME_TELEPORT
	} },
	specPos = {
