local storagesTable = { {
	storage = Storage.Quest.U12_40.SoulWar.GoshnarMaliceKilled,
	bossName = "Goshnar's Malice"
}, {
	storage = Storage.Quest.U12_40.SoulWar.GoshnarHatredKilled,
	bossName = "Goshnar's Hatred"
}, {
	storage = Storage.Quest.U12_40.SoulWar.GoshnarSpiteKilled,
	bossName = "Goshnar's Spite"
}, {
	storage = Storage.Quest.U12_40.SoulWar.GoshnarCrueltyKilled,
	bossName = "Goshnar's Cruelty"
}, {
	storage = Storage.Quest.U12_40.SoulWar.GoshnarGreedKilled,
