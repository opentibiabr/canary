...
{
	Position(32263, 32481, 13),
	Position(32274, 32490, 13)
}, {
	Position(32163, 32558, 13),
	Position(32173, 32567, 13)
}, {
	Position(32201, 32667, 13),
	Position(32211, 32672, 13)
}, {
	Position(32135, 32606, 14),
	Position(32143, 32614, 14)
}, {
	Position(32330, 32519, 14),
	Position(32339, 32521, 14)
}, { Position(32260, 32697, 14), Position(32272, 32705, 14) }, { Position(32176, 32493, 15), Position(32186, 32502, 15) }, { Position(32341, 32577, 15), Position(32347, 32586, 15) }, { Position(32220, 32643, 15), Position(32223, 32652, 15) } }
