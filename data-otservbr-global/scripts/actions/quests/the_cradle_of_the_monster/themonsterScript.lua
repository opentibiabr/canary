...
local t = {
    players = { 
        [1] = Position(33812, 32584, 12),
        [2] = Position(33811, 32584, 12),
        [3] = Position(33810, 32584, 12),
        [4] = Position(33809, 32584, 12),
        [5] = Position(33808, 32584, 12)
    },
    
    boss = {name = "The Monster", create_pos = Position(33842, 32591, 12)},  
    destination = Position(33831, 32591, 12), 
    
    cooldown = {20, "hour"},
    
    storageEvent = Storage.Quest.U13_10.CradleOfMonsters.Bosses.TheMonsterKilled,
    storage = Storage.Quest.U13_10.CradleOfMonsters.Bosses.TheMonsterTimer
}


local themonsterScript = Action()
function themonsterScript.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
themonsterScript:uid(38591)
themonsterScript:register()
