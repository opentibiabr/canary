local travel = { { wagon = Position(32578, 31488, 9) }, { -- start
	wagon = Position(32577, 31508, 9),
	destination = Position(32611, 31513, 9)
}, { -- bridge stage after completion
	wagon = Position(32628, 31514, 9),
	destination = Position(32652, 31507, 10)
}, { -- rubble stage after completion
	wagon = Position(32694, 31495, 11),
	destination = Position(32661, 31495, 13)
}, { -- from third rail
	wagon = Position(32696, 31495, 11),
	destination = Position(32704, 31507, 12)
}, { -- from forth rail
	wagon = Position(32599, 31505, 13),
	destination = Position(32604, 31338, 11)
}, { -- city's entrance
	wagon = Position(32603, 31339, 11),
	destination = Position(32600, 31504, 13)
}, { -- location exit
	wagon = Position(32700, 31452, 13),
	destination = Position(32604, 31338, 11)
}, { -- corner maze room
	wagon = Position(32570, 31508, 9),
	destination = Position(32580, 31487, 9),
	destination2 = Position(32578, 31507, 9)
}, { -- bridge stage
	wagon = Position(32615, 31514, 9),
	destination = Position(32580, 31487, 9),
	destination2 = Position(32624, 31514, 9)
}, { -- rubble stage
	wagon = Position(32651, 31508, 10),
	destination = Position(32580, 31487, 9)
}, { -- broken bridge
	wagon = Position(32633, 31508, 10),
	destination = Position(32580, 31487, 9)
}, { -- stairs
	wagon = Position(32693, 31502, 11),
	destination = Position(32580, 31487, 9)
}, { -- wagon station
	wagon = Position(32688, 31472, 13),
	destination = Position(32580, 31487, 9)
}, { -- maze
	wagon = Position(32683, 31508, 10),
	destination = Position(32692, 31501, 11)
}, { -- ladder
	wagon = Position(32662, 31496, 13),
	destination = Position(32692, 31501, 11)
}, { -- to third rail
	wagon = Position(32703, 31506, 12),
	destination = Position(32692, 31501, 11)
}, { -- to forth rail
	wagon = Position(32692, 31495, 11),
	destination = Position(32687, 31470, 13)
}, { -- second rail
	wagon = Position(32548, 31408, 11),
	destination = Position(32687, 31470, 13)
}, { -- infested tavern
	wagon = Position(32700, 31449, 15),
	destination = Position(32687, 31470, 13)
}, { -- npc tehlim
	wagon = Position(32720, 31488, 15),
	destination = Position(32687, 31470, 13)
}, { -- troll tribe's hideout
	wagon = Position(32688, 31471, 13),
	destination = Position(32687, 31470, 13)
} } -- maze logic
...
function wagons.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	}, --NPC Tehlim
	{
		...
		railCheck = Tile(
			Position(32688, 31469, 13)
		):getItemById(7124) and Tile(Position(32690, 31465, 13)):getItemById(7125) and Tile(Position(32684, 31464, 13)):getItemById(7122) and Tile(Position(32682, 31455, 13)):getItemById(7121) and Tile(Position(32687, 31452, 13)):getItemById(7125) and Tile(Position(32692, 31453, 13)):getItemById(7126)
	}, --Troll tribe's hideout
	{
