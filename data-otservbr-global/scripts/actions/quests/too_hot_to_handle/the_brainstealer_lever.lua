local config = {
	...
	requiredLevel = 250,
	playerPositions = { {
		pos = Position(32530, 31122, 15),
		teleport = Position(32495, 31129, 15),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(32531, 31122, 15),
		teleport = Position(32495, 31129, 15),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(32532, 31122, 15),
		teleport = Position(32495, 31129, 15),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(32533, 31122, 15),
		teleport = Position(32495, 31129, 15),
		effect = CONST_ME_TELEPORT
	}, {
		pos = Position(32534, 31122, 15),
		teleport = Position(32495, 31129, 15),
		effect = CONST_ME_TELEPORT
	} },
	specPos = {
