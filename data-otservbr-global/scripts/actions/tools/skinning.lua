...
function skinning.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	if item.itemid == 5908 then
		...
		elseif target.itemid == 10735 and player:getItemCount(11699) > 0 and player:getStorageValue(Storage.TibiaTales.AnInterestInBotany.Questline) == 1 then
			...
			player:setStorageValue(Storage.TibiaTales.AnInterestInBotany.Questline, 2)
			return true
		elseif target.itemid == 10697 and player:getItemCount(11699) > 0 and player:getStorageValue(Storage.TibiaTales.AnInterestInBotany.Questline) == 2 then
			...
			player:setStorageValue(Storage.TibiaTales.AnInterestInBotany.Questline, 3)
			return true
