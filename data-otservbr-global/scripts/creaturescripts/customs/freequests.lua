...
local questTable = {
	...
	{ storageName = "TheSecretLibrary.MoTA.LeverPermission", storage = 46062, storageValue = 1 },
	{ storageName = "TheSecretLibrary.MoTA.FinalBasin", storage = 46077, storageValue = 1 },
	{ storageName = "TheSecretLibrary.MoTA.SkullSample", storage = 46077, storageValue = 1 },
	{ storageName = "TheSecretLibrary.MoTA.YellowGem", storage = 46074, storageValue = 1 },
	{ storageName = "TheSecretLibrary.MoTA.GreenGem", storage = 46075, storageValue = 1 },
	{ storageName = "TheSecretLibrary.MoTA.RedGem", storage = 46076, storageValue = 1 },
