...
local stages = { {
	...
	health = 515000 * healthMultiplier
}, {
	name = "Wildness of Urmahlullu",
	health = 400000 * healthMultiplier
}, {
	name = "Urmahlullu the Tamed",
	health = 300000 * healthMultiplier
}, {
	name = "Wisdom of Urmahlullu",
	health = 200000 * healthMultiplier
}, {
	name = "Urmahlullu the Weakened",
	health = 100000 * healthMultiplier
} }
