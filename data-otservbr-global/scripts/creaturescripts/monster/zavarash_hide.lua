...
function zavarashHide.onThink(creature)
	...
	if creature:getCondition(CONDITION_POISON, CONDITIONID_COMBAT) or creature:getCondition(CONDITION_FIRE, CONDITIONID_COMBAT) or creature:getCondition(CONDITION_ENERGY, CONDITIONID_COMBAT) or creature:getCondition(
		CONDITION_BLEEDING,
		CONDITIONID_COMBAT
