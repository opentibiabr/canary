...
function sparkDeath.onDeath(creature)
	if unstableSparksCount < 10 then
		...
		creature:say("The death of the spark charges the room!", TALKTYPE_MONSTER_YELL, isInGhostMode, pid, {
			x = 32143,
			y = 31308,
			z = 14
		})
	elseif unstableSparksCount == 10 then
		setStorage()
		creature:say("The room is fully charged up! You are permeated with its power and can venture deeper into the heart of destruction now!", TALKTYPE_MONSTER_YELL, isInGhostMode, pid, {
			x = 32143,
			y = 31308,
			z = 14
		})
