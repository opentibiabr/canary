local config = {
    ...
    bossPosition = Position(33652, 32905, 15), 
    bossArea = {
        fromPos = Position(33633, 32886, 15), 
        toPos = Position(33669, 32921, 15), 
        entrancePos = Position(33654, 32919, 15), 
        exitPosition = Position(33669, 32932, 15) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(33669, 32926, 15),
        Position(33669, 32927, 15),
        Position(33669, 32928, 15), 
        Position(33669, 32929, 15),
        Position(33669, 32930, 15)  
    },
    attempts = {
        level = 100, 
        storage = 710006, 
    ...
    createTeleportPos = Position(33658, 32919, 15), 
    teleportToPosition = Position(33669, 32932, 15), 
    ...
    config.kickEventId = addEvent(function ()
        for _, spectator in pairs(getSpectators()) do
            if spectator:isPlayer() then
                ...
                spectator:sendTextMessage(MESSAGE_INFO_DESCR, "It's been a long time and you haven't managed to defeat Magma Bubble.")
            else
                spectator:remove()
            end
        end
