local config = {
    actionId = 43020, 
    bossName = "Archangel",
    bossPosition = Position(31896, 31810, 9), 
    bossArea = {
        fromPos = Position(31889, 31805, 9), 
        toPos = Position(31904, 31821, 9), 
        entrancePos = Position(31896, 31820, 9), 
        exitPosition = Position(31865, 31817, 9) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(31863, 31819, 9),
        Position(31862, 31820, 9),
        Position(31863, 31820, 9), 
        Position(31864, 31820, 9),
        Position(31862, 31821, 9),
        Position(31863, 31821, 9),
        Position(31864, 31821, 9),
    },
    attempts = {
        level = 100, 
        storage = 710017, 
    ...
    createTeleportPos = Position(31903, 31820, 9), 
    teleportToPosition = Position(31865, 31817, 9), 
...
local archangelLever = Action()

function archangelLever.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("ArchangelLeverBoss")
...
archangelLever:aid(config.actionId)
archangelLever:register()

local creatureEvent = CreatureEvent("ArchangelLeverBoss")
