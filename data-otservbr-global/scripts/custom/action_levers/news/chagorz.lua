local config = {
    actionId = 43016, 
    bossName = "Chagorz",
    bossPosition = Position(31361, 31965, 10), 
    bossArea = {
        fromPos = Position(31351, 31955, 10), 
        toPos = Position(31371, 31976, 10), 
        entrancePos = Position(31361, 31974, 10), 
        exitPosition = Position(31317, 32001, 12) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(31320, 31999, 12),
        Position(31320, 32000, 12),
        Position(31320, 32001, 12), 
        Position(31320, 32002, 12)
    },
    attempts = {
        level = 100, 
        storage = 710012, 
    ...
    createTeleportPos = Position(31353, 31966, 10), 
    teleportToPosition = Position(31317, 32001, 12), 
