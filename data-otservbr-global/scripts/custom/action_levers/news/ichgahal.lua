local config = {
    actionId = 43017, 
    bossName = "Ichgahal",
    bossPosition = Position(31411, 31909, 9), 
    bossArea = {
        fromPos = Position(31393, 31899, 9), 
        toPos = Position(31430, 31933, 9), 
        entrancePos = Position(31410, 31928, 9), 
        exitPosition = Position(31432, 31896, 9) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(31430, 31893, 9),
        Position(31431, 31893, 9),
        Position(31432, 31893, 9), 
        Position(31433, 31893, 9)
    },
    attempts = {
        level = 100, 
        storage = 710013, 
    ...
    createTeleportPos = Position(31411, 31919, 9), 
    teleportToPosition = Position(31432, 31896, 9), 
...
local ichagahalLever = Action()

function ichagahalLever.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("ichagahalBossLever")
...
ichagahalLever:aid(config.actionId)
ichagahalLever:register()

local creatureEvent = CreatureEvent("ichagahalBossLever")
