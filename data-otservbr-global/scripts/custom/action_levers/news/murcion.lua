local config = {
    actionId = 43018, 
    bossName = "Murcion",
    bossPosition = Position(31832, 31981, 8), 
    bossArea = {
        fromPos = Position(31809, 31969, 8), 
        toPos = Position(31840, 31994, 8), 
        entrancePos = Position(31811, 31981, 8), 
        exitPosition = Position(31821, 31915, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(31819, 31914, 8),
        Position(31819, 31915, 8),
        Position(31819, 31916, 8), 
        Position(31819, 31917, 8)
    },
    attempts = {
        level = 100, 
        storage = 710014, 
    ...
    createTeleportPos = Position(31810, 31981, 8), 
    teleportToPosition = Position(31821, 31915, 8), 
...
local murcionLever = Action()

function murcionLever.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("murcionBossLever")
...
murcionLever:aid(config.actionId)
murcionLever:register()

local creatureEvent = CreatureEvent("murcionBossLever")
