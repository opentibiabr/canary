local config = {
	...
	playerPositions = {
		{pos = Position(33809, 32702, 8), teleport = Position(33815, 32699, 9), effect = CONST_ME_TELEPORT},
		
	},
	bossPosition = Position(33815, 32704, 9),
	specPos = {
		from = Position(33806, 32696, 9),
		to = Position(33823, 32709, 9)
	},
