local config = {
    ...
    playItem = {
        itemId = 49685, -- item required to pull lever "Casino Token"
        count = 1
    },
    rouletteOptions = {
    ...
    prizePool = {
        {itemId = 3043, count = {1, 1},   chance = 10000}, 
        {itemId = 37109, count = {1, 1},    chance = 9000 },
        {itemId = 31964, count = {1, 1},    chance = 500 }, 
        {itemId = 37110, count = {1, 1},    chance = 7500 },
        {itemId = 22516, count = {1, 4},   chance = 6500 }, 
        {itemId = 22721, count = {1, 2}, chance = 5000 }, 
        {itemId = 3363, count = {1, 1},   chance = 210 },  -- Dragon Scale legs
        {itemId = 3394, count = {1, 1}, chance = 240 },  -- Amazon Armor
        {itemId = 3393, count = {1, 1},    chance = 180 }, -- Amazon helmet
        {itemId = 3365, count = {1, 1},    chance = 220 }, -- Golden Helmet
        {itemId = 8097, count = {1, 1},    chance = 218 }, -- Solar Axe
        {itemId = 8103, count = {1, 1},    chance = 228 }, -- The Epiphany
        {itemId = 3390, count = {1, 1},    chance = 210 }, -- Horned Helmet
        {itemId = 3423, count = {1, 1},    chance = 250  }  -- Blessed shield
    
    },
    roulettePositions = { -- hard-coded to 7 positions.
        Position(32228, 32186, 5),
        Position(32229, 32186, 5),
        Position(32230, 32186, 5),
        Position(32231, 32186, 5), -- position 4 in this list is hard-coded to be the reward location, which is the item given to the player
        Position(32232, 32186, 5),
        Position(32233, 32186, 5),
        Position(32234, 32186, 5),
    }
}
