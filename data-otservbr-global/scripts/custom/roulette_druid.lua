local config = {
    ...
    prizePool = {
		...
		{itemId = 49720, count = {1, 1},    chance = 600 }, -- knight chest		
		{itemId = 49752, count = {1, 1},    chance = 550 }, -- rod box		
    ...
    roulettePositions = { -- hard-coded to 7 positions.
        ...
        Position(1293, 795, 7),
        Position(1294, 795, 7),
        Position(1295, 795, 7),-- position 4 in this list is hard-coded to be the reward location, which is the item given to the player {x = 1295, y = 795, z = 7}
        Position(1296, 795, 7),
        Position(1297, 795, 7),
        Position(1298, 795, 7),
    }
