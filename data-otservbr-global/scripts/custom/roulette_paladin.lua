local config = {
    ...
    prizePool = {
        {itemId = 45248, count = {1, 3},    chance = 4000 }, -- roulette token
		{itemId = 34109, count = {1, 1},    chance = 1500 }, -- bag you desire
		{itemId = 49606, count = {1, 1},    chance = 1500 }, -- bp
		{itemId = 49605, count = {1, 1},    chance = 1500 }, -- bp2
		{itemId = 49604, count = {1, 1},    chance = 1500 }, -- bp3
		{itemId = 49662, count = {1, 1},    chance = 1500 }, -- bp4
		{itemId = 49661, count = {1, 1},    chance = 1500 }, -- bp 5
		{itemId = 49610, count = {1, 1},    chance = 1500 }, -- skarlet chest
		{itemId = 49609, count = {1, 1},    chance = 1500 }, -- falcon chest
		{itemId = 49613, count = {1, 1},    chance = 1500 }, -- brainstealer chest
		{itemId = 49612, count = {1, 1},    chance = 1500 }, -- timira chest
		{itemId = 49611, count = {1, 1},    chance = 1500 }, -- drume chest
		{itemId = 36836, count = {1, 1},    chance = 1500 }, -- eldricth caket
		{itemId = 39546, count = {1, 1},    chance = 1500 }, -- primal bag
		{itemId = 20063, count = {1, 1},    chance = 1500 }, -- dream matter
		{itemId = 43860, count = {1, 1},    chance = 1500 }, -- bag you covet
		{itemId = 49614, count = {1, 1},    chance = 1500 }, -- ratmiral chest
		{itemId = 49722, count = {1, 1},    chance = 600 }, -- paladin chest
		{itemId = 49749, count = {1, 1},    chance = 550 }, -- crossbow box
		{itemId = 49751, count = {1, 1},    chance = 500 }, -- bow chest
        {itemId = 34098, count = {1, 1},    chance = 1500  }  -- golden boots
    ...
    roulettePositions = { -- hard-coded to 7 positions.
        ...
        Position(1223, 853, 7),
        Position(1224, 853, 7),
        Position(1225, 853, 7),-- position 4 in this list is hard-coded to be the reward location, which is the item given to the player {x = 1225, y = 853, z = 7}
        Position(1226, 853, 7),
        Position(1227, 853, 7),
        Position(1228, 853, 7),
    }
