local config = {
    ...
    prizePool = {
        {itemId = 45248, count = {1, 3},    chance = 1500 }, -- roulette token
		...
		{itemId = 49614, count = {1, 1},    chance = 1250 }, -- ratmiral chest
		{itemId = 49610, count = {1, 1},    chance = 1200 }, -- skarlet chest
		{itemId = 49609, count = {1, 1},    chance = 1150 }, -- falcon chest
		{itemId = 49613, count = {1, 1},    chance = 1100 }, -- brainstealer chest
		{itemId = 49612, count = {1, 1},    chance = 1050 }, -- timira chest
		{itemId = 49611, count = {1, 1},    chance = 1000 }, -- drume chest
		{itemId = 36836, count = {1, 1},    chance = 950 }, -- eldricth caket
		...
		{itemId = 49719, count = {1, 1},    chance = 650 }, -- sorcerer chest
		{itemId = 49752, count = {1, 1},    chance = 600 }, -- wand box
    ...
    roulettePositions = { -- hard-coded to 7 positions.
        ...
        Position(1226, 793, 7),
        Position(1227, 793, 7),
        Position(1228, 793, 7),-- position 4 in this list is hard-coded to be the reward location, which is the item given to the player
        Position(1229, 793, 7),
        Position(1230, 793, 7),
        Position(1231, 793, 7),
    }
