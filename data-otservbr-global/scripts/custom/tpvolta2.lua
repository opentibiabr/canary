    local tplist = {
        ...
        [40020] = {name = "Teleports 2", level = 250, positions = {{x = 31712, y = 32269, z = 10}}, subareas = {}}
 
}

local firstid = 40020 -- Put your first action id used here
local lastid = 40020 -- Put your last action id used here
