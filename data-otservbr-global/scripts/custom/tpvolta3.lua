    local tplist = {
        ...
        [40030] = {name = "Teleports 2", level = 350, positions = {{x = 31704, y = 32274, z = 11}}, subareas = {}}
 
}

local firstid = 40030 -- Put your first action id used here
local lastid = 40030 -- Put your last action id used here
