local gates = {
	...
	[3] = {
		...
		burntItems = { {
			position = Position(32266, 31842, 7),
			itemId = 6217
		}, {
			position = Position(32258, 31843, 7),
			itemId = 6218
		}, {
			position = Position(32264, 31843, 7),
			itemId = 3917
		} }
	},
	-- Darashia
	[4] = {
		...
		burntItems = { {
			position = Position(33300, 32366, 7),
			itemId = 6217
		} }
	},
	-- Edron
	...
	[6] = {
		...
		burntItems = { {
			position = Position(32571, 31976, 7),
			itemId = 6218
		}, {
			position = Position(32573, 31977, 7),
			itemId = 6218
		}, {
			position = Position(32569, 31984, 7),
			itemId = 6217
		}, {
			position = Position(32572, 31984, 7),
			itemId = 6217
		}, {
			position = Position(32572, 31985, 7),
			itemId = 6218
		} }
	},
	-- Liberty Bay
	...
	[8] = {
		...
		burntItems = { {
			position = Position(32532, 32719, 7),
			itemId = 3696
		} }
	},
	-- Thais
	[9] = {
		...
		burntItems = { {
			position = Position(32269, 32157, 7),
			itemId = 6218
		}, {
			position = Position(32274, 32165, 7),
			itemId = 6218
		} }
	},
	-- Venore
	[10] = {
		...
		burntItems = { {
			position = Position(32836, 32079, 7),
			itemId = 6217
		}, {
			position = Position(32835, 32080, 7),
			itemId = 3693
		}, {
			position = Position(32837, 32080, 7),
			itemId = 6218
		}, {
			position = Position(32828, 32081, 7),
			itemId = 6217
		}, {
			position = Position(32836, 32081, 7),
			itemId = 3686
		}, {
			position = Position(32837, 32081, 7),
			itemId = 6217
		}, {
			position = Position(32827, 32082, 7),
			itemId = 6218
		}, {
			position = Position(32836, 32082, 7),
			itemId = 6218
		}, {
			position = Position(32834, 32084, 7),
			itemId = 3693
		}, {
			position = Position(32830, 32086, 7),
			itemId = 3694
		}, {
			position = Position(32836, 32086, 7),
			itemId = 3683
		}, {
			position = Position(32836, 32087, 7),
			itemId = 3686
		}, {
			position = Position(32838, 32087, 7),
			itemId = 3696
		}, {
			position = Position(32835, 32089, 7),
			itemId = 6217
		}, {
			position = Position(32836, 32091, 7),
			itemId = 3689
		} }
	}
}

local function Furywebhook(
...
function furygates.onStartup(interval)
	...
	Spdlog.info(string.format("Fury Gate will be active in %s today", gates[gateId].city))
