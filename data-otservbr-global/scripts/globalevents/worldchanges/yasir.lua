local config = {
	...
	[1] = {
		removeItems = { {
			position = Position(33096, 32882, 6),
			itemId = 4977
		}, {
			position = Position(33096, 32883, 6),
			itemId = 4977
		}, {
			position = Position(33096, 32883, 6),
			itemId = 4920
		}, {
			position = Position(33096, 32884, 6),
			itemId = 4920
		}, {
			position = Position(33096, 32885, 6),
			itemId = 4920
		}, {
			position = Position(33097, 32883, 6),
			itemId = 4976
		} },
	...
	[2] = {
		removeItems = { {
			position = Position(32393, 31814, 6),
			itemId = 9491
		}, {
			position = Position(32393, 31815, 6),
			itemId = 9491
		}, {
			position = Position(32393, 31816, 6),
			itemId = 9491
		} },
	...
	[3] = {
		removeItems = { {
			position = Position(32309, 32896, 6),
			itemId = 2279
		}, {
			position = Position(32309, 32895, 6),
			itemId = 2279
		}, {
			position = Position(32309, 32894, 6),
			itemId = 2279
		}, {
			position = Position(32309, 32893, 6),
			itemId = 2279
		}, {
			position = Position(32309, 32896, 6),
			itemId = 2257
...
function yasir.onStartup()
	if yasirEnabled then
		if math.random(100) <= yasirChance then
			...
			setGlobalStorageValue(GlobalStorage.Yasir, 1) -- Declaring the message to send to webhook. -- Event with 1 minute delay to send webhook message after server starts.
		else
