local items = { {
	...
	slot = "feet",
	level = 500,
	vocation = { { "Druid", true, true }, { "Elder Druid" } }
}, {
	-- sanguine galoshes
	itemid = 43887,
	type = "deequip",
	...
	slot = "feet",
	level = 500,
	vocation = { { "Sorcerer", true, true }, { "Master Sorcerer" } }
}, {
	-- sanguine boots
	itemid = 43884,
	type = "deequip",
	...
	slot = "legs",
	level = 500,
	vocation = { { "Paladin", true, true }, { "Royal Paladin" } }
}, {
	-- sanguine Greaves
	itemid = 43881,
	type = "deequip",
	...
	slot = "armor",
	level = 400,
	vocation = { { "Knight", true, true }, { "Elite Knight" } }
}, {
	-- spiritthorn armor
	itemid = 39147,
	type = "deequip",
	...
	type = "equip",
	slot = "right-hand",
	vocation = { { "None", true }, { "Paladin", true, true }, { "Royal Paladin" } }
}, {
	-- red quiver
	itemid = 35849,
	type = "deequip",
