...
local effects = { CONST_ME_TUTORIALARROW, CONST_ME_TUTORIALSQUARE }
...
function tutorialTile4.onStepIn(creature, item, position, fromPosition)
	...
	if player:getStorageValue(Storage.Dawnport.MessageStair) < 1 then
		player:sendTextMessage(MESSAGE_EVENT_ADVANCE, "To ATTACK, click on a target in the battle list next to the game window. \z
