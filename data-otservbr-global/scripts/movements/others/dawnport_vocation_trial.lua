local tutorialEffects = { CONST_ME_TUTORIALARROW, CONST_ME_TUTORIALSQUARE }
...
local vocationTrials = {
	...
	[25005] = {
		...
		items = { {
			...
			id = 7876,
			amount = 2,
			storage = Storage.Dawnport.SorcererHealthPotion,
			limit = 1
		}, { -- Health potion
			id = 268,
			amount = 10,
			storage = Storage.Dawnport.SorcererManaPotion,
			limit = 1
		}, { -- Mana potion
			id = 21352,
			amount = 2,
			storage = Storage.Dawnport.SorcererLightestMissile,
			limit = 1
		}, { -- Lightest missile runes
			id = 21351,
			amount = 2,
			storage = Storage.Dawnport.SorcererLightStoneShower,
			limit = 1
		}, { -- Light stone shower runes
			id = 3577,
			amount = 1,
			storage = Storage.Dawnport.SorcererMeat,
			limit = 1
		} } -- Meat
	},
	-- Druid trial
	[25006] = {
		...
		items = { {
			...
			id = 7876,
			amount = 2,
			storage = Storage.Dawnport.DruidHealthPotion,
			limit = 1
		}, { -- Health potion
			id = 268,
			amount = 10,
			storage = Storage.Dawnport.DruidManaPotion,
			limit = 1
		}, { -- Mana potion
			id = 21352,
			amount = 2,
			storage = Storage.Dawnport.DruidLightestMissile,
			limit = 1
		}, { -- Lightest missile runes
			id = 21351,
			amount = 2,
			storage = Storage.Dawnport.DruidLightStoneShower,
			limit = 1
		}, { -- Light stone shower runes
			id = 3577,
			amount = 1,
			storage = Storage.Dawnport.DruidMeat,
			limit = 1
		} } -- Meat
	},
	-- Paladin trial
	[25007] = {
		...
		items = { {
			...
			id = 7876,
			amount = 7,
			storage = Storage.Dawnport.PaladinHealthPotion,
			limit = 1
		}, { -- Health potion
			id = 268,
			amount = 5,
			storage = Storage.Dawnport.PaladinManaPotion,
			limit = 1
		}, { -- Mana potion
			id = 21352,
			amount = 1,
			storage = Storage.Dawnport.PaladinLightestMissile,
			limit = 1
		}, { -- Lightest missile rune
			id = 21351,
			amount = 1,
			storage = Storage.Dawnport.PaladinLightStoneShower,
			limit = 1
		}, { -- Light stone shower rune
			id = 3577,
			amount = 1,
			storage = Storage.Dawnport.PaladinMeat,
			limit = 1
		} } -- Meat
	},
	-- Knight trial
	[25008] = {
		...
		items = { {
			...
			id = 7876,
			amount = 10,
			storage = Storage.Dawnport.KnightHealthPotion,
			limit = 1
		}, { -- Health potion
			id = 268,
			amount = 2,
			storage = Storage.Dawnport.KnightManaPotion,
			limit = 1
		}, { -- Mana potion
			id = 3577,
			amount = 1,
			storage = Storage.Dawnport.KnightMeat,
			limit = 1
		} } -- Meat
	}
}
...
local function removeItems(player)
	local equipmentItemIds = { 21348, 21350, 21400, 3350, 3267, 3412, 35562 } -- The scorcher -- The chiller -- Spellbook of the novice -- Bow -- Dagger -- Wooden shield -- Quiver
