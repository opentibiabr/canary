local teleports = { {
	...
	destination = Position(32627, 31864, 11),
	storageValue = 1,
	needCrystal = true
}, {
	teleportPosition = {
	...
	destination = Position(33000, 31870, 13),
	storageValue = 1
}, {
	teleportPosition = {
		x = 33000,
	...
	destination = Position(32795, 31762, 10),
	storageValue = 1
}, {
	teleportPosition = {
		x = 32803,
	...
	destination = Position(32864, 31844, 11),
	storageValue = 1
}, {
	teleportPosition = {
		x = 32864,
	...
	destination = Position(32803, 31746, 10),
	storageValue = 1
}, {
	teleportPosition = {
		x = 32796,
	...
	destination = Position(32988, 31862, 9),
	storageValue = 120
}, { -- gnomebase alpha
	teleportPosition = {
		x = 32986,
	...
	destination = Position(32798, 31783, 10),
	storageValue = 120
}, { -- city
	teleportPosition = {
		x = 33001,
	...
	destination = Position(32959, 31953, 9),
	storageValue = 120
}, { -- golems
	teleportPosition = {
		x = 32959,
	...
	destination = Position(33001, 31915, 9),
	storageValue = 120
}, { -- back from golems
	teleportPosition = {
		x = 32980,
	...
	destination = Position(32904, 31894, 13),
	storageValue = 480
}, { -- vulcongras
	teleportPosition = {
		x = 32904,
	...
	destination = Position(32979, 31907, 9),
	storageValue = 480
}, { -- back from vulcongras
	teleportPosition = {
		x = 32805,
		y = 31743,
		z = 9
	},
	destination = Position(32329, 32172, 9),
	storageValue = 1,
	needCrystal = true
}, {
	teleportPosition = {
	...
	destination = Position(32195, 31182, 8),
	storageValue = 1,
	needCrystal = true
}, {
	teleportPosition = {
	...
	destination = Position(32402, 32816, 6),
	storageValue = 1,
	needCrystal = true
}, {
	teleportPosition = {
	...
	destination = Position(33153, 31833, 10),
	storageValue = 1,
	needCrystal = true
}, {
	teleportPosition = {
	...
	destination = Position(33186, 32385, 8),
	storageValue = 1,
	needCrystal = true
}, {
	teleportPosition = {
	...
	destination = Position(32771, 31800, 10),
	storageValue = 25,
	needCrystal = false
}, {
	teleportPosition = {
	...
	destination = Position(32790, 31795, 10),
	storageValue = 25,
	needCrystal = false
} }
