...
function riddleTeleport.onStepIn(creature, item, position, fromPosition)
	...
	if checkPillows(arenaPosition.x, arenaPosition.y, 2394) and checkPillows(arenaPosition.x + 3, arenaPosition.y, 2396) and checkPillows(arenaPosition.x, arenaPosition.y + 3, 2395) and (checkPillows(
		arenaPosition.x + 3,
		arenaPosition.y + 3,
		2397
	) or checkPillows(arenaPosition.x + 3, arenaPosition.y + 3, 900)) then
