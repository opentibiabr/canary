...
local config = { {
	...
	destination = Position(31943, 31045, 2)
}, {
	teleportPos = {
		x = 31943,
		y = 31046,
	...
	destination = Position(31943, 31044, 7)
}, {
	teleportPos = {
		x = 31938,
		y = 31041,
	...
	destination = Position(31938, 31041, 8),
	condition = TheHuntForTheSeaSerpent.QuestLine
}, {
	teleportPos = {
		x = 31939,
		y = 31050,
	...
	destination = Position(31912, 31187, 9),
	condition = TheHuntForTheSeaSerpent.QuestLine
} }
