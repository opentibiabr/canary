local config = {
	...
	[6] = {
		...
		position = { Position(32588, 32801, 4), Position(32580, 32743, 4), Position(32628, 32745, 4), Position(32629, 32745, 4), Position(32689, 32742, 4) }
	},
	[7] = {
...
for a = 1, #config do
	for b = 1, #config[a].position do
		mission2AllAroundTheWorld:position({
			x = config[a].position[b].x,
			y = config[a].position[b].y,
			z = config[a].position[b].z
		})
	end
end
