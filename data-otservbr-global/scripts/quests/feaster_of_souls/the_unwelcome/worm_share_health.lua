...
local wormShareHealth = CreatureEvent("wormShareHealth")

function wormShareHealth.onHealthChange(creature, attacker, primaryDamage, primaryType, secondaryDamage, secondaryType, origin)
	...
	local brother = Creature("Brother Worm")
	local unwelcome = Creature("The Unwelcome")
