local config = {
	...
	requiredLevel = 500,
	playerPositions = { {
		pos = Position(33548, 32752, 14),
		teleport = Position(33565, 32758, 15)
	}, {
		pos = Position(33549, 32752, 14),
		teleport = Position(33565, 32758, 15)
	}, {
		pos = Position(33550, 32752, 14),
		teleport = Position(33565, 32758, 15)
	}, {
		pos = Position(33551, 32752, 14),
		teleport = Position(33565, 32758, 15)
	}, {
		pos = Position(33552, 32752, 14),
		teleport = Position(33565, 32758, 15)
	} },
	specPos = {
