...
function spell.onCastSpell(creature, var)
	local hasCasted = Game.getStorageValue(Storage.Quest.U12_00.TheDreamCourts.DreamScar.lastBossCurse)
	...
	if hasCasted == 0 then
		...
		Game.setStorageValue(Storage.Quest.U12_00.TheDreamCourts.DreamScar.lastBossCurse, 1)
	end
end
