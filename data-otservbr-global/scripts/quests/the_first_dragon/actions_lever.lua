local config = {
	...
	monsters = {
		{ position = Position(33574, 31013, 14), monster = "fallen challenger" },
		{ position = Position(33592, 31013, 14), monster = "fallen challenger" },
		{ position = Position(33583, 31022, 14), monster = "fallen challenger" },
		{ position = Position(33574, 31031, 14), monster = "fallen challenger" },
		{ position = Position(33592, 31031, 14), monster = "fallen challenger" },
		{ position = Position(math.random(33610, 33622), math.random(31016, 31030), 14), monster = "unbeatable dragon" },
		{ position = Position(math.random(33610, 33622), math.random(31016, 31030), 14), monster = "unbeatable dragon" },
		{ position = Position(math.random(33610, 33622), math.random(31016, 31030), 14), monster = "unbeatable dragon" },
		{ position = Position(math.random(33610, 33622), math.random(31016, 31030), 14), monster = "unbeatable dragon" },
		{ position = Position(math.random(33610, 33622), math.random(31016, 31030), 14), monster = "unbeatable dragon" },
