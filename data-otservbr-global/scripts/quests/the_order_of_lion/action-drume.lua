local config = {
	lionPosition = { Position(32444, 32512, 7), Position(32449, 32516, 7), Position(32444, 32520, 7) },
	usurperPosition = { Position(32450, 32520, 7), Position(32444, 32516, 7), Position(32448, 32512, 7) },
