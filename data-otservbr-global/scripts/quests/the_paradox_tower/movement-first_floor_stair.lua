...
function firstFloorStair.onStepIn(creature, item, position, fromPosition)
	...
	if item.uid == 25013 then
		...
		if Position(positions[1]):hasItem(jungleGrassId) and Position(positions[2]):hasItem(jungleGrassId) and Position(positions[3]):hasItem(jungleGrassId) and Position(positions[4]):hasItem(jungleGrassId) and Position(positions[5]):hasItem(
			jungleGrassId
