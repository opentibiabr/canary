...
local config = {
	...
	[25730] = {
		targetPos = { Position(33386, 32215, 7), Position(33511, 32320, 6), Position(33518, 32193, 7), Position(33549, 32219, 7), Position(33597, 32182, 7) },
		usablePeriod = "night",
		...
		storagePos = { ThreatenedDreams.Mission02.MoonMirrorPos01, ThreatenedDreams.Mission02.MoonMirrorPos02, ThreatenedDreams.Mission02.MoonMirrorPos03, ThreatenedDreams.Mission02.MoonMirrorPos04, ThreatenedDreams.Mission02.MoonMirrorPos05 }
	}
}
