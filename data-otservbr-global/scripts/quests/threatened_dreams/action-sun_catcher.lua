...
local config = {
	...
	[25734] = {
		targetPos = { Position(33419, 32242, 7), Position(33484, 32192, 7), Position(33546, 32155, 7), Position(33547, 32206, 7), Position(33568, 32243, 7) },
		usablePeriod = "day",
		...
		storagePos = { ThreatenedDreams.Mission02.SunCatcherPos01, ThreatenedDreams.Mission02.SunCatcherPos02, ThreatenedDreams.Mission02.SunCatcherPos03, ThreatenedDreams.Mission02.SunCatcherPos04, ThreatenedDreams.Mission02.SunCatcherPos05 }
	}
}
