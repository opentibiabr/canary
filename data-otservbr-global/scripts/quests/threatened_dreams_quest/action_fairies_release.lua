local config = {
	[40016] = {
		...
		storage = Storage.Quest.U11_40.ThreatenedDreams.Mission02.Fairy01,
	...
	[40017] = {
		...
		storage = Storage.Quest.U11_40.ThreatenedDreams.Mission02.Fairy02,
		message = "My tainted siblings locked me up in the dark far too long. Now I'm finally free! Thank you, mortal being!",
	},
	[40018] = {
		pos = Position(33559, 32203, 9),
		storage = Storage.Quest.U11_40.ThreatenedDreams.Mission02.Fairy03,
		message = "My tainted siblings locked me up in the dark far too long. Now I'm finally free! Thank you, mortal being!",
	},
	[40019] = {
		pos = Position(33505, 32286, 8),
		storage = Storage.Quest.U11_40.ThreatenedDreams.Mission02.Fairy04,
		message = "My tainted siblings locked me up in the dark far too long. Now I'm finally free! Thank you, mortal being!",
	},
	[40020] = {
		pos = Position(33440, 32217, 8),
		storage = Storage.Quest.U11_40.ThreatenedDreams.Mission02.Fairy05,
		message = "My tainted siblings locked me up in the dark far too long. Now I'm finally free! Thank you, mortal being!",
	},
}
...
function fairiesRelease.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	local fairiesCounter = player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.FairiesCounter)
	if player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.NightmareIntruders) == 3 and fairiesCounter < 5 then
		if player:getStorageValue(fairy.storage) < 1 then
			...
			if fairiesCounter == -1 then
				player:setStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.FairiesCounter, 1)
			else
				player:setStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission02.FairiesCounter, fairiesCounter + 1)
			end
			return true
		else
			toPosition:sendMagicEffect(CONST_ME_PURPLESMOKE)
