...
function poacherBook.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	if player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission01.TroubledAnimals) == 2 then
		if target.itemid == 12648 or target.itemid == 12649 then
			...
			player:setStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission01.TroubledAnimals, 3)
			return true
		end
	else
