local config = {
	...
	[25028] = {
		...
		storage = Storage.Quest.U11_40.ThreatenedDreams.Mission01.Feathers5,
	},
}
...
function swanFeathers.onStepIn(creature, item, position, fromPosition)
	...
	if player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission01.TroubledAnimals) ~= 13 then
		return true
	end
	if player:getStorageValue(feathersFound.storage) == 1 then
		return true
	end
	if player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission01.FeathersCount) < 5 then
		player:setStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission01.FeathersCount, player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission01.FeathersCount) + 1)
		...
		if player:getStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission01.FeathersCount) == 5 then
			player:setStorageValue(Storage.Quest.U11_40.ThreatenedDreams.Mission01.TroubledAnimals, 14)
		end
		return true
	end
end
