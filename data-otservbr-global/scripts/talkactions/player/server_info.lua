...
function serverInfo.onSay(player, words, param)
	...
	.. "\nClub Skill rate: x" .. getRateFromTable(skills, player:getSkillLevel(SKILL_CLUB), configRateSkill)
	.. "\nAxe Skill rate: x" .. getRateFromTable(skills, player:getSkillLevel(SKILL_AXE), configRateSkill)
	.. "\nDistance Skill rate: x" .. getRateFromTable(skills, player:getSkillLevel(SKILL_DISTANCE), configRateSkill)
	.. "\nShield Skill rate: x" .. getRateFromTable(skills, player:getSkillLevel(SKILL_SHIELD), configRateSkill)
	.. "\nFist Skill rate: x" .. getRateFromTable(skills, player:getSkillLevel(SKILL_FIST), configRateSkill)
	.. "\nMagic rate: x" .. getRateFromTable(magicLevel, player:getBaseMagicLevel(), configManager.getNumber(configKeys.RATE_MAGIC))
