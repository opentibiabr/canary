local loyaltySystem = {
	...
	titles = {
		...
		[2] = {
			name = "Sentinel of Tibia",
			points = 100
		},
		[3] = {
			name = "Steward of Tibia",
			points = 200
		},
		[4] = {
			name = "Warden of Tibia",
			points = 400
		},
		[5] = {
			name = "Squire of Tibia",
			points = 1000
		},
		[6] = {
			name = "	Warrior of Tibia",
			points = 2000
		},
		[7] = {
			name = "Keeper of Tibia",
			points = 3000
		},
		[8] = {
			name = "Guardian of Tibia",
			points = 4000
		},
		[9] = {
			name = "Sage of Tibia",
		...
		[10] = {
			name = "Savant of Tibia",
			points = 6000
		},
		[11] = {
			name = "Enlightened of Tibia",
			points = 7000
		}
	},
	bonus = { {
...
function Player.initializeLoyaltySystem(self)
	...
	if self:getLoyaltyBonus() ~= 0 then
		self:sendTextMessage(
			MESSAGE_STATUS,
			string.formatNamed(loyaltySystem.messageTemplate, {
				bonusPercentage = playerBonusPercentage,
				loyaltyPoints = playerLoyaltyPoints
			})
		)
	end
