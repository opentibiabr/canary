		...
		offers = {
			{
				...
				itemtype = 49301,
				count = 1,
				description = "Navega Sword Atk:16 physical + 53 fire, Def:38 +5, sword fighting +5 ITEM VIP",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Baby_Vulcongra.png" },
				...
				itemtype = 49302,
				count = 1,
				description = "Navega Bow Range: 6, Atk +14, Hit% +12, distance fighting +6, critical hit chance 29%, critical extra damage +26%, protection earth +8% ITEM VIP",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Carved_Table.png" },
				...
				itemtype = 49304,
				count = 1,
				description = "Navega Wand critical hit chance 29%, critical extra damage +26%, magic level +5, energy magic level +1, fire magic level +1, protection earth +7% ITEM VIP",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Carved_Table.png" },
				...
				itemtype = 49300,
				count = 1,
				description = "Navega Crossbow Range: 6, Atk +16, Hit% +20, distance fighting +6, critical hit chance 35%, critical extra damage +29%, protection fire +8% ITEM VIP",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Carved_Table.png" },
				...
				itemtype = 49307,
				count = 1,
				description = "Navega Hatchet Atk:10 physical + 48 fire, Def:37 +5, axe fighting +7 It can only be wielded properly by knights of level 600 or higher ITEM VIP",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Carved_Table.png" },
				...
				itemtype = 49305,
				count = 1,
				description = "Navega Rod critical hit chance 31%, critical extra damage +28%, magic level +7, earth magic level +1, ice magic level +4, protection death +8% ITEM VIP",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Carved_Table.png" },
				...
				itemtype = 49283,
				count = 1,
				description = "Navega Shield Def:56, protection physical +16%, death +18% ITEM VIP",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
		
			{
				...
				itemtype = 49289,
				count = 1,
				description = "Navega Mage Book Def:32, magic level +8, healing magic level +3, ice magic level +3, protection physical +10%, energy +12% ITEM VIP",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Carved_Table.png" },
				...
				itemtype = 49306,
				count = 1,
				description = "Navega Sword Duo Atk:15 physical + 70 energy, Def:40, sword fighting +9, critical hit chance 20%, critical extra damage +22% ITEM VIP",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Carved_Table.png" },
				...
				itemtype = 49303,
				count = 1,
				description = "Navega Battleaxe Atk:10 physical + 60 death, Def:45, axe fighting +8, critical hit chance 21%, critical extra damage +19% ITEM VIP",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
		},
	},
	-- Item VIP ~ armors
	{
		...
		offers = {
			
			{
				...
				itemtype = 49279,
				count = 1,
				description = "Arm:19, distance fighting +6, protection physical +8%, energy +8%, earth +8%, fire +8%, ice +8%, holy +8%, death +8%",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Carved_Table_Centre.png" },
				name = "Navega Paladin Legs",
				price = 2000,
				itemtype = 49280,
				count = 1,
				description = "Arm:16, distance fighting +7, holy magic level +3, protection physical +9%, energy +11% Augments: Avatar of Light  -900s cooldown, Divine Caldera +10% critical extra damage",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Carved_Table_Centre.png" },
				name = "Navega Paladin Armor",
				price = 2000,
				itemtype = 49281,
				count = 1,
				description = "ROYAL PALADIN",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Carved_Table_Centre.png" },
				name = "Navega Paladin Boots",
				price = 2000,
				itemtype = 49282,
				count = 1,
				description = "ROYAL PALADIN",
			...
			{
				icons = { "Carved_Table_Centre.png" },
				name = "Navega Mage Hat",
				price = 2000,
				itemtype = 49290,
				count = 1,
				description = "Elder Druid e Master Soccer",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
				icons = { "Carved_Table_Centre.png" },
