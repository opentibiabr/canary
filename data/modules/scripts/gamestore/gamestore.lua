...
GameStore.Categories = {
	...
	-- House
	{
		...
		name = "Houses",
		rookgaard = true,
		subclasses = { "Decorations", "Furniture", "Upgrades", "Hirelings", "Hirelings Dresses", "Tournament"},
	},
	-- House ~ Decorations
	{
	...
	-- Extras
	{
		...
		name = "Extras",
		rookgaard = true,
		subclasses = { "Extra Services", "Useful Things", "Useful Itens" },
	},
	...
	-- Extras ~ Usefull Things
	{
		...
		offers = {
			...
			},
			{
				...
				name = "Charm Points",
				price = 500,
				description = "<i>It adds 500 charm points</i>\n\n{character}\n{once}",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARMS_POINTS,
			},
			{
