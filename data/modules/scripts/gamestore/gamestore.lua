...
HomeBanners = {
	images = { "home/Rotten_Blood_Bundle_Artwork.jpg", "home/atenas_bg.png" },
	delay = 0
}
		...
		offers = {
			{
				...
				name = "7 Days of Vip Account",
				price = 160,
				validUntil = 7,
				description = "<i>Enhance your gaming experience by gaining additional abilities and advantages:</i> \n\n {info} Acesso VIP area\n{info} 10% XP extra\n{info} 10% Loot extra\n{info} 10% Skill Extra (Treino) \n{info} Regen de stamina em PZ (5 minutos a cada 2 minutos em pz zone)",
			...
			offers = {
				{
					...
					itemtype = 44065,
					charges = 14400,
					description = "{info} Varinha de treino com 14400 cargas",
			...
			offers = {
				{
					...
					count = 1,
					itemtype = 19365,
					description = "Atenas Slime. \n\n{info} +10% critical damage \n{info} +2% critical chance",
				  ...
				  },
				  {
					...
					count = 1,
					itemtype = 35604,
					description = "Ice Necklace. \n\n{info} Protege 30% de gelo ",
					type = GameStore.OfferTypes.OFFER_TYPE_ITEM,			
					coinType = GameStore.CointType.Transferable,
				  },
				  {
					...
					count = 1,
					itemtype = 35605,
					description = "Earth Necklace. \n\n{info} Protege 30% de terra ",
					type = GameStore.OfferTypes.OFFER_TYPE_ITEM,			
					coinType = GameStore.CointType.Transferable,
				  },
				  {
					...
					count = 1,
					itemtype = 35606,
					description = "Fire Necklace. \n\n{info} Protege 30% de fogo ",
					type = GameStore.OfferTypes.OFFER_TYPE_ITEM,			
					coinType = GameStore.CointType.Transferable,
				  },
				  {
					name = "Energy Necklace",
					price = 150,
					count = 1,
					itemtype = 35609,
					description = "Energy Necklace. \n\n{info} Protege 30% de energy ",
					type = GameStore.OfferTypes.OFFER_TYPE_ITEM,			
					coinType = GameStore.CointType.Transferable,
				  },
				  {
					name = "Exercise Potion",
					price = 250,
					count = 1,
					itemtype = 30202,
					description = "Exercise Potion \n\n{info} Pega a próxima varinha de treino automaticamente",
					type = GameStore.OfferTypes.OFFER_TYPE_ITEM,			
					coinType = GameStore.CointType.Transferable,
				  },
				  {
					...
					count = 1,
					itemtype = 23681,
					description = "Summon Upgrade \n\n{info} Libera segundo outfit do summon e deixa ele mais forte.",
					type = GameStore.OfferTypes.OFFER_TYPE_ITEM,			
					coinType = GameStore.CointType.Transferable,
				  },
				   {
					...
					count = 1,
					itemtype = 18935,
					description = "Npc Ring \n\n{info} Refile durante a sua hunt \n{info} Sumona um Refiller particular ao seu lado sempre que desejar",
					type = GameStore.OfferTypes.OFFER_TYPE_ITEM,			
					coinType = GameStore.CointType.Transferable,
				  },
				  {
					...
					count = 1,
					itemtype = 19369,
					description = "Teleport de bolso \n\n{info} Teleporta o player para qualquer cidade com apenas 3 clicks",
					type = GameStore.OfferTypes.OFFER_TYPE_ITEM,			
					coinType = GameStore.CointType.Transferable,
					home = true, 
				  },
				  {
					...
					count = 1,
					itemtype = 23721,
					description = "Loot Pouch \n\n{info} Carrega itens e gold infinitamente. \n{info} Presa ao personagem que comprou!\n",
					type = GameStore.OfferTypes.OFFER_TYPE_ITEM,			
					coinType = GameStore.CointType.Transferable,
					home = true, 
				  },
					{
						name = "Atenas Backpack",
						price = 400,
						count = 1,
						itemtype = 49605,
						description = "Atenas Backpack \n\n{info} Regen extra de 60 de vida e 60 de mana a cada 10 segundos \n{info} Pode ser imbuída",
						type = GameStore.OfferTypes.OFFER_TYPE_ITEM,			
						coinType = GameStore.CointType.Transferable,
						home = true, 
					  },
						...
						count = 1,
						itemtype = 49685,
						description = "Coin Roleta \n\n{info} 1x Coin para jogar na roleta do templo de Thais",
						type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,	
						coinType = GameStore.CointType.Transferable,		
					  },
		 ...
		 offers = {
		   {
			 ...
			 itemtype = 9086,
			 charges = 1,
			 description = "Enche toda sua mana. Item agrupável",
			 type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			 coinType = GameStore.CointType.Transferable,
		   },  
		  ...
		  
		  {
			...
			itemtype = 9079,
			charges = 1,
			description = "Enche toda sua vida. Item agrupável.",
			type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			coinType = GameStore.CointType.Transferable,
		  },  
		  ...
		  
		  {
			...
			itemtype = 9080,
			charges = 1,
			description = "Ira curar voce de todas as condicoes negativas e nocivas. Item agrupável.",
			type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			coinType = GameStore.CointType.Transferable,
		  },  
 ...
 -- Cosmetics
  {
	...
	name = "Cosmetics",
	rookgaard = true,
	subclasses = {"Pacotes", "Outfits", "Mounts"},
  },
  
  {
	...
	{
		   icons = { "Rotten_Blood_Bundle.gif" },
		   name = "Pacote Rottem Full",
		   price = 600,
		   count = 1,
		   id = 44035,
		   description = "<i>Rottem Bundle:</i>\n{info} 1x Outfit e Addon Full\n{info} 1x Mount\n{info} 1x Mask of the defiler",
		   type = GameStore.OfferTypes.OFFER_TYPE_BUNDLE,
		   coinType = GameStore.CointType.Coin,
		   home = true,
		 },
    },
	rookgaard = true,
  ...
  
  {
	...
	{
		   icons = { "Royal_Costume.png", "Royal_Costume.png" },
		   name = "Royal Costume",
		   price = 1650,
		...
		{
			icons = { "Outfit_Armoured_Archer_Female_Addon_3.png", "Outfit_Armoured_Archer_Male_Addon_3.png" },
        ...
        {
          icons = { "Outfit_Fencer_Female_Addon_3.png", "Outfit_Fencer_Male_Addon_3.png" },
          name = "Fencer Outfit",
          price = 325,
   ...
   },
   {
	...
	offers = {
	{
			...
			price = 400,
			id = 183,
			description = "{character}\n{speedboost}\n\n<i>Shellodon in a deep rivalry with its cousin the Blood Devourer. Even though they were born in completely different areas, they somehow share the same bloodline. The eternal battle between fire and ice continues. Who will win? Tangerine vs.crystal blue! The choice is yours!</i>",
		...
		},
		{
			...
			price = 400,
			id = 213,
			description = "{character}\n{speedboost}\n\n<i>Darkfire Devourer in a deep rivalry with its cousin the Blood Devourer. Even though they were born in completely different areas, they somehow share the same bloodline. The eternal battle between fire and ice continues. Who will win? Tangerine vs.crystal blue! The choice is yours!</i>",
			type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
		},
		{
 ...
 --Furniture
  ...
  { 
	...
	offers = {   
		 ...
		 {
		   icons = { "Demonic_Reward_Shrine.png" },
		   name = "Demonic Reward Shrine",
		   price = 185,
		   itemtype = 49689,
		   count = 1,
		   description = "<i>Pick up your daily reward comfortably in your own four walls!</i>\n\n{house}\n{box}\n{storeinbox}\n{usablebyall}\n{useicon} use it to open the reward wall\n{backtoinbox}",
		 ...
		 {
		   icons = { "Beast_Exercise_Dummy.png" },
		   name = "Beast Exercise Dummy",
		   price = 580,
		   itemtype = 49698,
		   count = 1,
		 ...
		 {
		   icons = { "Factory_Imbuing_Shrine.png" },
		   name = "Factory Imbuing Shrine",
		   price = 245,
		   itemtype = 49691,
		   count = 1,
		   description = "<i>Enhance your equipment comfortably in your own four walls!</i>\n\n{house}\n{box}\n{storeinbox}\n{usablebyall}\n{useicon} use it with an imbuable item to open the imbuing dialog\n{backtoinbox}",
   ...
   
   {
	   ...
	   offers = {
		  ...
		  }, 
		{
			...
			count = 1,
			itemtype = 36725,
			description = "Recupera a sua stamina 100%",
			type = GameStore.OfferTypes.OFFER_TYPE_ITEM,			
			coinType = GameStore.CointType.Coin,
		  }, 
		{
		  ...
		  }, 
		{
		  ...
		  }, 
		 {
		   ...
		   count = 1,
		   itemtype = 36728,
		   description = "You see a bestiary betterment.\n\n{info}It weighs 2.10 oz.\n{info}Drinking this potion temporarily makes kills count one for the Bestiary.",
		   type = GameStore.OfferTypes.OFFER_TYPE_ITEM,			
		   coinType = GameStore.CointType.Tournament,
		 }, 
		 {
		   ...
		   count = 1,
		   itemtype = 36726,
		   description = "You see a charm upgrade.\n\n{info}It weighs 2.10 oz.\n{info}Drinking this potion temporarily increases offensive charm trigger chances except Cripple.",
		   type = GameStore.OfferTypes.OFFER_TYPE_ITEM,			
		   coinType = GameStore.CointType.Tournament,
		 }, 
		 {
		   ...
		   count = 1,
		   itemtype = 36741,
		   description = "You see a death amplification.\n\n{info}It weighs 2.10 oz.\n{info}Drinking this potion temporarily amplifies death damage against monsters.",
		   type = GameStore.OfferTypes.OFFER_TYPE_ITEM,			
		   coinType = GameStore.CointType.Tournament,
		 }, 
		 {
		   ...
		   count = 1,
		   itemtype = 36734,
		   description = "You see a death resilience.\n\n{info}It weighs 2.10 oz.\n{info}Drinking this potion temporarily increases death protection.",
		   type = GameStore.OfferTypes.OFFER_TYPE_ITEM,			
		   coinType = GameStore.CointType.Tournament,
		 }, 
		 {
		   ...
		   count = 1,
		   itemtype = 36738,
		   description = "You see a earth amplification.\n\n{info}It weighs 2.10 oz.\n{info}Drinking this potion temporarily amplifies earth damage against monsters.",
		   type = GameStore.OfferTypes.OFFER_TYPE_ITEM,			
		   coinType = GameStore.CointType.Tournament,
		 }, 
		 {
		   ...
		   count = 1,
		   itemtype = 36731,
		   description = "You see a earth resilience.\n\n{info}It weighs 2.10 oz.\n{info}Drinking this potion temporarily increases earth protection.",
		   type = GameStore.OfferTypes.OFFER_TYPE_ITEM,			
		   coinType = GameStore.CointType.Tournament,
		 }, 
	 },
