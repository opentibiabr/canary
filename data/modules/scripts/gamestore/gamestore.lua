...
HomeBanners = {
	images = { "home/banner_retrooutfits.png", "home/banner_exercisedummies.png" },
	--images = { "home/banner_thorfinn.png", "home/banner_retrooutfits.png", "home/banner_thorfinn2.png", "home/banner_exercisedummies.png" },
	delay = 10,
}
...
GameStore.Categories = {
	...
	-- Consumables
	{
		...
		name = "Consumables",
		rookgaard = true,
		subclasses = { "Blessings", "Casks", "Exercise Weapons", "Kegs", "Potions", "Runes", "Foods" },
	},
	...
	-- Consumables ~ Exercise Weapons
	{
		...
		offers = {
			...
			},
			{
				...
				itemtype = 35286,
				charges = 14400,
				description = "<i>Use it to train your axe fighting skill on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} use it on an exercise dummy to train your axe fighting skill\n{info} usable 40000 times a piece",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},
			{
	...
	-- Consumables ~ Foods
	{
		...
		offers = {
			{
				icons = { "Taberna_Pizza.png" },
				name = "Taberna Pizza",
				price = 15,
				itemtype = 64071,
				count = 1,
				description = "<b>Treat it nicely with its favourite and infinite food.</b>\n\n{character}\n{storeinbox}\n{use}\n{backtoinbox}",
	...
	-- Cosmetics ~ Mounts
	{
		...
		offers = {
			...
			},
			{
				...
				price = 1300,
				id = 216,
				description = "{character}\n{speedboost}\n\n<i>Darkfire Devourer (speed +10).</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
			...
			},
			{
				...
				price = 1000,
				id = 224,
				description = "{character}\n{speedboost}\n\n<i>Dawnbringer Pegasus (speed +10).</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
				state = GameStore.States.STATE_NEW,
				home = true,
			},
			{
				...
				price = 1000,
				id = 225,
				description = "{character}\n{speedboost}\n\n<i>Wrathfire Pegasus (speed +10).</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
				state = GameStore.States.STATE_NEW,
				home = true,
			},
			{
				...
				price = 1000,
				id = 226,
				description = "{character}\n{speedboost}\n\n<i>Skybreaker Pegasus (speed +10).</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
				state = GameStore.States.STATE_NEW,
				home = true,
			},
			{
				icons = { "Glacier_wyrn.png" },
				name = "Glacier wyrn",
				price = 1000,
				id = 227,
				description = "{character}\n{speedboost}\n\n<i>Glacier wyrn (speed +10).</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
				state = GameStore.States.STATE_NEW,
				home = true,
			},
...
--[[ 			{
				icons = { "Revodraptor.png" },
				name = "Revodraptor",
				price = 800,
				id = 271,
				description = "{character}\n{speedboost}\n\n<i>Revodraptor (speed +15).</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
				state = GameStore.States.STATE_NEW,
				home = true,
			}, ]]
			...
			},
			{
				...
				price = 750,
				id = 218,
				description = "{character}\n{speedboost}\n\n<i>Foxmice can only be tamed by players who are not cursed by the were sickness. Make sure to use Purple Nightshade Blossoms in case you are sick.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
	...
	-- Cosmetics ~ Outfits (base outfit has addon = 0 or no defined addon. By default addon is set to 0)
	{
		...
		offers = {
			...
			{
				icons = { "Outfit_Skull_Taberna_Male_Addon_3.png", "Outfit_Skull_Taberna_Female_Addon_3.png" },
				name = "Full Skull Taberna Outfit",
				price = 800,
				sexId = { female = 3003, male = 3002 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Full Skull Taberna Outfit.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
			...
			-- news
			{
				icons = { "Flamefury_Mage_Male.png", "Flamefury_Mage_Female.png" },
				name = "Flamefury Mage",
				price = 870,
				sexId = { female = 1681, male = 1680 },
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n\n<i>Flamefury Mage.</i>",
			...
			{
				icons = { "Doom_Knight_Male.png", "Doom_Knight_Female.png" },
				name = "Doom Knight",
				price = 870,
			...
			{
				icons = { "Draccoon_Herald_Male.png", "Draccoon_Herald_Female.png" },
			...
			{
				icons = { "Celestial_Avenger_Male.png", "Celestial_Avenger_Female.png" },
				name = "Celestial Avenger",
				price = 870,
				sexId = { female = 1726, male = 1725 },
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n\n<i>Celestial Avenger.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Blade_Dancer_Male.png", "Blade_Dancer_Female.png" },
				name = "Blade Dancer",
				price = 870,
	...
	-- House ~ Upgrades
	{
		...
		offers = {
			...
			{
				icons = { "64031.png" },
				name = "Fire Scarecrow Exercise Dummy",
				price = 1500,
				itemtype = 64031,
				count = 1,
				description = "<i>Train your skills more effectively at home than in public on this expert exercise dummy!</i>\n\n{house}\n{box}\n{storeinbox}\n{usablebyall}\n{info} can only be used by one character at a time\n{useicon} use one of the exercise weapons on this dummy\n{backtoinbox}",
			...
			{
				icons = { "Sanguinary_Exercise_Dummy.png" },
				name = "Sanguinary Exercise Dummy",
				price = 1500,
				itemtype = 64018,
				count = 1,
				description = "<i>Train your skills more effectively at home than in public on this expert exercise dummy!</i>\n\n{house}\n{box}\n{storeinbox}\n{usablebyall}\n{info} can only be used by one character at a time\n{useicon} use one of the exercise weapons on this dummy\n{backtoinbox}",
			...
			{
				icons = { "64021.png" },
				name = "Drako Daily Reward Shrine",
				price = 750,
				itemtype = 64021,
				count = 1,
				description = "<i>Pick up your daily reward comfortably in your own four walls!</i>\n\n{house}\n{box}\n{storeinbox}\n{usablebyall}\n{useicon} use it to open the reward wall\n{backtoinbox}",
	...
	-- Extras
	{
		...
		name = "Extras",
		rookgaard = true,
		subclasses = { "Extra Services", "Usefull Equips", "Useful Amulets", "Useful Rings", "Useful Things" }, --removed: Surprise Items
	},
	...
	-- Extras ~ Usefull Equips
--[[ 	{
		icons = { "Category_UsefulEquips.png" },
		name = "Useful Equips",
		parent = "Extras",
		rookgaard = true,
		state = GameStore.States.STATE_NONE,
		offers = {
			{
				icons = { "Majinboo_Backpack.png" },
				name = "Majinboo Backpack",
				price = 800,
				itemtype = 64039,
				count = 1,
				description = "<b>Backpack with Terrifying magic attributes.</b>\n\n{capacity}\n{speedboost}\nWhen you use this backpack, you will:\n{info} increase your speed\n{info} reduce damage of fire and holy",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				home = true,
				movable = true,
			...
			{
				icons = { "Taberna_Backpack.png" },
				name = "Taberna Backpack",
				price = 800,
				itemtype = 64004,
				count = 1,
				description = "<b>Backpack with Taberna magic attributes.</b>\n\n{capacity}\n{speedboost}\nWhen you use this backpack, you will:\n{info} increase your speed\n{info} reduce damage of ice and poison",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				home = true,
				movable = true,
			...
			{
				icons = { "Halloween_Backpack.png" },
				name = "Halloween Backpack",
				price = 800,
				itemtype = 64022,
				count = 1,
				description = "<b>Backpack with Halloween magic attributes.</b>\n\n{capacity}\n{speedboost}\nWhen you use this backpack, you will:\n{info} increase your speed\n{info} reduce damage of fire and death",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				home = true,
				movable = true,
			},
			{
				...
				itemtype = 64052,
				count = 1,
				description = "<b>Backpack with Pikachu magic attributes.</b>\n\n{capacity}\n{speedboost}\nWhen you use this backpack, you will:\n{info} increase your speed\n{info} reduce damage of energy and holy",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				home = true,
				movable = true,
			...
			{
				icons = { "Sanguinary_Backpack.png" },
				name = "Sanguinary Backpack",
				price = 800,
				itemtype = 64003,
				count = 1,
				description = "<b>Backpack with Sanguinary magic attributes.</b>\n\n{capacity}\n{speedboost}\nWhen you use this backpack, you will:\n{info} increase your speed\n{info} reduce damage of physical, poison and death",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				home = true,
				movable = true,
			...
			{
				icons = { "Phoenix_Statue.png" },
				name = "Taberna Phoenix",
				price = 800,
				itemtype = 4115,
				count = 1,
				description = "<b>Have the power of the phoenix (used in ammo slot). This item is exclusive for paladins!</b>\n\n{speedboost}\nWhen you use this item, you will:\n{info} increase your distance in +2\n{info} increase your magic level in +1\n{info} increase perfect shot +25\n{info} increase your speed +10\n{info} increase your critical hit chance +10\n{info} increase your critical hit damage +30",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				home = true,
				movable = true,
			},
			{
				...
				name = "Taberna Skull Celestial",
				price = 800,
				itemtype = 37749,
				count = 1,
				description = "<b>Have the revenge of the skulls (used in ammo slot). This item is exclusive for sorceres!</b>\n\n{speedboost}\nWhen you use this item, you will:\n{info} increase your speed in +10\n{info} increase your magic level in +2\n{info} increase your critical hit chance +10\n{info} increase your critical hit damage +30",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				home = true,
				movable = true,
			...
			{
				icons = { "Mathmaster_Shield.png" },
				name = "Taberna Shield",
				price = 800,
				itemtype = 14760,
				count = 1,
				description = "<b>This is a shield with the power of Taberna (used in ammo slot). This item is exclusive for knights!</b>\n\n{speedboost}\nWhen you use this item, you will:\n{info} increase your speed in +10\n{info} increase your shielding in +3\n{info} increase your skills in +2\n{info} increase your magic level in +1\n{info} increase your critical hit chance +10\n{info} increase your critical hit damage +30",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				home = true,
				movable = true,
			...
			{
				icons = { "Taberna_Magician.png" },
				name = "Taberna Magician",
				price = 800,
				itemtype = 64060,
				count = 1,
				description = "<b>Have the power of druid magician (used in ammo slot). This item is exclusive for druids!</b>\n\n{speedboost}\nWhen you use this item, you will:\n{info} increase your speed in +10\n{info} increase your magic level in +2\n{info} increase your critical hit chance +10\n{info} increase your critical hit damage +30",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				home = true,
				movable = true,
			},
			{
				...
				itemtype = 64065,
				count = 1,
				description = "<b>This quiver gives you 14 slots and more attributes and be used for paladins 600+.</b>\n\n{character}\n{storeinbox}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				home = true,
				movable = true,
			...
			{
				icons = { "Mega_Taberna_Boots.png" },
				name = "Mega Taberna Boots",
				price = 800,
				itemtype = 64054,
				count = 1,
				description = "<b>If you wear it, it will regeneration of your life in 50, mana in 80 and speed +30.</b>\n\n{character}\n{storeinbox}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				home = true,
				movable = true,
	...
	-- Extras ~ Usefull Amulets
	{
		icons = { "Category_UsefulAmulets.png" },
		name = "Useful Amulets",
		parent = "Extras",
		rookgaard = true,
		state = GameStore.States.STATE_NONE,
		offers = {
			{
				icons = { "64037.png" },
				name = "Black Taberna Amulet",
				price = 750,
				itemtype = 64037,
				description = "<b>Have the protections of Taberna. This item is exclusive for Knights!</b>\n\nWhen you use this item, you will:\n{info} increase your speed +10\n{info} increase your club, sword and axe fighting to +3\n{info} increase mana leech chance +4%\n{info} increase mana leech amount +4%\n{info} increase magic level +1\n{info} increase healing magic level +2\n{info} increase your protection to holy and death in +4%",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				home = true,
				movable = true,
			...
			{
				icons = { "64032.png" },
				name = "Blue Taberna Amulet",
				price = 750,
				itemtype = 64032,
				description = "<b>Have the protections of Taberna. This item is exclusive for Druids!</b>\n\nWhen you use this item, you will:\n{info} increase your speed +10\n{info} increase mana leech chance +4%\n{info} increase mana leech amount +4%\n{info} increase magic level +3\n{info} increase healing magic level +3\n{info} increase your protection to fire and ice in +4%",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				home = true,
				movable = true,
			...
			{
				icons = { "64034.png" },
				name = "Purple Taberna Amulet",
				price = 750,
				itemtype = 64034,
				description = "<b>Have the protections of Taberna. This item is exclusive for Sorcerers!</b>\n\nWhen you use this item, you will:\n{info} increase your speed +10\n{info} increase mana leech chance +4%\n{info} increase mana leech amount +4%\n{info} increase magic level +3\n{info} increase healing magic level +3\n{info} increase your protection to holy and death in +4%",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				home = true,
				movable = true,
			...
			{
				icons = { "64036.png" },
				name = "Red Taberna Amulet",
				price = 750,
				itemtype = 64036,
				description = "<b>Have the protections of Taberna. This item is exclusive for Paladins!</b>\n\nWhen you use this item, you will:\n{info} increase your speed +10\n{info} increase your distance fighting +5\n{info} increase mana leech chance +4%\n{info} increase mana leech amount +4%\n{info} increase magic level +2\n{info} increase healing magic level +2\n{info} increase your protection to fire and death in +4%",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				home = true,
				movable = true,
	...
	-- Extras ~ Usefull Rings
	{
		icons = { "Category_UsefulRings.png" },
		name = "Useful Rings",
		parent = "Extras",
		rookgaard = true,
		state = GameStore.States.STATE_NONE,
	...
	-- Extras ~ Usefull Things
	{
		...
		offers = {
			...
			},
			{
				...
				name = "Prey Wildcard",
				price = 75,
				id = GameStore.SubActions.PREY_WILDCARD2,
				count = 32,
				description = "<i>Use Prey Wildcards to reroll the bonus of an active prey, to lock your active prey or to select a prey of your choice.</i>\n\n{character}\n{info} added directly to Prey dialog\n{info} maximum amount that can be owned by character: " .. GameStore.ItemLimit.PREY_WILDCARD,
				type = GameStore.OfferTypes.OFFER_TYPE_PREYBONUS,
				state = GameStore.States.STATE_NEW,
			...
			--[[{
				icons = { "44750.png" },
				name = "Taberna Celestial EXP",
				price = 200,
				itemtype = 44750,
				count = 1,
				description = "<b>Purchase this boost parchment that increases the experience points your character gains from hunting by 60%! (It's not stackable)</b>\n\n{character}\n{info} lasts for 1 hour hunting time\n{info} can be purchased many times",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				home = true,
				movable = false,
...
--[[ 			{
				icons = { "Super_Roulette_Coin.png" },
				name = "Super Roulette Coin",
				price = 500,
				itemtype = ITEM_SUPER_ROULETTE,
				count = 1,
				description = "<b>Moeda utilizada na super roleta. Boa Sorte!!</b>",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
			{
				icons = { "Mega_Roulette_Coin.png" },
				name = "Mega Roulette Coin",
				price = 1000,
				itemtype = ITEM_MEGA_ROULETTE,
				count = 1,
				description = "<b>Item utilizado na mega roleta. Boa Sorte!!</b>",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				home = true,
				movable = true,
			}, ]]
...
--[[ 			{
				icons = { "Dummy_Surprise_Box.png" },
				name = "Dummy Surprise Box",
				price = 700,
				itemtype = 64049,
				count = 1,
				description = "<b>Using this box, you will win 1 random exercise dummy.</b>\n{info}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			}, ]]
			{
				icons = { "Addon_Surprise_Box.png" },
				name = "Addon Surprise Box",
				price = 250,
				itemtype = 64050,
				count = 1,
				description = "<b>Using this box, you will win one full random outfit.</b>\n{info} <i>Available outfits: Citizen, Hunter, Knight, Noble, Warrior, Barbarian, Druid, Wizard, Oriental, Pirate, Assassin, Beggar, Norse, Nightmare, Jester, Brotherhood, Afflicted, Elementalist, Insectoid, Crystal Warlord and Soil Guardian.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
			{
				icons = { "Love_Dust_Elixir.png" },
				name = "Love Dust Elixir",
				price = 180,
				itemtype = 33893,
				charges = 1,
				description = "<b>Anyone who drinks this sweet and slightly fizzy drink will win 100 of dust</b>",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
			},
			{
				...
				itemtype = 37338,
				count = 1,
				description = "<b>Remove Red or Black Skull.</b>",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
			{
				...
				itemtype = 44740,
				count = 1,
				description = "<b>Recovery your stamina for 2 hours.</b>",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
			{
				icons = { "Magic_Wall_Custom.png" },
				name = "Magic Wall Custom",
				price = 150,
				itemtype = ITEM_MAGIC_WALL_CUSTOM,
				count = 1,
				description = "<b>Choose the color of your magic walls.</b>\n\nWhen you use this item, you will select the color of your magic walls:\n{info} Red and Black\n{info} Green with Blue\n{info} Lightgreen\n{info} Purple with Black\n{info} Purple\n{info} Orange\n{info} White",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				home = true,
				movable = true,
			...
			},
			{
				...
				name = "sneaky stabber of eliteness (canivete vermelho)",
				price = 150,
				itemtype = 9594,
				charges = 1,
			...
			},
			{
				...
				name = "whacking driller of fate (canivete azul)",
				price = 150,
				itemtype = 9598,
				charges = 1,
				description = "<i>This nifty gadget can be used for many vital and less vital purposes. If it's not jammed, that is!</i>\n\n{character}\n{storeinbox}",
			...
			{
				icons = { "squeezing_gear_of_girlpower.png (canivete rosa)" },
			...
			},
			{
				...
				count = 1,
				charges = 1,
				description = "<i>Use this item to enhance your chances at the exaltation forge!</i>\n\n{storeinbox}",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
			},
			{
				icons = { "Exalted_Core.png" },
				name = "5 Exalted Cores",
				price = 1400,
				itemtype = 37110,
				count = 1,
				charges = 5,
			...
			{
				icons = { "64053.png" },
				name = "Taberna Totem Finder",
				price = 360,
				itemtype = 64053,
				count = 1,
				description = "<b>Use it to find out if and where the Taberna totem was born!</b>",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				home = true,
				movable = true,
	...
	--[[{
		...
		offers = {
			{
				icons = { "Bag_You_Covet.gif" },
				name = "Bag You Covet",
				price = 1800,
				itemtype = 43895,
				count = 1,
				description = "{info} The bag quickly transforms into any of the parts of the Sanguine Set.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
			},
			{
			...
			{
				icons = { "Bag_You_Desire.gif" },
				name = "Bag You Desire",
				price = 1100,
				itemtype = 34109,
				count = 1,
				description = "{info} The bag quickly transforms into any of the parts of the Soul Set:\n\nSoulbastion, Soulbleeder, Soulcrusher, Soulmaimer, Soulcutter, Soulshredder, Soulbiter, Souleater, Soulhexer, Soultainter, Soulpiercer, Soulshanks, Soulstrider, Soulshroud, Soulmantle, Soulshell, Pair of Soulwalkers or Pair of Soulstalkers.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
			},
			{
			...
			{
				icons = { "Primal_Bag.gif" },
				name = "Primal Bag",
				price = 700,
				itemtype = 39546,
				count = 1,
				description = "{info} The bag quickly transforms into any of the parts of the Primal Set:\n\nArboreal Crown, Arboreal Tome, Charged Arboreal Ring, Arcanomancer Regalia, Arcanomancer Folio, Charged Arcanomancer Sigil, Alicorn Headguard, Alicorn Quiver, Charged Alicorn Ring, Spiritthorn Helmet, Spiritthorn Armor or Charged Spiritthorn Ring.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
			},
			{
	...
	-- Taberna Shop
	{
		icons = { "Category_Taberna.png" },
		name = "Taberna Shop",
		rookgaard = true,
		subclasses = { "R-Exercise Weapons", "R-Outfits", "R-Mounts", "R-Utils", "R-Dolls", "R-House" },
	},
	{
		icons = { "Category_ExerciseWeapons.png" },
		name = "R-Exercise Weapons",
		parent = "Taberna Shop",
		rookgaard = true,
		state = GameStore.States.STATE_NEW,
		offers = {
	...
	-- Taberna Shop ~ Mounts
	{
		...
		offers = {
			...
			},
			{
				...
				price = 2500,
				id = 218,
				description = "{character}\n{speedboost}\n\n<i>Foxmice can only be tamed by players who are not cursed by the were sickness.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
				coinType = GameStore.CoinType.Coin,
			},
			{
	...
	-- Taberna Shop ~ Utils
	{
		...
		offers = {
			...
			},
			{
				...
				itemtype = 18339,
				count = 1,
				description = "<b>This chess box is made of jade and obsidian. It will hold a full set of 32 Zaoan chess figures.</b>",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				coinType = GameStore.CoinType.Coin,
				movable = true,
			},
			{
				icons = { "Pannier_Backpack.png" },
				name = "Pannier Backpack",
				price = 600,
				itemtype = 19159,
				count = 1,
				description = "<b>Nice Backpack (25 slots).</b>",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				coinType = GameStore.CoinType.Coin,
				movable = true,
			},
			{
				icons = { "love_elixir.png" },
				name = "Love Dust Elixir",
				price = 600,
				itemtype = 33893,
				charges = 1,
			...
			--[[{
				icons = { "Taberna_Celestial_EXP.png" },
				name = "Taberna Celestial EXP",
				price = 1200,
				itemtype = 44750,
				count = 1,
