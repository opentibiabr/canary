return function(api)
	...
	function lifecycle.onLogin(player)
		api.diagnostics.trace("login", "state initialization player='{}' enabled={} eligible={}", api.diagnostics.playerName(player), api.isEnabled(), api.isTaskboardEligible(player))
