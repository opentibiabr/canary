...
if KeywordHandler == nil then
	...
	function KeywordNode:processMessage(npc, cid, message)
		return (self.callback == nil or self.callback(npc, cid, message, self.keywords, self.parameters, self))
	end
	...
	function KeywordHandler:processMessage(npc, cid, message)
		...
		local ret = self:processNodeMessage(node, npc, cid, message)
		if ret then
			return true
		end
	...
	function KeywordHandler:processNodeMessage(node, npc, cid, message)
