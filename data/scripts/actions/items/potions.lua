...
local potions = {
	...
	[7643] = { health = { 2300, 3000 }, vocations = { VOCATION.BASE_ID.KNIGHT }, level = 600, flask = 284, description = "Only knights of level 600 or above may drink this fluid." },
	[7644] = { combat = antidote, flask = 285 },
	[7876] = { health = { 60, 90 }, flask = 285 },
	[23373] = { mana = { 2200, 3500 }, vocations = { VOCATION.BASE_ID.SORCERER, VOCATION.BASE_ID.DRUID }, level = 130, flask = 284, description = "Only druids and sorcerers of level 600 or above may drink this fluid." },
	[23374] = { health = { 1000, 1580 }, mana = { 950, 1350 }, vocations = { VOCATION.BASE_ID.PALADIN }, level = 130, flask = 284, description = "Only paladins of level 600 or above may drink this fluid." },
