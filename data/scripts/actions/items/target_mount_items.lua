...
local config = {
	...
	[12305] = {
		...
		chance = 20,
		fail = { { destroyObject = true, sound = "Krr... kch.", text = "The tin lizzard broke apart." } },
	...
	[16155] = {
		...
		chance = 20,
		fail = { { sound = "FCHHHHHHHHHHHHHHHH", text = "The dragonling doesn't seem to impressed with your ribbon." } },
