...
local function cleanupDatabase()
	...
	local familiarSummonEvent10 = Global.Storage.FamiliarSummonEvent10
	local familiarSummonEvent60 = Global.Storage.FamiliarSummonEvent60
	db.query("DELETE FROM `player_storage` WHERE `key` IN (" .. familiarSummonEvent10 .. ", " .. familiarSummonEvent60 .. ")")
end
