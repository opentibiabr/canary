local config = {
    actionId = 54507, 
    bossName = "Hollowsnake",
    bossPosition = Position(32519, 32462, 7), 
    bossArea = {
        fromPos = Position(32500, 32457, 7), 
        toPos = Position(32532, 32478, 7), 
        entrancePos = Position(32514, 32477, 7), 
        exitPosition = Position(32506, 32470, 7)
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(32516, 32492, 7),
        Position(32516, 32493, 7),
        Position(32516, 32494, 7),
        Position(32516, 32495, 7),
        Position(32516, 32496, 7)
    ...
    createTeleportPos = Position(32515, 32462, 7), 
    teleportToPosition = Position(32513, 32444, 7), 
...
local hollowsnakelever = Action()

function hollowsnakelever.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("hollowsnakebosslever")
...
hollowsnakelever:aid(config.actionId)
hollowsnakelever:register()

local creatureEvent = CreatureEvent("hollowsnakebosslever")
