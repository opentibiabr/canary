local config = {
    actionId = 54505, 
    bossName = "Trancescreamer",
    bossPosition = Position(32521, 32547, 7), 
    bossArea = {
        fromPos = Position(32507, 32543, 7), 
        toPos = Position(32527, 32560, 7), 
        entrancePos = Position(32516, 32558, 7), 
        exitPosition = Position(32510, 32558, 7)
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(32517, 32566, 7),
        Position(32517, 32567, 7),
        Position(32517, 32568, 7),
        Position(32517, 32569, 7),
        Position(32517, 32570, 7)
    ...
    createTeleportPos = Position(32518, 32546, 7), 
    teleportToPosition = Position(32516, 32537, 7), 
...
local trancescreamerlever = Action()

function trancescreamerlever.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("trancescreamerBossLever")
...
trancescreamerlever:aid(config.actionId)
trancescreamerlever:register()

local creatureEvent = CreatureEvent("trancescreamerBossLever")
