...
| 3.1 | Channel id resolution priority CLI > env > fallback | `ChannelContext` implements exactly this order | ✅ tested |
...
| 4.4 | Fail-closed startup validator | `ClusterConfigValidator` | ✅ config-shape checks / 📐 live Redis/DB/heartbeat checks |
