 ...
 icons = { "Category_ExclusiveOffers.png" },
  ...
  offers = {
            ...
            },
			{
                ...
                count = 1,
				moveable = true,
                description = "<i>A small gift from the gnomes of gnomprona.</i>",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
 },
},
  ...
  offers = {
			{
                ...
                count = 1,
				moveable = true,
                description = "Uma Wand/Rod capaz de atacar em area",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
 },
},
	...
	-- Consumables ~ Runes
	{
		...
		offers = {
			...
			},
			{
				...
				itemtype = 3180,
				count = 250,
				description = "{character}\n{storeinbox}\n{vocationlevelcheck}\n{battlesign}\n{capacity}\n\n<i>This spell causes all particles that are contained in the surrounding air to quickly gather and contract until a solid wall is formed that covers one  square metre. The wall that is formed that way is impenetrable to any missiles or to light and no creature or character can walk through it. However, the wall will only last for a couple of seconds.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
			...
			},
			{
				...
				itemtype = 3156,
				count = 250,
				description = "{character}\n{storeinbox}\n{vocationlevelcheck}\n{battlesign}\n{capacity}\n\n<i>By unleashing this spell, all seeds that are lying dormant in the surrounding quickly sprout and grow into -sized plants, thus forming an impenetrable thicket. Unfortunately, plant life created this way is short-lived and will collapse within minutes, so the magically created obstacle will not last long.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
		},
	},
	...
	-- Cosmetics ~ Mounts
	{
		...
		offers = {
			...
			},
			{
				...
				price = 750,
				id = 208,
				description = "{character}\n{speedboost}\n\n<i>The vibrant colours and elegance of a Tangerine Flecked Koi, a Brass Speckled Koi, and an Ink Spotted Koi make them a fascinating sight to behold, and their boisterous nature and speed will make you the first to arrive wherever there are riches to gain. Wield your weapon as gracey and effortlessly as your swimming companion glides through the water, and the two of you will make the perfect and most deadly pair.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				icons = { "Bogwurm.png" },
			...
			},
			{
				...
				price = 690,
				id = 117,
				description = "{character}\n{speedboost}\n\n<i>It is said that the Cave Tarantula was born long before Banor walked the earth of Tibia. While its parents died in the war against the cruel hordes sent by Brog and Zathroth, their child survived by hiding in skulls of burned enemies. It never left its hiding spot and as it grew older, the skulls merged into its body. Now, it is y-grown and thirsts for revenge.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
			...
			},
			{
				...
				price = 690,
				id = 116,
				description = "{character}\n{speedboost}\n\n<i>It is said that the Cranium Spider was born long before Banor walked the earth of Tibia. While its parents died in the war against the cruel hordes sent by Brog and Zathroth, their child survived by hiding in skulls of burned enemies. It never left its hiding spot and as it grew older, the skulls merged into its body. Now, it is y-grown and thirsts for revenge.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
			...
			},
			{
				...
				price = 690,
				id = 118,
				description = "{character}\n{speedboost}\n\n<i>It is said that the Gloom Widow was born long before Banor walked the earth of Tibia. While its parents died in the war against the cruel hordes sent by Brog and Zathroth, their child survived by hiding in skulls of burned enemies. It never left its hiding spot and as it grew older, the skulls merged into its body. Now, it is y-grown and thirsts for revenge.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				icons = { "Gloomwurm.png" },
			...
			},
			{
				...
				price = 870,
				id = 204,
				description = "{character}\n{speedboost}\n\n<i>A seasoned warrior knows how to make an entry, and so does his faithful companion: y armored! Saddle up your impressive Jousting Horse to charge into battle in style, gallop into the arena on the back of your striking Tourney Horse, and ride your distinguished Parade Horse through the streets of Thais to show off your chivalrous qualities. With a horse in  barding, nobody will ever rain on your parade again.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
	...
	-- Cosmetics ~ Outfits (base outfit has addon = 0 or no defined addon. By default addon is set to 0)
	{
		...
		offers = {
			...
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Being a Ghost Blade means having mastered the way of the warrior. No matter the circumstances, these fighters retain  control over their body and mind, with the sole focus of vanquishing their foe. So great is their ability that they not only control the weapons in their hands perfectly, but two floating blades following them as well.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "" },
				name = "Nordic Chieftan",
				price = 1200,
			...
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>The Herder is one with nature, being outside all day, watching carey over his flock. If you like to spend time on picturesque meadows and are always looking for greener pastures, then this outfit is for you.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
			...
			},
			{
				...
				name = " Lupine Warden Outfit",
				price = 840,
				sexId = { female = 900, male = 899 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Do you feel the adrenaline rushing through your veins when the sun goes down and a  moon lightens the night? Do you have the urge to hunt down your target no matter what? Unleash the beast inside of you and lead your friends to battle with the Lupine Warden outfit!</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
			...
			},
			{
				...
				name = " Rune Master Outfit",
				price = 870,
				sexId = { female = 1385, male = 1384 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>A Rune Master has dedicated their whole life to the study and mastery of runes. They are intrigued by the ancient symbols, shrouded in mystery, and how their magic works. Rune Masters have a deep understanding of the awesome power they are wielding and can make use of the  potential of runes.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
			...
			},
			{
				...
				name = " Shadowlotus Disciple Outfit",
				price = 600,
		...
		offers = {
			{
                ...
                count = 1,
				moveable = true,
                description = "Stamina Reffiler 1 hour",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
			{
                icons = {""},
            ...
            },
			{
                ...
                count = 1,
				moveable = true,
                description = "Teleporta voce para muitos lugares.",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            },
			{
                icons = {""},
	...
	-- Exclusive Offers
	{
		...
		offers = {
			...
			},
			{
				...
				name = " Void Master Outfit",
				price = 1750,
				sexId = { female = 1203, male = 1202 },
				addon = 3,
				description = "{info} usable by all characters of the account\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>According to ancient rumours, the pulsating orb that the Void Master balances skily on the tip of his staff consists of powerful cosmic spheres. If you gaze too long into the infinite emptiness inside the orb, its powers will absorb your mind.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
		},
	},
