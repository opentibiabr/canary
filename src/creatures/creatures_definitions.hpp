...
enum ConditionAttr_t {
	...
	CONDITIONATTR_SOURCE_SPELL_TYPE,
	CONDITIONATTR_SHIELD_ATTACK_DAMAGE_REDUCTION_BONUS,
...
enum CombatParam_t {
	...
	COMBAT_PARAM_IGNORECASTERFLOOR,
};
...
enum SpellGroup_t : uint8_t {
	...
	SPELLGROUP_VIRTUE = SPELLGROUP_STANCE, // Legacy name.
};
