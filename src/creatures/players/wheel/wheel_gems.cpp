...
void WheelModifierContext::addStrategies(WheelGemSupremeModifier_t modifier, uint8_t grade) {
	...
	switch (modifier) {
		case WheelGemSupremeModifier_t::General_Dodge:
			m_strategies.emplace_back(std::make_unique<GemModifierStatStrategy>(m_wheel, WheelStat_t::DODGE, 25 * gradeMultiplier));
			break;
		case WheelGemSupremeModifier_t::General_LifeLeech:
			m_strategies.emplace_back(std::make_unique<GemModifierStatStrategy>(m_wheel, WheelStat_t::LIFE_LEECH, 120 * gradeMultiplier));
			break;
		case WheelGemSupremeModifier_t::General_ManaLeech:
			m_strategies.emplace_back(std::make_unique<GemModifierStatStrategy>(m_wheel, WheelStat_t::MANA_LEECH, 40 * gradeMultiplier));
			break;
		case WheelGemSupremeModifier_t::General_CriticalDamage:
			m_strategies.emplace_back(std::make_unique<GemModifierStatStrategy>(m_wheel, WheelStat_t::CRITICAL_DAMAGE, 150 * gradeMultiplier));
			break;
