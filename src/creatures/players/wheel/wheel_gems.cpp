...
void WheelModifierContext::addStrategies(WheelGemBasicModifier_t modifier) {
	switch (modifier) {
		case WheelGemBasicModifier_t::General_PhysicalResistance:
			m_strategies.emplace_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_PHYSICALDAMAGE, 100));
			break;
		...
		case WheelGemBasicModifier_t::General_HolyResistance_DeathWeakness:
			m_strategies.emplace_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_HOLYDAMAGE, 150));
			m_strategies.emplace_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_DEATHDAMAGE, -100));
			break;
		case WheelGemBasicModifier_t::General_DeathResistance_HolyWeakness:
			m_strategies.emplace_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_DEATHDAMAGE, 150));
			m_strategies.emplace_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_HOLYDAMAGE, -100));
			break;
		case WheelGemBasicModifier_t::General_FireResistance_EarthResistance:
			m_strategies.emplace_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_FIREDAMAGE, 100));
			m_strategies.emplace_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_EARTHDAMAGE, 100));
			break;
		case WheelGemBasicModifier_t::General_FireResistance_IceResistance:
			m_strategies.emplace_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_FIREDAMAGE, 100));
			m_strategies.emplace_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_ICEDAMAGE, 100));
			break;
		case WheelGemBasicModifier_t::General_FireResistance_EnergyResistance:
			m_strategies.emplace_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_FIREDAMAGE, 100));
			m_strategies.emplace_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_ENERGYDAMAGE, 100));
			break;
		...
		case WheelGemBasicModifier_t::General_FireResistance_EarthWeakness:
			m_strategies.emplace_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_FIREDAMAGE, 300));
			m_strategies.emplace_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_EARTHDAMAGE, -200));
			break;
		...
		case WheelGemBasicModifier_t::General_EarthResistance_FireWeakness:
			m_strategies.emplace_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_EARTHDAMAGE, 300));
			m_strategies.emplace_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_FIREDAMAGE, -200));
			break;
		...
		case WheelGemBasicModifier_t::General_IceResistance_EarthWeakness:
			m_strategies.emplace_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_ICEDAMAGE, 300));
			m_strategies.emplace_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_EARTHDAMAGE, -200));
			break;
		...
		case WheelGemBasicModifier_t::General_EnergyResistance_EarthWeakness:
			m_strategies.emplace_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_ENERGYDAMAGE, 300));
			m_strategies.emplace_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_EARTHDAMAGE, -200));
			break;
		...
		case WheelGemBasicModifier_t::General_ManaDrainResistance:
			m_strategies.emplace_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_MANADRAIN, 300));
			break;
		case WheelGemBasicModifier_t::General_LifeDrainResistance:
			m_strategies.emplace_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_LIFEDRAIN, 300));
			break;
		case WheelGemBasicModifier_t::General_ManaDrainResistance_LifeDrainResistance:
			m_strategies.emplace_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_MANADRAIN, 150));
			m_strategies.emplace_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_LIFEDRAIN, 150));
			break;
		case WheelGemBasicModifier_t::General_MitigationMultiplier:
			m_strategies.emplace_back(std::make_unique<GemModifierStatStrategy>(m_wheel, WheelStat_t::MITIGATION, 500));
			break;

		case WheelGemBasicModifier_t::Vocation_Health:
			m_strategies.emplace_back(std::make_unique<GemModifierStatStrategy>(m_wheel, WheelStat_t::HEALTH, getHealthValue(m_vocation, modifier)));
			break;
		case WheelGemBasicModifier_t::Vocation_Mana_FireResistance:
			m_strategies.emplace_back(std::make_unique<GemModifierStatStrategy>(m_wheel, WheelStat_t::MANA, getManaValue(m_vocation, modifier)));
			m_strategies.emplace_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_FIREDAMAGE, 100));
			break;
		...
		case WheelGemBasicModifier_t::Vocation_Mixed:
			m_strategies.emplace_back(std::make_unique<GemModifierStatStrategy>(m_wheel, WheelStat_t::HEALTH, getHealthValue(m_vocation, modifier)));
			m_strategies.emplace_back(std::make_unique<GemModifierStatStrategy>(m_wheel, WheelStat_t::MANA, getManaValue(m_vocation, modifier)));
			m_strategies.emplace_back(std::make_unique<GemModifierStatStrategy>(m_wheel, WheelStat_t::CAPACITY, getCapacityValue(m_vocation, modifier)));
			break;
...
void WheelModifierContext::addStrategies(WheelGemSupremeModifier_t modifier) {
	...
	switch (modifier) {
		case WheelGemSupremeModifier_t::General_Dodge:
			m_strategies.emplace_back(std::make_unique<GemModifierStatStrategy>(m_wheel, WheelStat_t::DODGE, 25));
			break;
		case WheelGemSupremeModifier_t::General_LifeLeech:
			m_strategies.emplace_back(std::make_unique<GemModifierStatStrategy>(m_wheel, WheelStat_t::LIFE_LEECH, 120));
			break;
		case WheelGemSupremeModifier_t::General_ManaLeech:
			m_strategies.emplace_back(std::make_unique<GemModifierStatStrategy>(m_wheel, WheelStat_t::MANA_LEECH, 40));
			break;
		case WheelGemSupremeModifier_t::General_CriticalDamage:
			m_strategies.emplace_back(std::make_unique<GemModifierStatStrategy>(m_wheel, WheelStat_t::CRITICAL_DAMAGE, 150));
			break;
		case WheelGemSupremeModifier_t::General_RevelationMastery_GiftOfLife:
			m_strategies.emplace_back(std::make_unique<GemModifierRevelationStrategy>(m_wheel, WheelGemAffinity_t::Green, 150));
			break;
		...
		case WheelGemSupremeModifier_t::Knight_RevelationMastery_ExecutionersThrow:
			m_strategies.emplace_back(std::make_unique<GemModifierRevelationStrategy>(m_wheel, WheelGemAffinity_t::Red, 150));
			break;
		case WheelGemSupremeModifier_t::Knight_RevelationMastery_AvatarOfSteel:
			m_strategies.emplace_back(std::make_unique<GemModifierRevelationStrategy>(m_wheel, WheelGemAffinity_t::Purple, 150));
			break;
		case WheelGemSupremeModifier_t::Knight_RevelationMastery_CombatMastery:
			m_strategies.emplace_back(std::make_unique<GemModifierRevelationStrategy>(m_wheel, WheelGemAffinity_t::Blue, 150));
			break;
