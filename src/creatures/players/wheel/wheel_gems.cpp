...
void WheelModifierContext::addStrategies(WheelGemBasicModifier_t modifier, uint8_t grade) {
	...
	switch (modifier) {
		case WheelGemBasicModifier_t::General_PhysicalResistance:
			m_strategies.push_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_PHYSICALDAMAGE, 100 * gradeMultiplier));
			break;
		case WheelGemBasicModifier_t::General_HolyResistance:
			m_strategies.push_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_HOLYDAMAGE, 100 * gradeMultiplier));
			break;
		case WheelGemBasicModifier_t::General_DeathResistance:
			m_strategies.push_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_DEATHDAMAGE, 100 * gradeMultiplier));
			break;
		case WheelGemBasicModifier_t::General_FireResistance:
			m_strategies.push_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_FIREDAMAGE, 200 * gradeMultiplier));
			break;
		case WheelGemBasicModifier_t::General_EarthResistance:
			m_strategies.push_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_EARTHDAMAGE, 200 * gradeMultiplier));
			break;
		case WheelGemBasicModifier_t::General_IceResistance:
			m_strategies.push_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_ICEDAMAGE, 200 * gradeMultiplier));
			break;
		case WheelGemBasicModifier_t::General_EnergyResistance:
			m_strategies.push_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_ENERGYDAMAGE, 200 * gradeMultiplier));
			break;
		case WheelGemBasicModifier_t::General_HolyResistance_DeathWeakness:
			m_strategies.push_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_HOLYDAMAGE, 150 * gradeMultiplier));
		...
		case WheelGemBasicModifier_t::General_DeathResistance_HolyWeakness:
			m_strategies.push_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_DEATHDAMAGE, 150 * gradeMultiplier));
		...
		case WheelGemBasicModifier_t::General_FireResistance_EarthWeakness:
			m_strategies.push_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_FIREDAMAGE, 300 * gradeMultiplier));
		...
		case WheelGemBasicModifier_t::General_EarthResistance_FireWeakness:
			m_strategies.push_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_EARTHDAMAGE, 300 * gradeMultiplier));
		...
		case WheelGemBasicModifier_t::General_IceResistance_EarthWeakness:
			m_strategies.push_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_ICEDAMAGE, 300 * gradeMultiplier));
			m_strategies.push_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_EARTHDAMAGE, -200));
			break;
		...
		case WheelGemBasicModifier_t::General_EnergyResistance_EarthWeakness:
			m_strategies.push_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_ENERGYDAMAGE, 300 * gradeMultiplier));
			m_strategies.push_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_EARTHDAMAGE, -200));
			break;
		...
		case WheelGemBasicModifier_t::General_ManaDrainResistance:
			m_strategies.push_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_MANADRAIN, 300 * gradeMultiplier));
			break;
		case WheelGemBasicModifier_t::General_LifeDrainResistance:
			m_strategies.push_back(std::make_unique<GemModifierResistanceStrategy>(m_wheel, CombatType_t::COMBAT_LIFEDRAIN, 300 * gradeMultiplier));
			break;
		...
		case WheelGemBasicModifier_t::General_MitigationMultiplier:
			m_strategies.push_back(std::make_unique<GemModifierStatStrategy>(m_wheel, WheelStat_t::MITIGATION, 500 * gradeMultiplier));
			break;
...
void WheelModifierContext::addStrategies(WheelGemSupremeModifier_t modifier, uint8_t grade) {
	...
	switch (modifier) {
		case WheelGemSupremeModifier_t::General_Dodge:
			m_strategies.push_back(std::make_unique<GemModifierStatStrategy>(m_wheel, WheelStat_t::DODGE, 25 * gradeMultiplier));
			break;
		case WheelGemSupremeModifier_t::General_LifeLeech:
			m_strategies.push_back(std::make_unique<GemModifierStatStrategy>(m_wheel, WheelStat_t::LIFE_LEECH, 120 * gradeMultiplier));
			break;
		case WheelGemSupremeModifier_t::General_ManaLeech:
			m_strategies.push_back(std::make_unique<GemModifierStatStrategy>(m_wheel, WheelStat_t::MANA_LEECH, 40 * gradeMultiplier));
			break;
		case WheelGemSupremeModifier_t::General_CriticalDamage:
			m_strategies.push_back(std::make_unique<GemModifierStatStrategy>(m_wheel, WheelStat_t::CRITICAL_DAMAGE, 150 * gradeMultiplier));
			break;
		case WheelGemSupremeModifier_t::General_RevelationMastery_GiftOfLife:
			m_strategies.push_back(std::make_unique<GemModifierRevelationStrategy>(m_wheel, WheelGemAffinity_t::Green, 150 * gradeMultiplier));
		...
		case WheelGemSupremeModifier_t::Knight_RevelationMastery_ExecutionersThrow:
			m_strategies.push_back(std::make_unique<GemModifierRevelationStrategy>(m_wheel, WheelGemAffinity_t::Red, 150 * gradeMultiplier));
		...
		case WheelGemSupremeModifier_t::Knight_RevelationMastery_AvatarOfSteel:
			m_strategies.push_back(std::make_unique<GemModifierRevelationStrategy>(m_wheel, WheelGemAffinity_t::Purple, 150 * gradeMultiplier));
		...
		case WheelGemSupremeModifier_t::Knight_RevelationMastery_CombatMastery:
			m_strategies.push_back(std::make_unique<GemModifierRevelationStrategy>(m_wheel, WheelGemAffinity_t::Blue, 150 * gradeMultiplier));
