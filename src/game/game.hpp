...
public:
	...
	bool combatChangeHealth(
		const std::shared_ptr<Creature> &attacker, const std::shared_ptr<Creature> &target,
		CombatDamage &damage, bool isEvent = false, CombatOrigin sourceOrigin = ORIGIN_NONE
	);
