...
public:
	static bool loadPlayerFirst(const std::shared_ptr<Player> &player, DBResult_ptr result);
	static bool preLoadPlayer(const std::shared_ptr<Player> &player, const std::string &name);
	static void loadPlayerExperience(const std::shared_ptr<Player> &player, DBResult_ptr result);
	static void loadPlayerBlessings(const std::shared_ptr<Player> &player, DBResult_ptr result);
	static void loadPlayerConditions(const std::shared_ptr<Player> &player, DBResult_ptr result);
	static void loadPlayerDefaultOutfit(const std::shared_ptr<Player> &player, DBResult_ptr result);
	static void loadPlayerSkullSystem(const std::shared_ptr<Player> &player, DBResult_ptr result);
	static void loadPlayerSkill(const std::shared_ptr<Player> &player, DBResult_ptr result);
