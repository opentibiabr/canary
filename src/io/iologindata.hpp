...
public:
	...
	static bool loadPlayerById(std::shared_ptr<Player> player, uint32_t id, bool disableOfflineUnrelevantInformations = true);
	static bool loadPlayerByName(std::shared_ptr<Player> player, const std::string &name, bool disableOfflineUnrelevantInformations = true);
	static bool loadPlayer(std::shared_ptr<Player> player, DBResult_ptr result, bool disableOfflineUnrelevantInformations = false);
