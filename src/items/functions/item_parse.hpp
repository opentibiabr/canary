...
const std::unordered_map<std::string_view, ItemParseAttributes_t> ItemParseAttributesMap = {
...
const std::unordered_map<std::string_view, ItemTypes_t> ItemTypesMap = {
	{"key", ITEM_TYPE_KEY},
...
const std::unordered_map<std::string_view, TileFlags_t> TileStatesMap = {
...
const std::unordered_map<std::string_view, Fluids_t> FluidTypesMap = {
	{"water", FLUID_WATER },
	{"blood", FLUID_BLOOD},
	{"beer", FLUID_BEER},
	{"slime", FLUID_SLIME},
...
const std::unordered_map<std::string_view, WeaponType_t> WeaponTypesMap = {
	{"sword", WEAPON_SWORD},
	{"club", WEAPON_CLUB},
	{"axe", WEAPON_AXE},
...
const std::unordered_map<std::string_view, ImbuementTypes_t> ImbuementsTypeMap = {
