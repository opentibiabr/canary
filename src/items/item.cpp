...
bool Item::unserializeAttrFromProtobuf(Canary::protobuf::itemsserialization::Item itemProtobuf) {
	for (const auto &attributeProtobuf : itemProtobuf.attribute()) {
		switch (attributeProtobuf.id()) {
			...
			case ATTR_ACTION_ID: {
				setAttribute(ItemAttribute_t::ACTIONID, static_cast<uint16_t>(std::stoll(attributeProtobuf.data())));
				break;
			}

			case ATTR_UNIQUE_ID: {
				setAttribute(ItemAttribute_t::UNIQUEID, static_cast<uint16_t>(std::stoll(attributeProtobuf.data())));
				break;
			}

			case ATTR_TEXT: {
				setAttribute(ItemAttribute_t::TEXT, attributeProtobuf.data());
				break;
			}

			case ATTR_WRITTENDATE: {
				setAttribute(ItemAttribute_t::DATE, static_cast<uint32_t>(std::stoll(attributeProtobuf.data())));
				break;
			}

			case ATTR_WRITTENBY: {
				setAttribute(ItemAttribute_t::WRITER, attributeProtobuf.data());
				break;
			}

			case ATTR_DESC: {
				setAttribute(ItemAttribute_t::DESCRIPTION, attributeProtobuf.data());
				break;
			}
			...
			case ATTR_NAME: {
				setAttribute(ItemAttribute_t::NAME, attributeProtobuf.data());
				break;
			}

			case ATTR_ARTICLE: {
				setAttribute(ItemAttribute_t::ARTICLE, attributeProtobuf.data());
				break;
			}

			case ATTR_PLURALNAME: {
				setAttribute(ItemAttribute_t::PLURALNAME, attributeProtobuf.data());
				break;
			}

			case ATTR_WEIGHT: {
				setAttribute(ItemAttribute_t::WEIGHT, static_cast<uint32_t>(std::stoll(attributeProtobuf.data())));
				break;
			}

			case ATTR_ATTACK: {
				setAttribute(ItemAttribute_t::ATTACK, static_cast<int32_t>(std::stoll(attributeProtobuf.data())));
				break;
			}

			case ATTR_DEFENSE: {
				setAttribute(ItemAttribute_t::DEFENSE, static_cast<int32_t>(std::stoll(attributeProtobuf.data())));
				break;
			}

			case ATTR_EXTRADEFENSE: {
				setAttribute(ItemAttribute_t::EXTRADEFENSE, static_cast<int32_t>(std::stoll(attributeProtobuf.data())));
				break;
			}

			case ATTR_IMBUEMENT_SLOT: {
				setAttribute(ItemAttribute_t::IMBUEMENT_SLOT, static_cast<int32_t>(std::stoll(attributeProtobuf.data())));
				break;
			}

			case ATTR_OPENCONTAINER: {
				setAttribute(ItemAttribute_t::OPENCONTAINER, static_cast<uint8_t>(std::stoll(attributeProtobuf.data())));
				break;
			}

			case ATTR_ARMOR: {
				setAttribute(ItemAttribute_t::ARMOR, static_cast<int32_t>(std::stoll(attributeProtobuf.data())));
				break;
			}

			case ATTR_HITCHANCE: {
				setAttribute(ItemAttribute_t::HITCHANCE, static_cast<int8_t>(std::stoll(attributeProtobuf.data())));
				break;
			}

			case ATTR_SHOOTRANGE: {
				setAttribute(ItemAttribute_t::SHOOTRANGE, static_cast<uint8_t>(std::stoll(attributeProtobuf.data())));
				break;
			}

			case ATTR_SPECIAL: {
				setAttribute(ItemAttribute_t::SPECIAL, attributeProtobuf.data());
				break;
			}

			case ATTR_QUICKLOOTCONTAINER: {
				setAttribute(ItemAttribute_t::QUICKLOOTCONTAINER, static_cast<uint32_t>(std::stoll(attributeProtobuf.data())));
				break;
			}
			...
			case ATTR_CUSTOM: {
				...
				CustomAttribute customAttribute;
				customAttribute.unserializeFromProtobuf(attributeProtobuf);
				addCustomAttribute(key, customAttribute);
				break;
			}
...
bool Item::serializeAttrToProtobuf(Canary::protobuf::itemsserialization::Item* itemProtobuf) const {
	...
	if (hasAttribute(ItemAttribute_t::NAME)) {
		...
		attribute->set_type(Canary::protobuf::itemsserialization::ATTRIBUTE_TYPE::ATTRIBUTE_TYPE_STRING);
		attribute->set_data(getString(ItemAttribute_t::NAME));
	}
	...
	if (hasAttribute(ItemAttribute_t::ARTICLE)) {
		...
		attribute->set_type(Canary::protobuf::itemsserialization::ATTRIBUTE_TYPE::ATTRIBUTE_TYPE_STRING);
		attribute->set_data(getString(ItemAttribute_t::ARTICLE));
	}
	...
	if (hasAttribute(ItemAttribute_t::PLURALNAME)) {
		...
		attribute->set_type(Canary::protobuf::itemsserialization::ATTRIBUTE_TYPE::ATTRIBUTE_TYPE_STRING);
		attribute->set_data(getString(ItemAttribute_t::PLURALNAME));
	}
	...
	if (hasAttribute(ItemAttribute_t::WEIGHT)) {
		...
		attribute->set_type(Canary::protobuf::itemsserialization::ATTRIBUTE_TYPE::ATTRIBUTE_TYPE_NUMERIC);
		attribute->set_data(std::to_string(getAttribute<uint32_t>(ItemAttribute_t::WEIGHT)));
	}
	...
	if (hasAttribute(ItemAttribute_t::ATTACK)) {
		...
		attribute->set_type(Canary::protobuf::itemsserialization::ATTRIBUTE_TYPE::ATTRIBUTE_TYPE_NUMERIC);
		attribute->set_data(std::to_string(getAttribute<uint32_t>(ItemAttribute_t::ATTACK)));
	}
	...
	if (hasAttribute(ItemAttribute_t::DEFENSE)) {
		...
		attribute->set_type(Canary::protobuf::itemsserialization::ATTRIBUTE_TYPE::ATTRIBUTE_TYPE_NUMERIC);
		attribute->set_data(std::to_string(getAttribute<uint32_t>(ItemAttribute_t::DEFENSE)));
	}
	...
	if (hasAttribute(ItemAttribute_t::EXTRADEFENSE)) {
		...
		attribute->set_type(Canary::protobuf::itemsserialization::ATTRIBUTE_TYPE::ATTRIBUTE_TYPE_NUMERIC);
		attribute->set_data(std::to_string(getAttribute<uint32_t>(ItemAttribute_t::EXTRADEFENSE)));
	}
	...
	if (hasAttribute(ItemAttribute_t::IMBUEMENT_SLOT)) {
		...
		attribute->set_type(Canary::protobuf::itemsserialization::ATTRIBUTE_TYPE::ATTRIBUTE_TYPE_NUMERIC);
		attribute->set_data(std::to_string(getAttribute<uint32_t>(ItemAttribute_t::IMBUEMENT_SLOT)));
	}
	...
	if (hasAttribute(ItemAttribute_t::OPENCONTAINER)) {
		...
		attribute->set_type(Canary::protobuf::itemsserialization::ATTRIBUTE_TYPE::ATTRIBUTE_TYPE_NUMERIC);
		attribute->set_data(std::to_string(getAttribute<uint32_t>(ItemAttribute_t::OPENCONTAINER)));
	}
	...
	if (hasAttribute(ItemAttribute_t::ARMOR)) {
		...
		attribute->set_type(Canary::protobuf::itemsserialization::ATTRIBUTE_TYPE::ATTRIBUTE_TYPE_NUMERIC);
		attribute->set_data(std::to_string(getAttribute<uint32_t>(ItemAttribute_t::ARMOR)));
	}
	...
	if (hasAttribute(ItemAttribute_t::HITCHANCE)) {
		...
		attribute->set_type(Canary::protobuf::itemsserialization::ATTRIBUTE_TYPE::ATTRIBUTE_TYPE_NUMERIC);
		attribute->set_data(std::to_string(getAttribute<uint32_t>(ItemAttribute_t::HITCHANCE)));
	}
	...
	if (hasAttribute(ItemAttribute_t::SHOOTRANGE)) {
		...
		attribute->set_type(Canary::protobuf::itemsserialization::ATTRIBUTE_TYPE::ATTRIBUTE_TYPE_NUMERIC);
		attribute->set_data(std::to_string(getAttribute<uint32_t>(ItemAttribute_t::SHOOTRANGE)));
	}
	...
	if (hasAttribute(ItemAttribute_t::SPECIAL)) {
		...
		attribute->set_type(Canary::protobuf::itemsserialization::ATTRIBUTE_TYPE::ATTRIBUTE_TYPE_STRING);
		attribute->set_data(getString(ItemAttribute_t::SPECIAL));
	}
	...
	if (hasCustomAttribute()) {
		...
		for (const auto &[attributeKey, customAttribute] : customAttributeMap) {
			...
			attribute->set_extended(attributeKey);

			// Serializing value type and value
			customAttribute.serializeToProtobuf(attribute);
		}
	}
	...
	if (hasAttribute(ItemAttribute_t::QUICKLOOTCONTAINER)) {
		...
		attribute->set_type(Canary::protobuf::itemsserialization::ATTRIBUTE_TYPE::ATTRIBUTE_TYPE_NUMERIC);
		attribute->set_data(std::to_string(getAttribute<uint32_t>(ItemAttribute_t::QUICKLOOTCONTAINER)));
	}
