...
enum ImbuementTypes_t : int64_t {
	...
	IMBUEMENT_SKILLBOST_AXE = 11,
	IMBUEMENT_SKILLBOST_SWORD = 12,
	IMBUEMENT_SKILLBOST_CLUB = 13,
	IMBUEMENT_SKILLBOST_SHIELDING = 14,
	IMBUEMENT_SKILLBOST_DISTANCE = 15,
	IMBUEMENT_SKILLBOST_MAGIC_LEVEL = 16,
