...
std::shared_ptr<MoveEvent> MoveEvents::getEvent(Item &item, MoveEvent_t eventType, Slots_t slot) {
	uint32_t slotp;
	switch (slot) {
...
std::shared_ptr<MoveEvent> MoveEvents::getEvent(Tile &tile, MoveEvent_t eventType) {
