...
bool TalkActions::checkWord(std::shared_ptr<Player> player, TalkType type, const std::string &words, const std::string_view &word, const TalkAction_ptr &talkActionPtr) const {
...
TalkActionResult_t TalkActions::checkPlayerCanSayTalkAction(std::shared_ptr<Player> player, TalkType type, const std::string &words) const {
...
bool TalkAction::executeSay(std::shared_ptr<Player> player, const std::string &words, const std::string &param, TalkType type) const {
