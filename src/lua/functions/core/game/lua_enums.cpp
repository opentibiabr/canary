...
void LuaEnums::initItemIdEnums(lua_State* L) {
	...
	registerEnum(L, ITEM_REVOADA_COIN);
	registerEnum(L, ITEM_REVOADA_RUBY_BOX);
	registerEnum(L, ITEM_REVOADA_JADE_BOX);
	registerEnum(L, ITEM_REVOADA_TURQUOISE_BOX);
	registerEnum(L, ITEM_REVOADA_EXERCISE_PRESENT);
	registerEnum(L, ITEM_REMOVE_BAGS);
	registerEnum(L, ITEM_SUPER_ROULETTE);
	registerEnum(L, ITEM_MAGIC_WALL_CUSTOM);
	registerEnum(L, ITEM_MEGA_ROULETTE);
	registerEnum(L, ITEM_REVOADA_PIZZA);
	registerEnum(L, ITEM_GODNESS_FORGE);
	registerEnum(L, ITEM_RUBY_COIN);
}
