	...
	public:
		static void init(lua_State* L) {
			...
			*/
			...
			registerEnum(L, HIGHSCORE_CATEGORY_EXPERIENCE)
			registerEnum(L, HIGHSCORE_CATEGORY_FIST_FIGHTING)
			registerEnum(L, HIGHSCORE_CATEGORY_CLUB_FIGHTING)
			registerEnum(L, HIGHSCORE_CATEGORY_SWORD_FIGHTING)
			registerEnum(L, HIGHSCORE_CATEGORY_AXE_FIGHTING)
			registerEnum(L, HIGHSCORE_CATEGORY_DISTANCE_FIGHTING)
			registerEnum(L, HIGHSCORE_CATEGORY_SHIELDING)
			registerEnum(L, HIGHSCORE_CATEGORY_FISHING)
			registerEnum(L, HIGHSCORE_CATEGORY_MAGIC_LEVEL)
			registerEnum(L, HIGHSCORE_CATEGORY_LOYALTY)
			registerEnum(L, HIGHSCORE_CATEGORY_ACHIEVEMENTS)
			registerEnum(L, HIGHSCORE_CATEGORY_CHARMS)
			registerEnum(L, HIGHSCORE_CATEGORY_DROME)
			registerEnum(L, HIGHSCORE_CATEGORY_GOSHNAR)
			#undef registerEnum
		}
