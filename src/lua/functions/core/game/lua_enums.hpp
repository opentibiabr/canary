...
class LuaEnums final : LuaScriptInterface {
	public:
		static void init(lua_State* L) {
			...
			registerEnum(L, MESSAGE_TRADENPC)
			...
			registerEnum(L, MESSAGE_TUTORIAL)
			...
			registerEnum(L, MESSAGE_EVENT_ADVANCE)
			registerEnum(L, MESSAGE_EVENT_ADVANCE)
			registerEnum(L, MESSAGE_WARNING)
			...
			*/
			...
			registerEnum(L, GAME_FEATURE_RULEVIOLATION)
			#endif
			#if GAME_FEATURE_XTEA > 0
			registerEnum(L, GAME_FEATURE_XTEA)
			#endif
			#if GAME_FEATURE_RSA1024 > 0
			registerEnum(L, GAME_FEATURE_RSA1024)
			#endif
			#if GAME_FEATURE_MESSAGE_STATEMENT > 0
			registerEnum(L, GAME_FEATURE_MESSAGE_STATEMENT)
			#endif
			#if GAME_FEATURE_LOOKTYPE_U16 > 0
			registerEnum(L, GAME_FEATURE_LOOKTYPE_U16)
			#endif
			#if GAME_FEATURE_NEWFLUIDS > 0
			registerEnum(L, GAME_FEATURE_NEWFLUIDS)
			#endif
			#if GAME_FEATURE_MESSAGE_LEVEL > 0
			registerEnum(L, GAME_FEATURE_MESSAGE_LEVEL)
			#endif
			#if GAME_FEATURE_PLAYERICONS_U16 > 0
			registerEnum(L, GAME_FEATURE_PLAYERICONS_U16)
			#endif
			#if GAME_FEATURE_ADDONS > 0
			registerEnum(L, GAME_FEATURE_ADDONS)
			#endif
			#if GAME_FEATURE_STAMINA > 0
			registerEnum(L, GAME_FEATURE_STAMINA)
			#endif
			#if GAME_FEATURE_OUTFITS > 0
			registerEnum(L, GAME_FEATURE_OUTFITS)
			#endif
			#if GAME_FEATURE_WRITABLE_DATE > 0
			registerEnum(L, GAME_FEATURE_WRITABLE_DATE)
			#endif
			#if GAME_FEATURE_NPC_INTERFACE > 0
			registerEnum(L, GAME_FEATURE_NPC_INTERFACE)
			#endif
			#if GAME_FEATURE_ADLER32_CHECKSUM > 0
			registerEnum(L, GAME_FEATURE_ADLER32_CHECKSUM)
			#endif
			#if GAME_FEATURE_ACCOUNT_NAME > 0
			registerEnum(L, GAME_FEATURE_ACCOUNT_NAME)
			#endif
			#if GAME_FEATURE_DOUBLE_CAPACITY > 0
			registerEnum(L, GAME_FEATURE_DOUBLE_CAPACITY)
			#endif
			#if GAME_FEATURE_SERVER_SENDFIRST > 0
			registerEnum(L, GAME_FEATURE_SERVER_SENDFIRST)
			#endif
			#if GAME_FEATURE_TILE_ADDTHING_STACKPOS > 0
			registerEnum(L, GAME_FEATURE_TILE_ADDTHING_STACKPOS)
			#endif
			#if GAME_FEATURE_GUILD_EMBLEM > 0
			registerEnum(L, GAME_FEATURE_GUILD_EMBLEM)
			#endif
			#if GAME_FEATURE_SERVER_LOG_DETAILS > 0
			registerEnum(L, GAME_FEATURE_SERVER_LOG_DETAILS)
			#endif
			#if GAME_FEATURE_ATTACK_SEQUENCE > 0
			registerEnum(L, GAME_FEATURE_ATTACK_SEQUENCE)
			#endif
			#if GAME_FEATURE_DEATH_PENALTY > 0
			registerEnum(L, GAME_FEATURE_DEATH_PENALTY)
			#endif
			#if GAME_FEATURE_MOUNTS > 0
			registerEnum(L, GAME_FEATURE_MOUNTS)
			#endif
			#if GAME_FEATURE_DOUBLE_EXPERIENCE > 0
			registerEnum(L, GAME_FEATURE_DOUBLE_EXPERIENCE)
			#endif
			#if GAME_FEATURE_SPELL_LIST > 0
			registerEnum(L, GAME_FEATURE_SPELL_LIST)
			#endif
			#if GAME_FEATURE_INVENTORY_LIST > 0
			registerEnum(L, GAME_FEATURE_INVENTORY_LIST)
			#endif
			#if GAME_FEATURE_TOTAL_CAPACITY > 0
			registerEnum(L, GAME_FEATURE_TOTAL_CAPACITY)
			#endif
			#if GAME_FEATURE_BASE_SKILLS > 0
			registerEnum(L, GAME_FEATURE_BASE_SKILLS)
			#endif
			#if GAME_FEATURE_CHAT_PLAYERLIST > 0
			registerEnum(L, GAME_FEATURE_CHAT_PLAYERLIST)
			#endif
			#if GAME_FEATURE_REGENERATION_TIME > 0
			registerEnum(L, GAME_FEATURE_REGENERATION_TIME)
			#endif
			#if GAME_FEATURE_ITEM_ANIMATION_PHASES > 0
			registerEnum(L, GAME_FEATURE_ITEM_ANIMATION_PHASES)
			#endif
			#if GAME_FEATURE_ENVIRONMENT_EFFECTS > 0
			registerEnum(L, GAME_FEATURE_ENVIRONMENT_EFFECTS)
			#endif
			#if GAME_FEATURE_NPC_NAME_ON_TRADE > 0
			registerEnum(L, GAME_FEATURE_NPC_NAME_ON_TRADE)
			#endif
			#if GAME_FEATURE_MARKET > 0
			registerEnum(L, GAME_FEATURE_MARKET)
			#endif
			#if GAME_FEATURE_PING > 0
			registerEnum(L, GAME_FEATURE_PING)
			#endif
			#if GAME_FEATURE_PURSE_SLOT > 0
			registerEnum(L, GAME_FEATURE_PURSE_SLOT)
			#endif
			#if GAME_FEATURE_OFFLINE_TRAINING > 0
			registerEnum(L, GAME_FEATURE_OFFLINE_TRAINING)
			#endif
			#if GAME_FEATURE_LOOKATCREATURE > 0
			registerEnum(L, GAME_FEATURE_LOOKATCREATURE)
			#endif
			#if GAME_FEATURE_ADDITIONAL_VIPINFO > 0
			registerEnum(L, GAME_FEATURE_ADDITIONAL_VIPINFO)
			#endif
			#if GAME_FEATURE_PREVIEW_STATE > 0
			registerEnum(L, GAME_FEATURE_PREVIEW_STATE)
			#endif
			#if GAME_FEATURE_CLIENT_VERSION > 0
			registerEnum(L, GAME_FEATURE_CLIENT_VERSION)
			#endif
			#if GAME_FEATURE_KEEP_CONNECTION_AFTER_DEATH > 0
			registerEnum(L, GAME_FEATURE_KEEP_CONNECTION_AFTER_DEATH)
			#endif
			#if GAME_FEATURE_LOGIN_PENDING > 0
			registerEnum(L, GAME_FEATURE_LOGIN_PENDING)
			#endif
			#if GAME_FEATURE_VIP_STATUS > 0
			registerEnum(L, GAME_FEATURE_VIP_STATUS)
			#endif
			#if GAME_FEATURE_NEWSPEED_LAW > 0
			registerEnum(L, GAME_FEATURE_NEWSPEED_LAW)
			#endif
			#if GAME_FEATURE_BROWSEFIELD > 0
			registerEnum(L, GAME_FEATURE_BROWSEFIELD)
			#endif
			#if GAME_FEATURE_CONTAINER_PAGINATION > 0
			registerEnum(L, GAME_FEATURE_CONTAINER_PAGINATION)
			#endif
			#if GAME_FEATURE_PVP_MODE > 0
			registerEnum(L, GAME_FEATURE_PVP_MODE)
			#endif
			#if GAME_FEATURE_ITEM_MARK > 0
			registerEnum(L, GAME_FEATURE_ITEM_MARK)
			#endif
			#if GAME_FEATURE_CREATURE_MARK > 0
			registerEnum(L, GAME_FEATURE_CREATURE_MARK)
			#endif
			#if GAME_FEATURE_CREATURE_TYPE > 0
			registerEnum(L, GAME_FEATURE_CREATURE_TYPE)
			#endif
			#if GAME_FEATURE_LOGIN_EXTENDED > 0
			registerEnum(L, GAME_FEATURE_LOGIN_EXTENDED)
			#endif
			#if GAME_FEATURE_DOUBLE_SKILLS > 0
			registerEnum(L, GAME_FEATURE_DOUBLE_SKILLS)
			#endif
			#if GAME_FEATURE_CREATURE_ICONS > 0
			registerEnum(L, GAME_FEATURE_CREATURE_ICONS)
			#endif
			#if GAME_FEATURE_PREMIUM_EXPIRATION > 0
			registerEnum(L, GAME_FEATURE_PREMIUM_EXPIRATION)
			#endif
			#if GAME_FEATURE_UNJUSTIFIED_POINTS > 0
			registerEnum(L, GAME_FEATURE_UNJUSTIFIED_POINTS)
			#endif
			#if GAME_FEATURE_EXPERIENCE_BONUS > 0
			registerEnum(L, GAME_FEATURE_EXPERIENCE_BONUS)
			#endif
			#if GAME_FEATURE_DEATH_TYPE > 0
			registerEnum(L, GAME_FEATURE_DEATH_TYPE)
			#endif
			#if GAME_FEATURE_RENDER_INFORMATION > 0
			registerEnum(L, GAME_FEATURE_RENDER_INFORMATION)
			#endif
			#if GAME_FEATURE_CONTENT_REVISION > 0
			registerEnum(L, GAME_FEATURE_CONTENT_REVISION)
			#endif
			#if GAME_FEATURE_AUTHENTICATOR > 0
			registerEnum(L, GAME_FEATURE_AUTHENTICATOR)
			#endif
			#if GAME_FEATURE_SESSIONKEY > 0
			registerEnum(L, GAME_FEATURE_SESSIONKEY)
			#endif
			#if GAME_FEATURE_LOGIN_EMAIL > 0
			registerEnum(L, GAME_FEATURE_LOGIN_EMAIL)
			#endif
			#if GAME_FEATURE_EQUIP_HOTKEY > 0
			registerEnum(L, GAME_FEATURE_EQUIP_HOTKEY)
			#endif
			#if GAME_FEATURE_STORE > 0
			registerEnum(L, GAME_FEATURE_STORE)
			#endif
			#if GAME_FEATURE_LOGIN_PREMIUM_TIMESTAMP > 0
			registerEnum(L, GAME_FEATURE_LOGIN_PREMIUM_TIMESTAMP)
			#endif
			#if GAME_FEATURE_LOGIN_PREMIUM_TYPE > 0
			registerEnum(L, GAME_FEATURE_LOGIN_PREMIUM_TYPE)
			#endif
			#if GAME_FEATURE_WRAPPABLE > 0
			registerEnum(L, GAME_FEATURE_WRAPPABLE)
			#endif
			#if GAME_FEATURE_STORE_INBOX > 0
			registerEnum(L, GAME_FEATURE_STORE_INBOX)
			#endif
			#if GAME_FEATURE_STORE_SERVICETYPE > 0
			registerEnum(L, GAME_FEATURE_STORE_SERVICETYPE)
			#endif
			#if GAME_FEATURE_STORE_HIGHLIGHTS > 0
			registerEnum(L, GAME_FEATURE_STORE_HIGHLIGHTS)
			#endif
			#if GAME_FEATURE_ADDITIONAL_SKILLS > 0
			registerEnum(L, GAME_FEATURE_ADDITIONAL_SKILLS)
			#endif
			#if GAME_FEATURE_DETAILED_EXPERIENCE_BONUS > 0
			registerEnum(L, GAME_FEATURE_DETAILED_EXPERIENCE_BONUS)
			#endif
			#if GAME_FEATURE_STORE_HIGHLIGHTS2 > 0
			registerEnum(L, GAME_FEATURE_STORE_HIGHLIGHTS2)
			#endif
			#if GAME_FEATURE_CLIENT_SENDSERVERNAME > 0
			registerEnum(L, GAME_FEATURE_CLIENT_SENDSERVERNAME)
			#endif
			#if GAME_FEATURE_PREY > 0
			registerEnum(L, GAME_FEATURE_PREY)
			#endif
			#if GAME_FEATURE_IMBUING > 0
			registerEnum(L, GAME_FEATURE_IMBUING)
			#endif
			#if GAME_FEATURE_VIP_GROUPS > 0
			registerEnum(L, GAME_FEATURE_VIP_GROUPS)
			#endif
			#if GAME_FEATURE_INSPECTION > 0
			registerEnum(L, GAME_FEATURE_INSPECTION)
			#endif
			#if GAME_FEATURE_PROTOCOLSEQUENCE > 0
			registerEnum(L, GAME_FEATURE_PROTOCOLSEQUENCE)
			#endif
			#if GAME_FEATURE_BLESS_DIALOG > 0
			registerEnum(L, GAME_FEATURE_BLESS_DIALOG)
			#endif
			#if GAME_FEATURE_QUEST_TRACKER > 0
			registerEnum(L, GAME_FEATURE_QUEST_TRACKER)
			#endif
			#if GAME_FEATURE_GAMETIME > 0
			registerEnum(L, GAME_FEATURE_GAMETIME)
			#endif
			#if GAME_FEATURE_COMPEDIUM > 0
			registerEnum(L, GAME_FEATURE_COMPEDIUM)
			#endif
			#if GAME_FEATURE_PLAYERICONS_U32 > 0
			registerEnum(L, GAME_FEATURE_PLAYERICONS_U32)
			#endif
			#if GAME_FEATURE_REWARD_WALL > 0
			registerEnum(L, GAME_FEATURE_REWARD_WALL)
			#endif
			#if GAME_FEATURE_ANALYTICS > 0
			registerEnum(L, GAME_FEATURE_ANALYTICS)
			#endif
			#if GAME_FEATURE_QUICK_LOOT > 0
			registerEnum(L, GAME_FEATURE_QUICK_LOOT)
			#endif
			#if GAME_FEATURE_EXTENDED_CAPACITY > 0
			registerEnum(L, GAME_FEATURE_EXTENDED_CAPACITY)
			#endif
			#if GAME_FEATURE_CYCLOPEDIA_MONSTERS > 0
			registerEnum(L, GAME_FEATURE_CYCLOPEDIA_MONSTERS)
			#endif
			#if GAME_FEATURE_STASH > 0
			registerEnum(L, GAME_FEATURE_STASH)
			#endif
			#if GAME_FEATURE_CYCLOPEDIA_MAPANDDETAILS > 0
			registerEnum(L, GAME_FEATURE_CYCLOPEDIA_MAPANDDETAILS)
			#endif
			#if GAME_FEATURE_DOUBLE_PERCENT_SKILLS > 0
			registerEnum(L, GAME_FEATURE_DOUBLE_PERCENT_SKILLS)
			#endif
			#if GAME_FEATURE_TOURNAMENTS > 0
			registerEnum(L, GAME_FEATURE_TOURNAMENTS)
			#endif
			#if GAME_FEATURE_PARTY_LIST > 0
			registerEnum(L, GAME_FEATURE_PARTY_LIST)
			#endif
			#if GAME_FEATURE_HIGHSCORES > 0
			registerEnum(L, GAME_FEATURE_HIGHSCORES)
			#endif
			#if GAME_FEATURE_DOUBLE_HEALTH > 0
			registerEnum(L, GAME_FEATURE_DOUBLE_HEALTH)
			#endif
			#if GAME_FEATURE_MOUNT_COLORS > 0
			registerEnum(L, GAME_FEATURE_MOUNT_COLORS)
			#endif
			#if GAME_FEATURE_FAMILIARS > 0
			registerEnum(L, GAME_FEATURE_FAMILIARS)
			#endif
			#if GAME_FEATURE_ROBINHOOD_HASH_MAP > 0
			registerEnum(L, GAME_FEATURE_ROBINHOOD_HASH_MAP)
			#endif
			#if GAME_FEATURE_XIAOLIN_WU_SIGHT_CLEAR > 0
			registerEnum(L, GAME_FEATURE_XIAOLIN_WU_SIGHT_CLEAR)
			#endif
			#if GAME_FEATURE_FASTER_CLEAN > 0
			registerEnum(L, GAME_FEATURE_FASTER_CLEAN)
			#endif
