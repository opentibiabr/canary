...
class LuaEnums final : LuaScriptInterface {
	public:
		static void init(lua_State* L) {
			...
			registerEnum(L, SOUND_EFFECT_TYPE_SPELL_HELLSCORE)
			...
			registerEnum(L, SOUND_EFFECT_TYPE_SPELL_FIRE_ALL_RUNE)
			...
			registerEnum(L, SOUND_EFFECT_TYPE_SPELL_CONJUREARROW)
			...
			registerEnum(L, SOUND_EFFECT_TYPE_SPELL_MAGICWALL_RUNE)
			...
			registerEnum(L, SOUND_EFFECT_TYPE_SPELL_WILDGROWTH_RUNE)
			...
			registerEnum(L, SOUND_EFFECT_TYPE_SPELL_SWIFTFOOT)
			...
			registerEnum(L, SOUND_EFFECT_TYPE_SPELL_LIGHTSTONE_SHOWER_RUNE)
			...
			registerEnum(L, SOUND_EFFECT_TYPE_MONSTER_SPELL_LARGE_AREAFIRE)
			registerEnum(L, SOUND_EFFECT_TYPE_MONSTER_SPELL_LARGE_AREAENERGY)
			registerEnum(L, SOUND_EFFECT_TYPE_MONSTER_SPELL_LARGE_AREAEARTH)
			registerEnum(L, SOUND_EFFECT_TYPE_MONSTER_SPELL_LARGE_AREAICE)
			registerEnum(L, SOUND_EFFECT_TYPE_MONSTER_SPELL_LARGE_AREADEATH)
			registerEnum(L, SOUND_EFFECT_TYPE_MONSTER_SPELL_LARGE_AREAHOLY)
			registerEnum(L, SOUND_EFFECT_TYPE_MONSTER_SPELL_LARGE_AREAHIT)
			registerEnum(L, SOUND_EFFECT_TYPE_MONSTER_SPELL_LARGE_AREALIFEDRAIN)
			registerEnum(L, SOUND_EFFECT_TYPE_MONSTER_SPELL_LARGE_AREAMANADRAIN)
			registerEnum(L, SOUND_EFFECT_TYPE_MONSTER_SPELL_LARGE_AREADROWNING)
			registerEnum(L, SOUND_EFFECT_TYPE_MONSTER_SPELL_LARGE_AREABLEEDING)
			registerEnum(L, SOUND_EFFECT_TYPE_MONSTER_SPELL_LARGE_AREAHEALING)
			...
			registerEnum(L, COMBAT_PARAM_CASTSOUND)
			registerEnum(L, COMBAT_PARAM_IMPACTSOUND)
