...
int PlayerFunctions::luaPlayerGetStorageValueByName(lua_State* L) {
	...
	g_logger().debug("The function 'player:getStorageValueByName' is deprecated and will be removed in future versions, please use KV system");
...
int PlayerFunctions::luaPlayerSetStorageValueByName(lua_State* L) {
	...
	g_logger().debug("The function 'player:setStorageValueByName' is deprecated and will be removed in future versions, please use KV system");
...
int PlayerFunctions::luaPlayerUpdateTournamentCoins(lua_State* L) {
	...
	if (action == "add" && player->account->addCoins(enumToValue(CoinType::Tournament), amount, "") != enumToValue(AccountErrors_t::Ok)) {
