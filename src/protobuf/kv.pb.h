...
PROTOBUF_NAMESPACE_OPEN
template <>
::Canary::protobuf::kv::ArrayType* Arena::CreateMaybeMessage<::Canary::protobuf::kv::ArrayType>(Arena*);
template <>
::Canary::protobuf::kv::KeyValuePair* Arena::CreateMaybeMessage<::Canary::protobuf::kv::KeyValuePair>(Arena*);
template <>
::Canary::protobuf::kv::MapType* Arena::CreateMaybeMessage<::Canary::protobuf::kv::MapType>(Arena*);
template <>
::Canary::protobuf::kv::ValueWrapper* Arena::CreateMaybeMessage<::Canary::protobuf::kv::ValueWrapper>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace Canary {
	namespace protobuf {
		namespace kv {
			...
			class ValueWrapper final : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Canary.protobuf.kv.ValueWrapper) */ {
			public:
				inline ValueWrapper() :
					ValueWrapper(nullptr) { }
			...
			protected:
				explicit ValueWrapper(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned = false);
			...
			class ArrayType final : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Canary.protobuf.kv.ArrayType) */ {
			public:
				inline ArrayType() :
					ArrayType(nullptr) { }
				~ArrayType() override;
			...
			protected:
				explicit ArrayType(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned = false);
			...
			class KeyValuePair final : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Canary.protobuf.kv.KeyValuePair) */ {
			public:
				inline KeyValuePair() :
			...
			protected:
				explicit KeyValuePair(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned = false);
			...
			class MapType final : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Canary.protobuf.kv.MapType) */ {
			public:
				inline MapType() :
					MapType(nullptr) { }
				~MapType() override;
			...
			protected:
				explicit MapType(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned = false);
	...
	#pragma GCC diagnostic ignored "-Wstrict-aliasing"
			...
			template <typename ArgT0, typename... ArgT>
			inline PROTOBUF_ALWAYS_INLINE void KeyValuePair::set_key(ArgT0 &&arg0, ArgT... args) {
			...
			inline const ::Canary::protobuf::kv::ValueWrapper &KeyValuePair::_internal_value() const {
				...
				return p != nullptr ? *p : reinterpret_cast<const ::Canary::protobuf::kv::ValueWrapper &>(::Canary::protobuf::kv::_ValueWrapper_default_instance_);
			}
