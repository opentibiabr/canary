...
/*
// minimum required to log into game
#define PROTOCOL_DISABLE_SERVER_CONFIG
#define PROTOCOL_DISABLE_ADD_CREATURE
...
#define PROTOCOL_DISABLE_PASSIVE_COOLDOWNS
...
#define PROTOCOL_OTC_DISABLE_EXTENDED_OPCODE

// Lua scripts (networkMessage:sendToPlayer)
#define PROTOCOL_DISABLE_LUA_MESSAGES
*/
// PACKET DEFINITIONS END
