...
const std::unordered_map<Tiers_t, double_t> dodgeChance = {
	{TIER1, 0.50},
	{TIER2, 1.03},
	{TIER3, 1.62},
	{TIER4, 2.28},
...
const std::unordered_map<Tiers_t, double_t> fatalChance = {
	{TIER1, 0.50},
	{TIER2, 1.05},
	{TIER3, 1.70},
	{TIER4, 2.45},
...
const std::unordered_map<Tiers_t, double_t> momentumChance = {
	{TIER1, 2.0},
	{TIER2, 4.05},
	{TIER3, 6.20},
	{TIER4, 8.45},
