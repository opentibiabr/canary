...
enum class PlayerFlags_t : uint8_t {
	CannotUseCombat = 0,
	CannotAttackPlayer = 1,
	CannotAttackMonster = 2,
	CannotBeAttacked = 3,
	CanConvinceAll = 4,
	CanSummonAll = 5,
	CanIllusionAll = 6,
	CanSenseInvisibility = 7,
	IgnoredByMonsters = 8,
	NotGainInFight = 9,
	HasInfiniteMana = 10,
	HasInfiniteSoul = 11,
	...
	CannotBeBanned = 18,
	CannotBePushed = 19,
	HasInfiniteCapacity = 20,
	CanPushAllCreatures = 21,
	CanTalkRedPrivate = 22,
	CanTalkRedChannel = 23,
	TalkOrangeHelpChannel = 24,
	NotGainExperience = 25,
	NotGainMana = 26,
	NotGainHealth = 27,
	NotGainSkill = 28,
	SetMaxSpeed = 29,
	SpecialVIP = 30,
	NotGenerateLoot = 31,
	CanTalkRedChannelAnonymous = 32,
	IgnoreProtectionZone = 33,
	IgnoreSpellCheck = 34,
	IgnoreWeaponCheck = 35,
	CannotBeMuted = 36,
	IsAlwaysPremium = 37,
	CanMapClickTeleport = 38,
	IgnoredByNpcs = 39,
