...
enum CreatureMark_t : uint8_t {
	CREATURE_MARK_BROWN = TEXTCOLOR_DARKBROWN,
	CREATURE_MARK_ORANGE = TEXTCOLOR_ORANGE,
	CREATURE_MARK_YELLOW = TEXTCOLOR_YELLOW,
	CREATURE_MARK_UNMARKED = TEXTCOLOR_NONE,
};
