 ...
 *
 */
class AccountStorageStub : public AccountStorage
{
public:
    /***************************************************************************
     * Account Load/Save
    ...
    account::AccountInfo m_account;
    std::string m_password = "default password";
    bool m_forceRegisterError = false;
    bool m_forceGetCoinsError = false;
    bool m_forceSetCoinsError = false;
    bool m_forceGetPasswordError = false;
    bool m_forceSaveError = false;
    bool m_forceLoadError = false;
    uint32_t m_coins = 0;
};
