...
local old, oldStarted, oldStarts = runScenario(1, true)
...
assertEqual(old.status().requiredSchemaVersion, 2, "required schema version")

local current, currentStarted, currentStarts, currentQueries = runScenario(2, true)
...
assertEqual(current.status().schemaVersion, 2, "current schema version")
